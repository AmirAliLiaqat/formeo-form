...
`),n={};for(let d,h=0;h<t.length;h++)d=/^(.+?) *?= *?([^\n]+)/.exec(t[h]),d&&(n[d[1]]=d[2].replace(/(^\s+|\s+$)/g,""));return n}loadLang(e,t=!0){const n=this;return new Promise(function(d,h){if(n.loaded.indexOf(e)!==-1&&t)return n.applyLanguage(n.langs[e]),d(n.langs[e]);{const g=[n.config.location,e,n.config.extension].join("");return gd(g).then(m=>{const c=Yt.processFile(m);return n.applyLanguage(e,c),n.loaded.push(e),d(n.langs[e])}).catch(m=>{console.error(m);const c=n.applyLanguage(e);d(c)})}})}applyLanguage(e,t={}){const n=this.config.override[e]||{},d=this.langs[e]||{};return this.langs[e]={...d,...t,...n},this.langs[e]}get getLangs(){return this.config.langs}async setCurrent(e="en-US"){return await this.loadLang(e),this.locale=e,this.current=this.langs[e],this.current}}const X=new Yt;(function(){try{if(typeof document<"u"){var l=document.createElement("style");l.appendChild(document.createTextNode('._3x4ZIcu-{position:absolute;background:#1f2937;color:#fff;padding:.75rem;border-radius:.375rem;max-width:200px;z-index:50;visibility:hidden;opacity:0;transition:opacity .2s;pointer-events:none;left:0;top:0}._3x4ZIcu-.JIt36hCJ{visibility:visible;opacity:1;pointer-events:all}._3x4ZIcu-:before{content:"";position:absolute;width:0;height:0;border:6px solid transparent}._3x4ZIcu-[data-position=top]:before{border-top-color:#1f2937;bottom:-12px;left:50%;transform:translate(-50%)}._3x4ZIcu-[data-position=bottom]:before{border-bottom-color:#1f2937;top:-12px;left:50%;transform:translate(-50%)}._3x4ZIcu-[data-position=left]:before{border-left-color:#1f2937;right:-12px;top:50%;transform:translateY(-50%)}._3x4ZIcu-[data-position=right]:before{border-right-color:#1f2937;left:-12px;top:50%;transform:translateY(-50%)}._3x4ZIcu-[data-position=top-left]:before{border-top-color:#1f2937;bottom:-12px;left:12px;transform:none}._3x4ZIcu-[data-position=top-right]:before{border-top-color:#1f2937;bottom:-12px;right:12px;left:auto;transform:none}._3x4ZIcu-[data-position=bottom-left]:before{border-bottom-color:#1f2937;top:-12px;left:12px;transform:none}._3x4ZIcu-[data-position=bottom-right]:before{border-bottom-color:#1f2937;top:-12px;right:12px;left:auto;transform:none}')),document.head.appendChild(l)}}catch(e){console.error("vite-plugin-css-injected-by-js",e)}})();var md=Object.defineProperty,vd=(l,e,t)=>e in l?md(l,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):l[e]=t,Ye=(l,e,t)=>vd(l,typeof e!="symbol"?e+"":e,t);const yd="_3x4ZIcu-",bd="JIt36hCJ",Ht={tooltip:yd,visible:bd},wd={triggerName:"tooltip"};class Bu{constructor(e=wd){Ye(this,"triggerName"),Ye(this,"tooltip"),Ye(this,"activeTriggerType",null),Ye(this,"spacing",12),Ye(this,"handleClick",t=>{const n=this.triggerName,d=t.target.closest(`[${n}][${n}-type="click"]`);if(d)if(this.isVisible())this.hide();else{const h=d.getAttribute(`${n}`);this.show(d,h),this.activeTriggerType="click"}else this.hide()}),Ye(this,"handleMouseOver",t=>{const n=this.triggerName,d=t.target.closest(`[${n}]`);if(this.activeTriggerType!=="click"&&d?.getAttribute(`${n}-type`)!=="click"){const h=d?.getAttribute(`${n}`);h&&(this.show(d,h),this.activeTriggerType="hover")}}),Ye(this,"handleMouseOut",t=>{const n=this.triggerName,d=t.target.closest(`[${n}]`);this.activeTriggerType!=="click"&&d?.getAttribute(`${n}-type`)!=="click"&&this.hide()}),Ye(this,"handleResize",()=>{this.isVisible()&&this.hide()}),Ye(this,"handleScroll",()=>{this.isVisible()&&this.hide()}),this.triggerName=`data-${e.triggerName}`,this.tooltip=document.createElement("div"),this.tooltip.className=`d-tooltip ${Ht.tooltip}`,document.body.appendChild(this.tooltip),this.setupEventListeners()}setupEventListeners(){document.addEventListener("mouseover",this.handleMouseOver),document.addEventListener("mouseout",this.handleMouseOut),document.addEventListener("touchstart",this.handleMouseOver),document.addEventListener("touchend",this.handleMouseOut),document.addEventListener("click",this.handleClick),window.addEventListener("resize",this.handleResize),window.addEventListener("scroll",this.handleScroll,!0)}isVisible(){return this.tooltip.classList.contains(Ht.visible)}calculatePosition(e){const t=e.getBoundingClientRect(),n=this.tooltip.getBoundingClientRect(),d=[{name:"top",x:t.left+(t.width-n.width)/2,y:t.top-n.height-this.spacing},{name:"bottom",x:t.left+(t.width-n.width)/2,y:t.bottom+this.spacing},{name:"left",x:t.left-n.width-this.spacing,y:t.top+(t.height-n.height)/2},{name:"right",x:t.right+this.spacing,y:t.top+(t.height-n.height)/2},{name:"top-left",x:t.left,y:t.top-n.height-this.spacing},{name:"top-right",x:t.right-n.width,y:t.top-n.height-this.spacing},{name:"bottom-left",x:t.left,y:t.bottom+this.spacing},{name:"bottom-right",x:t.right-n.width,y:t.bottom+this.spacing}];return d.find(h=>this.fitsInViewport(h,n))||d[0]}fitsInViewport(e,t){return e.x>=0&&e.y>=0&&e.x+t.width<=window.innerWidth&&e.y+t.height<=window.innerHeight?[[e.x,e.y],[e.x+t.width,e.y],[e.x,e.y+t.height],[e.x+t.width,e.y+t.height],[e.x+t.width/2,e.y+t.height/2]].flatMap(([m,c])=>Array.from(document.elementsFromPoint(m,c))).filter(m=>{if(this.tooltip.contains(m)||m===this.tooltip||m.classList.contains(Ht.tooltip)||getComputedStyle(m).pointerEvents==="none")return!1}).length===0:!1}show(e,t){this.tooltip.innerHTML=t??"",this.tooltip.classList.add(Ht.visible);const n=this.calculatePosition(e);this.tooltip.style.left=`${n.x}px`,this.tooltip.style.top=`${n.y}px`,this.tooltip.dataset.position=n.name}hide(){this.tooltip.classList.remove(Ht.visible),this.activeTriggerType=null}destroy(){document.removeEventListener("mouseover",this.handleMouseOver),document.removeEventListener("mouseout",this.handleMouseOut),document.removeEventListener("touchstart",this.handleMouseOver),document.removeEventListener("touchend",this.handleMouseOut),document.removeEventListener("click",this.handleClick),window.removeEventListener("resize",this.handleResize),window.removeEventListener("scroll",this.handleScroll,!0),this.tooltip.remove()}}window!==void 0&&(window.SmartTooltip=Bu);const Cd="formeo",Sd="5.0.0",ju={name:Cd,version:Sd};var un=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Ot(l){return l&&l.__esModule&&Object.prototype.hasOwnProperty.call(l,"default")?l.default:l}var ii,pa;function Ad(){if(pa)return ii;pa=1;function l(){this.__data__=[],this.size=0}return ii=l,ii}var ri,ga;function sn(){if(ga)return ri;ga=1;function l(e,t){return e===t||e!==e&&t!==t}return ri=l,ri}var oi,ma;function Wn(){if(ma)return oi;ma=1;var l=sn();function e(t,n){for(var d=t.length;d--;)if(l(t[d][0],n))return d;return-1}return oi=e,oi}var si,va;function $d(){if(va)return si;va=1;var l=Wn(),e=Array.prototype,t=e.splice;function n(d){var h=this.__data__,g=l(h,d);if(g<0)return!1;var m=h.length-1;return g==m?h.pop():t.call(h,g,1),--this.size,!0}return si=n,si}var ai,ya;function xd(){if(ya)return ai;ya=1;var l=Wn();function e(t){var n=this.__data__,d=l(n,t);return d<0?void 0:n[d][1]}return ai=e,ai}var li,ba;function Md(){if(ba)return li;ba=1;var l=Wn();function e(t){return l(this.__data__,t)>-1}return li=e,li}var ci,wa;function Ed(){if(wa)return ci;wa=1;var l=Wn();function e(t,n){var d=this.__data__,h=l(d,t);return h<0?(++this.size,d.push([t,n])):d[h][1]=n,this}return ci=e,ci}var ui,Ca;function zn(){if(Ca)return ui;Ca=1;var l=Ad(),e=$d(),t=xd(),n=Md(),d=Ed();function h(g){var m=-1,c=g==null?0:g.length;for(this.clear();++m<c;){var f=g[m];this.set(f[0],f[1])}}return h.prototype.clear=l,h.prototype.delete=e,h.prototype.get=t,h.prototype.has=n,h.prototype.set=d,ui=h,ui}var hi,Sa;function _d(){if(Sa)return hi;Sa=1;var l=zn();function e(){this.__data__=new l,this.size=0}return hi=e,hi}var di,Aa;function Td(){if(Aa)return di;Aa=1;function l(e){var t=this.__data__,n=t.delete(e);return this.size=t.size,n}return di=l,di}var fi,$a;function Ld(){if($a)return fi;$a=1;function l(e){return this.__data__.get(e)}return fi=l,fi}var pi,xa;function Rd(){if(xa)return pi;xa=1;function l(e){return this.__data__.has(e)}return pi=l,pi}var gi,Ma;function Vu(){if(Ma)return gi;Ma=1;var l=typeof un=="object"&&un&&un.Object===Object&&un;return gi=l,gi}var mi,Ea;function Ke(){if(Ea)return mi;Ea=1;var l=Vu(),e=typeof self=="object"&&self&&self.Object===Object&&self,t=l||e||Function("return this")();return mi=t,mi}var vi,_a;function Bn(){if(_a)return vi;_a=1;var l=Ke(),e=l.Symbol;return vi=e,vi}var yi,Ta;function kd(){if(Ta)return yi;Ta=1;var l=Bn(),e=Object.prototype,t=e.hasOwnProperty,n=e.toString,d=l?l.toStringTag:void 0;function h(g){var m=t.call(g,d),c=g[d];try{g[d]=void 0;var f=!0}catch{}var r=n.call(g);return f&&(m?g[d]=c:delete g[d]),r}return yi=h,yi}var bi,La;function Dd(){if(La)return bi;La=1;var l=Object.prototype,e=l.toString;function t(n){return e.call(n)}return bi=t,bi}var wi,Ra;function It(){if(Ra)return wi;Ra=1;var l=Bn(),e=kd(),t=Dd(),n="[object Null]",d="[object Undefined]",h=l?l.toStringTag:void 0;function g(m){return m==null?m===void 0?d:n:h&&h in Object(m)?e(m):t(m)}return wi=g,wi}var Ci,ka;function ut(){if(ka)return Ci;ka=1;function l(e){var t=typeof e;return e!=null&&(t=="object"||t=="function")}return Ci=l,Ci}var Si,Da;function Rs(){if(Da)return Si;Da=1;var l=It(),e=ut(),t="[object AsyncFunction]",n="[object Function]",d="[object GeneratorFunction]",h="[object Proxy]";function g(m){if(!e(m))return!1;var c=l(m);return c==n||c==d||c==t||c==h}return Si=g,Si}var Ai,Oa;function Od(){if(Oa)return Ai;Oa=1;var l=Ke(),e=l["__core-js_shared__"];return Ai=e,Ai}var $i,Ia;function Id(){if(Ia)return $i;Ia=1;var l=Od(),e=(function(){var n=/[^.]+$/.exec(l&&l.keys&&l.keys.IE_PROTO||"");return n?"Symbol(src)_1."+n:""})();function t(n){return!!e&&e in n}return $i=t,$i}var xi,Na;function Uu(){if(Na)return xi;Na=1;var l=Function.prototype,e=l.toString;function t(n){if(n!=null){try{return e.call(n)}catch{}try{return n+""}catch{}}return""}return xi=t,xi}var Mi,Fa;function Nd(){if(Fa)return Mi;Fa=1;var l=Rs(),e=Id(),t=ut(),n=Uu(),d=/[\\^$.*+?()[\]{}|]/g,h=/^\[object .+?Constructor\]$/,g=Function.prototype,m=Object.prototype,c=g.toString,f=m.hasOwnProperty,r=RegExp("^"+c.call(f).replace(d,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$");function o(a){if(!t(a)||e(a))return!1;var s=l(a)?r:h;return s.test(n(a))}return Mi=o,Mi}var Ei,Pa;function Fd(){if(Pa)return Ei;Pa=1;function l(e,t){return e?.[t]}return Ei=l,Ei}var _i,Ha;function bt(){if(Ha)return _i;Ha=1;var l=Nd(),e=Fd();function t(n,d){var h=e(n,d);return l(h)?h:void 0}return _i=t,_i}var Ti,Wa;function ks(){if(Wa)return Ti;Wa=1;var l=bt(),e=Ke(),t=l(e,"Map");return Ti=t,Ti}var Li,za;function jn(){if(za)return Li;za=1;var l=bt(),e=l(Object,"create");return Li=e,Li}var Ri,Ba;function Pd(){if(Ba)return Ri;Ba=1;var l=jn();function e(){this.__data__=l?l(null):{},this.size=0}return Ri=e,Ri}var ki,ja;function Hd(){if(ja)return ki;ja=1;function l(e){var t=this.has(e)&&delete this.__data__[e];return this.size-=t?1:0,t}return ki=l,ki}var Di,Va;function Wd(){if(Va)return Di;Va=1;var l=jn(),e="__lodash_hash_undefined__",t=Object.prototype,n=t.hasOwnProperty;function d(h){var g=this.__data__;if(l){var m=g[h];return m===e?void 0:m}return n.call(g,h)?g[h]:void 0}return Di=d,Di}var Oi,Ua;function zd(){if(Ua)return Oi;Ua=1;var l=jn(),e=Object.prototype,t=e.hasOwnProperty;function n(d){var h=this.__data__;return l?h[d]!==void 0:t.call(h,d)}return Oi=n,Oi}var Ii,Ga;function Bd(){if(Ga)return Ii;Ga=1;var l=jn(),e="__lodash_hash_undefined__";function t(n,d){var h=this.__data__;return this.size+=this.has(n)?0:1,h[n]=l&&d===void 0?e:d,this}return Ii=t,Ii}var Ni,qa;function jd(){if(qa)return Ni;qa=1;var l=Pd(),e=Hd(),t=Wd(),n=zd(),d=Bd();function h(g){var m=-1,c=g==null?0:g.length;for(this.clear();++m<c;){var f=g[m];this.set(f[0],f[1])}}return h.prototype.clear=l,h.prototype.delete=e,h.prototype.get=t,h.prototype.has=n,h.prototype.set=d,Ni=h,Ni}var Fi,Ka;function Vd(){if(Ka)return Fi;Ka=1;var l=jd(),e=zn(),t=ks();function n(){this.size=0,this.__data__={hash:new l,map:new(t||e),string:new l}}return Fi=n,Fi}var Pi,Ya;function Ud(){if(Ya)return Pi;Ya=1;function l(e){var t=typeof e;return t=="string"||t=="number"||t=="symbol"||t=="boolean"?e!=="__proto__":e===null}return Pi=l,Pi}var Hi,Za;function Vn(){if(Za)return Hi;Za=1;var l=Ud();function e(t,n){var d=t.__data__;return l(n)?d[typeof n=="string"?"string":"hash"]:d.map}return Hi=e,Hi}var Wi,Xa;function Gd(){if(Xa)return Wi;Xa=1;var l=Vn();function e(t){var n=l(this,t).delete(t);return this.size-=n?1:0,n}return Wi=e,Wi}var zi,Qa;function qd(){if(Qa)return zi;Qa=1;var l=Vn();function e(t){return l(this,t).get(t)}return zi=e,zi}var Bi,Ja;function Kd(){if(Ja)return Bi;Ja=1;var l=Vn();function e(t){return l(this,t).has(t)}return Bi=e,Bi}var ji,el;function Yd(){if(el)return ji;el=1;var l=Vn();function e(t,n){var d=l(this,t),h=d.size;return d.set(t,n),this.size+=d.size==h?0:1,this}return ji=e,ji}var Vi,tl;function Ds(){if(tl)return Vi;tl=1;var l=Vd(),e=Gd(),t=qd(),n=Kd(),d=Yd();function h(g){var m=-1,c=g==null?0:g.length;for(this.clear();++m<c;){var f=g[m];this.set(f[0],f[1])}}return h.prototype.clear=l,h.prototype.delete=e,h.prototype.get=t,h.prototype.has=n,h.prototype.set=d,Vi=h,Vi}var Ui,nl;function Zd(){if(nl)return Ui;nl=1;var l=zn(),e=ks(),t=Ds(),n=200;function d(h,g){var m=this.__data__;if(m instanceof l){var c=m.__data__;if(!e||c.length<n-1)return c.push([h,g]),this.size=++m.size,this;m=this.__data__=new t(c)}return m.set(h,g),this.size=m.size,this}return Ui=d,Ui}var Gi,il;function Gu(){if(il)return Gi;il=1;var l=zn(),e=_d(),t=Td(),n=Ld(),d=Rd(),h=Zd();function g(m){var c=this.__data__=new l(m);this.size=c.size}return g.prototype.clear=e,g.prototype.delete=t,g.prototype.get=n,g.prototype.has=d,g.prototype.set=h,Gi=g,Gi}var qi,rl;function qu(){if(rl)return qi;rl=1;var l=bt(),e=(function(){try{var t=l(Object,"defineProperty");return t({},"",{}),t}catch{}})();return qi=e,qi}var Ki,ol;function Os(){if(ol)return Ki;ol=1;var l=qu();function e(t,n,d){n=="__proto__"&&l?l(t,n,{configurable:!0,enumerable:!0,value:d,writable:!0}):t[n]=d}return Ki=e,Ki}var Yi,sl;function Ku(){if(sl)return Yi;sl=1;var l=Os(),e=sn();function t(n,d,h){(h!==void 0&&!e(n[d],h)||h===void 0&&!(d in n))&&l(n,d,h)}return Yi=t,Yi}var Zi,al;function Xd(){if(al)return Zi;al=1;function l(e){return function(t,n,d){for(var h=-1,g=Object(t),m=d(t),c=m.length;c--;){var f=m[e?c:++h];if(n(g[f],f,g)===!1)break}return t}}return Zi=l,Zi}var Xi,ll;function Qd(){if(ll)return Xi;ll=1;var l=Xd(),e=l();return Xi=e,Xi}var jt={exports:{}};jt.exports;var cl;function Jd(){return cl||(cl=1,(function(l,e){var t=Ke(),n=e&&!e.nodeType&&e,d=n&&!0&&l&&!l.nodeType&&l,h=d&&d.exports===n,g=h?t.Buffer:void 0,m=g?g.allocUnsafe:void 0;function c(f,r){if(r)return f.slice();var o=f.length,a=m?m(o):new f.constructor(o);return f.copy(a),a}l.exports=c})(jt,jt.exports)),jt.exports}var Qi,ul;function Yu(){if(ul)return Qi;ul=1;var l=Ke(),e=l.Uint8Array;return Qi=e,Qi}var Ji,hl;function ef(){if(hl)return Ji;hl=1;var l=Yu();function e(t){var n=new t.constructor(t.byteLength);return new l(n).set(new l(t)),n}return Ji=e,Ji}var er,dl;function tf(){if(dl)return er;dl=1;var l=ef();function e(t,n){var d=n?l(t.buffer):t.buffer;return new t.constructor(d,t.byteOffset,t.length)}return er=e,er}var tr,fl;function nf(){if(fl)return tr;fl=1;function l(e,t){var n=-1,d=e.length;for(t||(t=Array(d));++n<d;)t[n]=e[n];return t}return tr=l,tr}var nr,pl;function rf(){if(pl)return nr;pl=1;var l=ut(),e=Object.create,t=(function(){function n(){}return function(d){if(!l(d))return{};if(e)return e(d);n.prototype=d;var h=new n;return n.prototype=void 0,h}})();return nr=t,nr}var ir,gl;function Zu(){if(gl)return ir;gl=1;function l(e,t){return function(n){return e(t(n))}}return ir=l,ir}var rr,ml;function Xu(){if(ml)return rr;ml=1;var l=Zu(),e=l(Object.getPrototypeOf,Object);return rr=e,rr}var or,vl;function Is(){if(vl)return or;vl=1;var l=Object.prototype;function e(t){var n=t&&t.constructor,d=typeof n=="function"&&n.prototype||l;return t===d}return or=e,or}var sr,yl;function of(){if(yl)return sr;yl=1;var l=rf(),e=Xu(),t=Is();function n(d){return typeof d.constructor=="function"&&!t(d)?l(e(d)):{}}return sr=n,sr}var ar,bl;function wt(){if(bl)return ar;bl=1;function l(e){return e!=null&&typeof e=="object"}return ar=l,ar}var lr,wl;function sf(){if(wl)return lr;wl=1;var l=It(),e=wt(),t="[object Arguments]";function n(d){return e(d)&&l(d)==t}return lr=n,lr}var cr,Cl;function Qu(){if(Cl)return cr;Cl=1;var l=sf(),e=wt(),t=Object.prototype,n=t.hasOwnProperty,d=t.propertyIsEnumerable,h=l((function(){return arguments})())?l:function(g){return e(g)&&n.call(g,"callee")&&!d.call(g,"callee")};return cr=h,cr}var ur,Sl;function Ct(){if(Sl)return ur;Sl=1;var l=Array.isArray;return ur=l,ur}var hr,Al;function Ju(){if(Al)return hr;Al=1;var l=9007199254740991;function e(t){return typeof t=="number"&&t>-1&&t%1==0&&t<=l}return hr=e,hr}var dr,$l;function Un(){if($l)return dr;$l=1;var l=Rs(),e=Ju();function t(n){return n!=null&&e(n.length)&&!l(n)}return dr=t,dr}var fr,xl;function af(){if(xl)return fr;xl=1;var l=Un(),e=wt();function t(n){return e(n)&&l(n)}return fr=t,fr}var Vt={exports:{}},pr,Ml;function lf(){if(Ml)return pr;Ml=1;function l(){return!1}return pr=l,pr}Vt.exports;var El;function Ns(){return El||(El=1,(function(l,e){var t=Ke(),n=lf(),d=e&&!e.nodeType&&e,h=d&&!0&&l&&!l.nodeType&&l,g=h&&h.exports===d,m=g?t.Buffer:void 0,c=m?m.isBuffer:void 0,f=c||n;l.exports=f})(Vt,Vt.exports)),Vt.exports}var gr,_l;function cf(){if(_l)return gr;_l=1;var l=It(),e=Xu(),t=wt(),n="[object Object]",d=Function.prototype,h=Object.prototype,g=d.toString,m=h.hasOwnProperty,c=g.call(Object);function f(r){if(!t(r)||l(r)!=n)return!1;var o=e(r);if(o===null)return!0;var a=m.call(o,"constructor")&&o.constructor;return typeof a=="function"&&a instanceof a&&g.call(a)==c}return gr=f,gr}var mr,Tl;function uf(){if(Tl)return mr;Tl=1;var l=It(),e=Ju(),t=wt(),n="[object Arguments]",d="[object Array]",h="[object Boolean]",g="[object Date]",m="[object Error]",c="[object Function]",f="[object Map]",r="[object Number]",o="[object Object]",a="[object RegExp]",s="[object Set]",i="[object String]",u="[object WeakMap]",p="[object ArrayBuffer]",y="[object DataView]",b="[object Float32Array]",M="[object Float64Array]",$="[object Int8Array]",A="[object Int16Array]",S="[object Int32Array]",E="[object Uint8Array]",R="[object Uint8ClampedArray]",L="[object Uint16Array]",_="[object Uint32Array]",D={};D[b]=D[M]=D[$]=D[A]=D[S]=D[E]=D[R]=D[L]=D[_]=!0,D[n]=D[d]=D[p]=D[h]=D[y]=D[g]=D[m]=D[c]=D[f]=D[r]=D[o]=D[a]=D[s]=D[i]=D[u]=!1;function w(v){return t(v)&&e(v.length)&&!!D[l(v)]}return mr=w,mr}var vr,Ll;function hf(){if(Ll)return vr;Ll=1;function l(e){return function(t){return e(t)}}return vr=l,vr}var Ut={exports:{}};Ut.exports;var Rl;function df(){return Rl||(Rl=1,(function(l,e){var t=Vu(),n=e&&!e.nodeType&&e,d=n&&!0&&l&&!l.nodeType&&l,h=d&&d.exports===n,g=h&&t.process,m=(function(){try{var c=d&&d.require&&d.require("util").types;return c||g&&g.binding&&g.binding("util")}catch{}})();l.exports=m})(Ut,Ut.exports)),Ut.exports}var yr,kl;function Fs(){if(kl)return yr;kl=1;var l=uf(),e=hf(),t=df(),n=t&&t.isTypedArray,d=n?e(n):l;return yr=d,yr}var br,Dl;function eh(){if(Dl)return br;Dl=1;function l(e,t){if(!(t==="constructor"&&typeof e[t]=="function")&&t!="__proto__")return e[t]}return br=l,br}var wr,Ol;function th(){if(Ol)return wr;Ol=1;var l=Os(),e=sn(),t=Object.prototype,n=t.hasOwnProperty;function d(h,g,m){var c=h[g];(!(n.call(h,g)&&e(c,m))||m===void 0&&!(g in h))&&l(h,g,m)}return wr=d,wr}var Cr,Il;function ff(){if(Il)return Cr;Il=1;var l=th(),e=Os();function t(n,d,h,g){var m=!h;h||(h={});for(var c=-1,f=d.length;++c<f;){var r=d[c],o=g?g(h[r],n[r],r,h,n):void 0;o===void 0&&(o=n[r]),m?e(h,r,o):l(h,r,o)}return h}return Cr=t,Cr}var Sr,Nl;function pf(){if(Nl)return Sr;Nl=1;function l(e,t){for(var n=-1,d=Array(e);++n<e;)d[n]=t(n);return d}return Sr=l,Sr}var Ar,Fl;function Ps(){if(Fl)return Ar;Fl=1;var l=9007199254740991,e=/^(?:0|[1-9]\d*)$/;function t(n,d){var h=typeof n;return d=d??l,!!d&&(h=="number"||h!="symbol"&&e.test(n))&&n>-1&&n%1==0&&n<d}return Ar=t,Ar}var $r,Pl;function nh(){if(Pl)return $r;Pl=1;var l=pf(),e=Qu(),t=Ct(),n=Ns(),d=Ps(),h=Fs(),g=Object.prototype,m=g.hasOwnProperty;function c(f,r){var o=t(f),a=!o&&e(f),s=!o&&!a&&n(f),i=!o&&!a&&!s&&h(f),u=o||a||s||i,p=u?l(f.length,String):[],y=p.length;for(var b in f)(r||m.call(f,b))&&!(u&&(b=="length"||s&&(b=="offset"||b=="parent")||i&&(b=="buffer"||b=="byteLength"||b=="byteOffset")||d(b,y)))&&p.push(b);return p}return $r=c,$r}var xr,Hl;function gf(){if(Hl)return xr;Hl=1;function l(e){var t=[];if(e!=null)for(var n in Object(e))t.push(n);return t}return xr=l,xr}var Mr,Wl;function mf(){if(Wl)return Mr;Wl=1;var l=ut(),e=Is(),t=gf(),n=Object.prototype,d=n.hasOwnProperty;function h(g){if(!l(g))return t(g);var m=e(g),c=[];for(var f in g)f=="constructor"&&(m||!d.call(g,f))||c.push(f);return c}return Mr=h,Mr}var Er,zl;function ih(){if(zl)return Er;zl=1;var l=nh(),e=mf(),t=Un();function n(d){return t(d)?l(d,!0):e(d)}return Er=n,Er}var _r,Bl;function vf(){if(Bl)return _r;Bl=1;var l=ff(),e=ih();function t(n){return l(n,e(n))}return _r=t,_r}var Tr,jl;function yf(){if(jl)return Tr;jl=1;var l=Ku(),e=Jd(),t=tf(),n=nf(),d=of(),h=Qu(),g=Ct(),m=af(),c=Ns(),f=Rs(),r=ut(),o=cf(),a=Fs(),s=eh(),i=vf();function u(p,y,b,M,$,A,S){var E=s(p,b),R=s(y,b),L=S.get(R);if(L){l(p,b,L);return}var _=A?A(E,R,b+"",p,y,S):void 0,D=_===void 0;if(D){var w=g(R),v=!w&&c(R),C=!w&&!v&&a(R);_=R,w||v||C?g(E)?_=E:m(E)?_=n(E):v?(D=!1,_=e(R,!0)):C?(D=!1,_=t(R,!0)):_=[]:o(R)||h(R)?(_=E,h(E)?_=i(E):(!r(E)||f(E))&&(_=d(R))):D=!1}D&&(S.set(R,_),$(_,R,M,A,S),S.delete(R)),l(p,b,_)}return Tr=u,Tr}var Lr,Vl;function bf(){if(Vl)return Lr;Vl=1;var l=Gu(),e=Ku(),t=Qd(),n=yf(),d=ut(),h=ih(),g=eh();function m(c,f,r,o,a){c!==f&&t(f,function(s,i){if(a||(a=new l),d(s))n(c,f,i,r,m,o,a);else{var u=o?o(g(c,i),s,i+"",c,f,a):void 0;u===void 0&&(u=s),e(c,i,u)}},h)}return Lr=m,Lr}var Rr,Ul;function rh(){if(Ul)return Rr;Ul=1;function l(e){return e}return Rr=l,Rr}var kr,Gl;function wf(){if(Gl)return kr;Gl=1;function l(e,t,n){switch(n.length){case 0:return e.call(t);case 1:return e.call(t,n[0]);case 2:return e.call(t,n[0],n[1]);case 3:return e.call(t,n[0],n[1],n[2])}return e.apply(t,n)}return kr=l,kr}var Dr,ql;function Cf(){if(ql)return Dr;ql=1;var l=wf(),e=Math.max;function t(n,d,h){return d=e(d===void 0?n.length-1:d,0),function(){for(var g=arguments,m=-1,c=e(g.length-d,0),f=Array(c);++m<c;)f[m]=g[d+m];m=-1;for(var r=Array(d+1);++m<d;)r[m]=g[m];return r[d]=h(f),l(n,this,r)}}return Dr=t,Dr}var Or,Kl;function Sf(){if(Kl)return Or;Kl=1;function l(e){return function(){return e}}return Or=l,Or}var Ir,Yl;function Af(){if(Yl)return Ir;Yl=1;var l=Sf(),e=qu(),t=rh(),n=e?function(d,h){return e(d,"toString",{configurable:!0,enumerable:!1,value:l(h),writable:!0})}:t;return Ir=n,Ir}var Nr,Zl;function $f(){if(Zl)return Nr;Zl=1;var l=800,e=16,t=Date.now;function n(d){var h=0,g=0;return function(){var m=t(),c=e-(m-g);if(g=m,c>0){if(++h>=l)return arguments[0]}else h=0;return d.apply(void 0,arguments)}}return Nr=n,Nr}var Fr,Xl;function xf(){if(Xl)return Fr;Xl=1;var l=Af(),e=$f(),t=e(l);return Fr=t,Fr}var Pr,Ql;function Mf(){if(Ql)return Pr;Ql=1;var l=rh(),e=Cf(),t=xf();function n(d,h){return t(e(d,h,l),d+"")}return Pr=n,Pr}var Hr,Jl;function Ef(){if(Jl)return Hr;Jl=1;var l=sn(),e=Un(),t=Ps(),n=ut();function d(h,g,m){if(!n(m))return!1;var c=typeof g;return(c=="number"?e(m)&&t(g,m.length):c=="string"&&g in m)?l(m[g],h):!1}return Hr=d,Hr}var Wr,ec;function _f(){if(ec)return Wr;ec=1;var l=Mf(),e=Ef();function t(n){return l(function(d,h){var g=-1,m=h.length,c=m>1?h[m-1]:void 0,f=m>2?h[2]:void 0;for(c=n.length>3&&typeof c=="function"?(m--,c):void 0,f&&e(h[0],h[1],f)&&(c=m<3?void 0:c,m=1),d=Object(d);++g<m;){var r=h[g];r&&n(d,r,g,c)}return d})}return Wr=t,Wr}var zr,tc;function Tf(){if(tc)return zr;tc=1;var l=bf(),e=_f(),t=e(function(n,d,h,g){l(n,d,h,g)});return zr=t,zr}var Lf=Tf();const Rf=Ot(Lf),kf=()=>crypto.randomUUID().slice(0,8),Df=()=>kf().slice(0,8),nc=(l="",e)=>{if(!e)return console.warn("utils.match missing argument 2."),!1;const t=/[|\\{}()[\]^*$+?.]/g;let n=typeof e=="string"?[e]:e;n=n.map(h=>h==="*"?"":h.replace(t,"\\$&"));let d=!0;return n.length&&(d=!new RegExp(n.join("|"),"i").exec(l)),d},Of=(l,e)=>{const t=l.indexOf(e);t!==-1&&l.splice(t,1)},Le=l=>{const e=l.className?.match(Yf);return e&&qf[e[0]]},mt=l=>Array.from(new Set(l)),He=l=>l?.attrs?.id||l?.id||Df(),Ve=(l,e)=>Rf({},l,e,(n,d)=>{if(Array.isArray(n))return d!=null?mt(n.concat(d)):d;if(Array.isArray(d))return n!=null?mt(d.concat(n)):d}),Je=l=>{let e;const t=l instanceof Promise;if(l===null||!(typeof l=="object")||t)return l;if(l instanceof Date)return e=new Date,e.setTime(l.getTime()),e;if(Array.isArray(l)){e=[];for(let d=0,h=l.length;d<h;d++)e[d]=Je(l[d]);return e}if(l instanceof Object){e={};for(const d in l)Object.hasOwn(l,d)&&(e[d]=Je(l[d]));return e}throw new Error("Unable to copy Object, type not supported.")},Br=(l,e)=>l/e*100,ws=l=>`${l.toString()}%`,oh=Object.create(null,{get:{value:l=>{const e=window.sessionStorage?.getItem(l);try{return JSON.parse(e)}catch{return e}}},set:{value:(l,e)=>{try{return window.sessionStorage?.setItem(l,JSON.stringify(e))}catch(t){console.error(t)}}}}),Pe=l=>/^(stage|row|column|field)s./.test(l),If=l=>jf.test(l);function Nf(l,e=Vs){let t=0;return function(...n){const d=Date.now();d-t>=e&&(t=d,l.apply(this,n))}}function _n(l,e=vt){let t;return function(...n){t&&clearTimeout(t),t=setTimeout(()=>l.apply(this,n),e)}}function Cs(l){return l}function Ss(){}function Gn(l=Object.create(null)){if(typeof l=="string")try{return JSON.parse(l)}catch(e){return console.error("Invalid JSON string provided:",e),Object.create(null)}return l}const Mt=l=>l?Je(Gn(l)):Tn();function sh(l,e,t,n={}){if(!e||!l[t][e])return n;const d=`${t}.${e}`;n[d]=l[t][e];const h=Qf.get(t);if(h){const g=l[t][e].data?.children||[];for(const m of g)sh(l,m,h,n)}return n}const Ff='<?xml version="1.0" encoding="utf-8"?><!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><symbol id="f-i-autocomplete" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path d="M6,5h1v1H6V5z M4,4H3v1h1V4z M6,4H5v1h1V4z M2,5v1h1V5H2z M3,7h1V6H3V7z M5,7h1V6H5V7z M4,5v1h1V5H4z M2,14h1v-1H2V14z M4,14h1v-1H4V14z M6,14h1v-1H6V14z M9,13H8v1h1V13z M16,3.5v4C16,8.3,15.3,9,14.5,9H14v3v3c0,0.6-0.4,1-1,1H1c-0.6,0-1-0.4-1-1V3.5 C0,2.7,0.7,2,1.5,2h3H8V1.5V1H7H6V0.5V0h2.5H11v0.5V1h-1H9v0.5V2h3h2.5C15.3,2,16,2.7,16,3.5z M13,12H7H1v3h12V12z M3,11v-1H2v1H3z M5,11v-1H4v1H5z M15,3.5C15,3.2,14.8,3,14.5,3H9v2.5V8H8.5H8V7.5V7H7V6h1V5.5V5H7V4h1V3.5V3H1.5C1.2,3,1,3.2,1,3.5v4 C1,7.8,1.2,8,1.5,8H8v1H6v0.5V10h2.5H11V9.5V9H9V8h5.5C14.8,8,15,7.8,15,7.5V3.5z"/></symbol><symbol viewBox="0 0 32 32" id="f-i-bin" xmlns="http://www.w3.org/2000/svg"><path d="M4 10v20c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2v-20h-22zM10 28h-2v-14h2v14zM14 28h-2v-14h2v14zM18 28h-2v-14h2v14zM22 28h-2v-14h2v14zM26.5 4h-6.5v-2.5c0-.825-.675-1.5-1.5-1.5h-7c-.825 0-1.5.675-1.5 1.5v2.5h-6.5c-.825 0-1.5.675-1.5 1.5v2.5h26v-2.5c0-.825-.675-1.5-1.5-1.5zM18 4h-6v-1.975h6v1.975z"/></symbol><symbol id="f-i-button" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><metadata id="acprefix__metadata8"><rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"><cc:Work rdf:about="" xmlns:cc="http://creativecommons.org/ns#"><dc:format xmlns:dc="http://purl.org/dc/elements/1.1/">image/svg+xml</dc:format><dc:type rdf:resource="http://purl.org/dc/dcmitype/StillImage" xmlns:dc="http://purl.org/dc/elements/1.1/"/><dc:title xmlns:dc="http://purl.org/dc/elements/1.1/"/></cc:Work></rdf:RDF></metadata><path id="acprefix__rect4140" d="M 0.4765625,4 A 0.47706934,0.47706934 0 0 0 0,4.4765625 L 0,11.523438 A 0.47706934,0.47706934 0 0 0 0.4765625,12 L 15.523438,12 A 0.47706934,0.47706934 0 0 0 16,11.523438 L 16,4.4765625 A 0.47706934,0.47706934 0 0 0 15.523438,4 L 0.4765625,4 Z m 0.4765625,0.953125 14.09375,0 0,6.09375 -14.09375,0 0,-6.09375 z"/><g id="acprefix__layer1"><g id="acprefix__text4203"><g id="acprefix__g4212" transform="translate(0.10112835,0.1001358)"><path id="acprefix__path4208" d="m 6.0690374,6.4093857 q -0.5371093,0 -0.8544922,0.4003906 -0.3149414,0.4003906 -0.3149414,1.0913086 0,0.6884766 0.3149414,1.0888672 0.3173829,0.4003906 0.8544922,0.4003906 0.5371094,0 0.8496094,-0.4003906 0.3149414,-0.4003906 0.3149414,-1.0888672 0,-0.690918 -0.3149414,-1.0913086 -0.3125,-0.4003906 -0.8496094,-0.4003906 z m 0,-0.4003906 q 0.7666016,0 1.225586,0.5151367 0.4589843,0.5126953 0.4589843,1.3769531 0,0.8618164 -0.4589843,1.3769531 -0.4589844,0.5126953 -1.225586,0.5126953 -0.7690429,0 -1.2304687,-0.5126953 -0.4589844,-0.5126953 -0.4589844,-1.3769531 0,-0.8642578 0.4589844,-1.3769531 0.4614258,-0.5151367 1.2304687,-0.5151367 z"/><path id="acprefix__path4210" d="m 8.5250921,6.074913 0.4931641,0 0,1.5405274 1.6357418,-1.5405274 0.634766,0 -1.809082,1.6992188 1.938477,1.9458008 -0.649415,0 -1.7504878,-1.7553711 0,1.7553711 -0.4931641,0 0,-3.6450196 z"/></g></g></g></symbol><symbol viewBox="0 0 32 32" id="f-i-calendar" xmlns="http://www.w3.org/2000/svg"><path d="M12.048 16.961c-0.178 0.257-0.395 0.901-0.652 1.059-0.257 0.157-0.547 0.267-0.869 0.328-0.323 0.062-0.657 0.089-1.002 0.079v1.527h2.467v6.046h1.991v-9.996h-1.584c-0.056 0.381-0.173 0.7-0.351 0.957zM23 8h2c0.553 0 1-0.448 1-1v-6c0-0.552-0.447-1-1-1h-2c-0.553 0-1 0.448-1 1v6c0 0.552 0.447 1 1 1zM7 8h2c0.552 0 1-0.448 1-1v-6c0-0.552-0.448-1-1-1h-2c-0.552 0-1 0.448-1 1v6c0 0.552 0.448 1 1 1zM30 4h-2v5c0 0.552-0.447 1-1 1h-6c-0.553 0-1-0.448-1-1v-5h-8v5c0 0.552-0.448 1-1 1h-6c-0.552 0-1-0.448-1-1v-5h-2c-1.104 0-2 0.896-2 2v24c0 1.104 0.896 2 2 2h28c1.104 0 2-0.896 2-2v-24c0-1.104-0.896-2-2-2zM30 29c0 0.553-0.447 1-1 1h-26c-0.552 0-1-0.447-1-1v-16c0-0.552 0.448-1 1-1h26c0.553 0 1 0.448 1 1v16zM15.985 17.982h4.968c-0.936 1.152-1.689 2.325-2.265 3.705-0.575 1.381-0.638 2.818-0.749 4.312h2.131c0.009-0.666-0.195-1.385-0.051-2.156 0.146-0.771 0.352-1.532 0.617-2.285 0.267-0.752 0.598-1.461 0.996-2.127 0.396-0.667 0.853-1.229 1.367-1.686v-1.742h-7.015v1.979z"/></symbol><symbol id="f-i-checkbox" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path d="M13.5,5v8c0,0.8-0.7,1.5-1.5,1.5H3c-0.8,0-1.5-0.7-1.5-1.5V4c0-0.8,0.7-1.5,1.5-1.5h9c0.7,0,1.3,0.5,1.5,1.2l2.4-1.4L13.5,5 z M12.5,6.2L7.7,12L2.8,5.5l4.9,1.6l4.8-2.9V4c0-0.3-0.2-0.5-0.5-0.5H3C2.7,3.5,2.5,3.7,2.5,4v9c0,0.3,0.2,0.5,0.5,0.5h9 c0.3,0,0.5-0.2,0.5-0.5V6.2z"/></symbol><symbol id="f-i-checkbox-group" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path d="M0,1h16V0H0V1z M0,3h16V2H0V3z M6,5v1h9V5H6z M15,14v-1H6v1H15z M6,10h9V9H6V10z M4,12l-2.5,1.5L0,13l1.5,2L4,12z M4,8 L1.5,9.5L0,9l1.5,2L4,8z M4,4L1.5,5.5L0,5l1.5,2L4,4z"/></symbol><symbol xml:space="preserve" viewBox="0 0 16 16" id="f-i-columns" xmlns="http://www.w3.org/2000/svg"><metadata id="agprefix__metadata4318"><rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"><cc:Work rdf:about="" xmlns:cc="http://creativecommons.org/ns#"><dc:format xmlns:dc="http://purl.org/dc/elements/1.1/">image/svg+xml</dc:format><dc:type rdf:resource="http://purl.org/dc/dcmitype/StillImage" xmlns:dc="http://purl.org/dc/elements/1.1/"/><dc:title xmlns:dc="http://purl.org/dc/elements/1.1/"/></cc:Work></rdf:RDF></metadata><path id="agprefix__rect4860-3-5" d="M 16,0.5 A 0.50004997,0.50004997 0 0 0 15.5,0 l -5,0 -5,0 -5,0 A 0.50004997,0.50004997 0 0 0 0,0.5 l 0,15 A 0.50004997,0.50004997 0 0 0 0.5,16 l 5,0 5,0 5,0 A 0.50004997,0.50004997 0 0 0 16,15.5 l 0,-15 z M 15,1 15,15 11,15 11,1 15,1 Z M 10,1 10,15 6,15 6,1 10,1 Z M 5,1 5,15 1,15 1,1 5,1 Z"/></symbol><symbol viewBox="0 0 32 32" id="f-i-copy" xmlns="http://www.w3.org/2000/svg"><path d="M20 8v-8h-14l-6 6v18h12v8h20v-24h-12zM6 2.828v3.172h-3.172l3.172-3.172zM2 22v-14h6v-6h10v6l-6 6v8h-10zM18 10.828v3.172h-3.172l3.172-3.172zM30 30h-16v-14h6v-6h10v20z"/></symbol><symbol id="f-i-divider" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg"><metadata id="aiprefix__metadata10"><rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"><cc:Work rdf:about="" xmlns:cc="http://creativecommons.org/ns#"><dc:format xmlns:dc="http://purl.org/dc/elements/1.1/">image/svg+xml</dc:format><dc:type rdf:resource="http://purl.org/dc/dcmitype/StillImage" xmlns:dc="http://purl.org/dc/elements/1.1/"/><dc:title xmlns:dc="http://purl.org/dc/elements/1.1/"/></cc:Work></rdf:RDF></metadata><rect y="7" x="0" height="1" width="15" id="aiprefix__rect4182"/></symbol><symbol viewBox="0 0 28 32" id="f-i-edit" xmlns="http://www.w3.org/2000/svg"><path d="M22 2l-4 4 6 6 4-4-6-6zM0 24l0.021 6.018 5.979-0.018 16-16-6-6-16 16zM6 28h-4v-4h2v2h2v2z"/></symbol><symbol fill="#000000" viewBox="0 0 24 24" id="f-i-email" xmlns="http://www.w3.org/2000/svg"><path d="M12,2 C17.4292399,2 21.8479317,6.32667079 21.9961582,11.7200952 L22,12 L22,13 C22,15.1729208 20.477434,17 18.5,17 C17.3269391,17 16.3139529,16.3570244 15.6839382,15.3803024 C14.770593,16.3757823 13.4581934,17 12,17 C9.23857625,17 7,14.7614237 7,12 C7,9.23857625 9.23857625,7 12,7 C14.6887547,7 16.8818181,9.12230671 16.9953805,11.7831104 L17,12 L17,13 C17,14.1407877 17.7160103,15 18.5,15 C19.2447902,15 19.928229,14.2245609 19.9947109,13.1689341 L20,13 L20,12 C20,7.581722 16.418278,4 12,4 C7.581722,4 4,7.581722 4,12 C4,16.418278 7.581722,20 12,20 C13.1630948,20 14.2892822,19.7522618 15.3225159,19.2798331 C15.8247876,19.0501777 16.4181317,19.271177 16.647787,19.7734487 C16.8774423,20.2757205 16.656443,20.8690646 16.1541713,21.0987199 C14.861218,21.689901 13.4515463,22 12,22 C6.4771525,22 2,17.5228475 2,12 C2,6.4771525 6.4771525,2 12,2 Z M12,9 C10.3431458,9 9,10.3431458 9,12 C9,13.6568542 10.3431458,15 12,15 C13.6568542,15 15,13.6568542 15,12 C15,10.3431458 13.6568542,9 12,9 Z"/></symbol><symbol viewBox="0 0 32 32" id="f-i-floppy-disk" xmlns="http://www.w3.org/2000/svg"><path d="M28 0h-28v32h32v-28l-4-4zM16 4h4v8h-4v-8zM28 28h-24v-24h2v10h18v-10h2.343l1.657 1.657v22.343z"/></symbol><symbol xml:space="preserve" viewBox="0 0 16 16" id="f-i-handle" xmlns="http://www.w3.org/2000/svg"><metadata id="aqprefix__metadata8"><rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"><cc:Work rdf:about="" xmlns:cc="http://creativecommons.org/ns#"><dc:format xmlns:dc="http://purl.org/dc/elements/1.1/">image/svg+xml</dc:format><dc:type rdf:resource="http://purl.org/dc/dcmitype/StillImage" xmlns:dc="http://purl.org/dc/elements/1.1/"/><dc:title xmlns:dc="http://purl.org/dc/elements/1.1/"/></cc:Work></rdf:RDF></metadata><g transform="translate(0,-2)" id="aqprefix__g4220"><rect id="aqprefix__rect4191" width="2" height="2" x="2" y="7"/><rect id="aqprefix__rect4191-2" width="2" height="2" x="7" y="7"/><rect id="aqprefix__rect4191-4" width="2" height="2" x="12" y="7"/></g><g transform="translate(0,2)" id="aqprefix__g4220-6"><rect id="aqprefix__rect4191-40" width="2" height="2" x="2" y="7"/><rect id="aqprefix__rect4191-2-3" width="2" height="2" x="7" y="7"/><rect id="aqprefix__rect4191-4-9" width="2" height="2" x="12" y="7"/></g></symbol><symbol xml:space="preserve" viewBox="0 0 16 16" id="f-i-handle-column" xmlns="http://www.w3.org/2000/svg"><path d="M2 7h2v2H2zM7 7h2v2H7zM12 7h2v2h-2zM2 12h2v2H2zM7 12h2v2H7zM12 12h2v2h-2z" transform="rotate(90 9.25 9.25)"/></symbol><symbol xml:space="preserve" viewBox="0 0 16 16" id="f-i-handle-field" xmlns="http://www.w3.org/2000/svg"><path d="M9.5-6.5h2v2h-2zm-5 0h2v2h-2zm5-5h2v2h-2zm-5 0h2v2h-2z" transform="rotate(90)"/></symbol><symbol xml:space="preserve" viewBox="0 0 16 16" id="f-i-handle-row" xmlns="http://www.w3.org/2000/svg"><path d="M12 9.5h2v2h-2zm-5 0h2v2H7Zm-5 0h2v2H2Zm10-5h2v2h-2zm-5 0h2v2H7Zm-5 0h2v2H2Z"/></symbol><symbol xml:space="preserve" viewBox="0 0 16 16" id="f-i-handle-stage" xmlns="http://www.w3.org/2000/svg"><path d="M2 4.5h2v2H2zM7 4.5h2v2H7zM12 4.5h2v2h-2zM2 9.5h2v2H2zM7 9.5h2v2H7zM12 9.5h2v2h-2zM2-.5h2v2H2zM7-.5h2v2H7zM12-.5h2v2h-2z" transform="translate(0 2.5)"/></symbol><symbol viewBox="0 0 448 512" id="f-i-hash" xmlns="http://www.w3.org/2000/svg"><g id="arprefix__icomoon-ignore"/><path fill="#000" d="M448 192v-64h-80.064l16-128h-64l-16 128h-127.968l16-128h-64l-16 128h-111.968v64h103.968l-15.968 128h-88v64h80l-16 128h64l16-128h127.968l-16 128h64.032l16-128h112v-64h-104l15.936-128h88.064zM279.968 320h-127.968l15.968-128h127.968l-15.968 128z"/></symbol><symbol viewBox="0 0 28 28" id="f-i-header" xmlns="http://www.w3.org/2000/svg"><path fill="#444" d="M26.281 26q-0.688 0-2.070-0.055t-2.086-0.055q-0.688 0-2.063 0.055t-2.063 0.055q-0.375 0-0.578-0.32t-0.203-0.711q0-0.484 0.266-0.719t0.609-0.266 0.797-0.109 0.703-0.234q0.516-0.328 0.516-2.188l-0.016-6.109q0-0.328-0.016-0.484-0.203-0.063-0.781-0.063h-10.547q-0.594 0-0.797 0.063-0.016 0.156-0.016 0.484l-0.016 5.797q0 2.219 0.578 2.562 0.25 0.156 0.75 0.203t0.891 0.055 0.703 0.234 0.313 0.711q0 0.406-0.195 0.75t-0.57 0.344q-0.734 0-2.18-0.055t-2.164-0.055q-0.672 0-2 0.055t-1.984 0.055q-0.359 0-0.555-0.328t-0.195-0.703q0-0.469 0.242-0.703t0.562-0.273 0.742-0.117 0.656-0.234q0.516-0.359 0.516-2.234l-0.016-0.891v-12.703q0-0.047 0.008-0.406t0-0.57-0.023-0.602-0.055-0.656-0.102-0.57-0.172-0.492-0.25-0.281q-0.234-0.156-0.703-0.187t-0.828-0.031-0.641-0.219-0.281-0.703q0-0.406 0.187-0.75t0.562-0.344q0.719 0 2.164 0.055t2.164 0.055q0.656 0 1.977-0.055t1.977-0.055q0.391 0 0.586 0.344t0.195 0.75q0 0.469-0.266 0.68t-0.602 0.227-0.773 0.063-0.672 0.203q-0.547 0.328-0.547 2.5l0.016 5q0 0.328 0.016 0.5 0.203 0.047 0.609 0.047h10.922q0.391 0 0.594-0.047 0.016-0.172 0.016-0.5l0.016-5q0-2.172-0.547-2.5-0.281-0.172-0.914-0.195t-1.031-0.203-0.398-0.773q0-0.406 0.195-0.75t0.586-0.344q0.688 0 2.063 0.055t2.063 0.055q0.672 0 2.016-0.055t2.016-0.055q0.391 0 0.586 0.344t0.195 0.75q0 0.469-0.273 0.688t-0.625 0.227-0.805 0.047-0.688 0.195q-0.547 0.359-0.547 2.516l0.016 14.734q0 1.859 0.531 2.188 0.25 0.156 0.719 0.211t0.836 0.070 0.648 0.242 0.281 0.695q0 0.406-0.187 0.75t-0.562 0.344z"/></symbol><symbol xml:space="preserve" viewBox="0 0 16 16" id="f-i-hidden" xmlns="http://www.w3.org/2000/svg"><path d="M0 12h1v-1H0Zm15-7h1V4h-1zm-1 7h1v-1h-1zm-2 0h1v-1h-1zm-2 0h1v-1h-1Zm-2 0h1v-1H8Zm-2 0h1v-1H6Zm-2 0h1v-1H4Zm-2 0h1v-1H2Zm13-1h1v-1h-1ZM0 10h1V9H0Zm15-1h1V8h-1ZM0 8h1V7H0Zm15-1h1V6h-1ZM0 6h1V5H0Zm13-1h1V4h-1zm-2 0h1V4h-1ZM9 5h1V4H9ZM7 5h1V4H7ZM5 5h1V4H5ZM3 5h1V4H3ZM1 5h1V4H1Z"/></symbol><symbol xml:space="preserve" viewBox="0 0 32 32" id="f-i-info-circle" xmlns="http://www.w3.org/2000/svg"><path d="m17.962 24.725 1.806.096v2.531h-7.534v-2.406l1.045-.094c.568-.063.916-.254.916-1.014v-8.801c0-.699-.188-.92-.791-.92l-1.106-.062v-2.626h5.666zM15.747 4.648c1.394 0 2.405 1.047 2.405 2.374 0 1.331-1.014 2.313-2.438 2.313-1.454 0-2.404-.982-2.404-2.313 0-1.327.95-2.374 2.437-2.374M16 32C7.178 32 0 24.822 0 16S7.178 0 16 0c8.82 0 16 7.178 16 16s-7.18 16-16 16m0-29C8.832 3 3 8.832 3 16s5.832 13 13 13 13-5.832 13-13S23.168 3 16 3"/></symbol><symbol viewBox="0 0 384 512" id="f-i-menu" xmlns="http://www.w3.org/2000/svg"><g id="avprefix__icomoon-ignore"/><path d="M0 96v64h384v-64h-384zM0 288h384v-64h-384v64zM0 416h384v-64h-384v64z"/></symbol><symbol viewBox="0 0 24 24" fill="none" id="f-i-minus" xmlns="http://www.w3.org/2000/svg"><path d="M6 12L18 12" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></symbol><symbol viewBox="0 0 512 512" id="f-i-move" xmlns="http://www.w3.org/2000/svg"><path d="M287.744 94.736v129.008h128v-64l96.256 96.256-96.256 96.24v-65.488h-128v129.008h64.496l-96.24 96.24-96.256-96.24h64v-129.008h-128v64.992l-95.744-95.744 95.744-95.744v63.488h128v-129.008h-62.496l94.752-94.736 94.752 94.736h-63.008z"/></symbol><symbol viewBox="0 0 512 512" id="f-i-move-vertical" xmlns="http://www.w3.org/2000/svg"><metadata id="axprefix__metadata10"><rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"><cc:Work rdf:about="" xmlns:cc="http://creativecommons.org/ns#"><dc:format xmlns:dc="http://purl.org/dc/elements/1.1/">image/svg+xml</dc:format><dc:type rdf:resource="http://purl.org/dc/dcmitype/StillImage" xmlns:dc="http://purl.org/dc/elements/1.1/"/><dc:title xmlns:dc="http://purl.org/dc/elements/1.1/"/></cc:Work></rdf:RDF></metadata><sodipodi:namedview pagecolor="#ffffff" bordercolor="#666666" borderopacity="1" objecttolerance="10" gridtolerance="10" guidetolerance="10" xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" inkscape:pageopacity="0" inkscape:pageshadow="2" inkscape:window-width="3440" inkscape:window-height="1416" id="axprefix__namedview6" showgrid="false" inkscape:zoom="1.84375" inkscape:cx="421.4312" inkscape:cy="218.56484" inkscape:window-x="0" inkscape:window-y="24" inkscape:window-maximized="1" inkscape:current-layer="svg2" xmlns:sodipodi="http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd"/><path d="m 287.744,94.736 0,321.024 64.496,0 L 256,512 l -96.256,-96.24 64,0 0,-321.024 -62.496,0 L 256,0 350.752,94.736 Z" id="axprefix__path4" xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" inkscape:connector-curvature="0" xmlns:sodipodi="http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd" sodipodi:nodetypes="ccccccccccc"/></symbol><symbol viewBox="0 0 20 28" id="f-i-paragraph" xmlns="http://www.w3.org/2000/svg"><path fill="#444" d="M19.969 2.953v1.141q0 0.453-0.289 0.953t-0.664 0.5q-0.781 0-0.844 0.016-0.406 0.094-0.5 0.484-0.047 0.172-0.047 1v18q0 0.391-0.281 0.672t-0.672 0.281h-1.687q-0.391 0-0.672-0.281t-0.281-0.672v-19.031h-2.234v19.031q0 0.391-0.273 0.672t-0.68 0.281h-1.687q-0.406 0-0.68-0.281t-0.273-0.672v-7.75q-2.297-0.187-3.828-0.922-1.969-0.906-3-2.797-1-1.828-1-4.047 0-2.594 1.375-4.469 1.375-1.844 3.266-2.484 1.734-0.578 6.516-0.578h7.484q0.391 0 0.672 0.281t0.281 0.672z"/></symbol><symbol id="f-i-phone-receiver" viewBox="0 0 578.106 578.106" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><g><g><path d="M577.83,456.128c1.225,9.385-1.635,17.545-8.568,24.48l-81.396,80.781 c-3.672,4.08-8.465,7.551-14.381,10.404c-5.916,2.857-11.729,4.693-17.439,5.508c-0.408,0-1.635,0.105-3.676,0.309 c-2.037,0.203-4.689,0.307-7.953,0.307c-7.754,0-20.301-1.326-37.641-3.979s-38.555-9.182-63.645-19.584 c-25.096-10.404-53.553-26.012-85.376-46.818c-31.823-20.805-65.688-49.367-101.592-85.68 c-28.56-28.152-52.224-55.08-70.992-80.783c-18.768-25.705-33.864-49.471-45.288-71.299 c-11.425-21.828-19.993-41.616-25.705-59.364S4.59,177.362,2.55,164.51s-2.856-22.95-2.448-30.294 c0.408-7.344,0.612-11.424,0.612-12.24c0.816-5.712,2.652-11.526,5.508-17.442s6.324-10.71,10.404-14.382L98.022,8.756 c5.712-5.712,12.24-8.568,19.584-8.568c5.304,0,9.996,1.53,14.076,4.59s7.548,6.834,10.404,11.322l65.484,124.236 c3.672,6.528,4.692,13.668,3.06,21.42c-1.632,7.752-5.1,14.28-10.404,19.584l-29.988,29.988c-0.816,0.816-1.53,2.142-2.142,3.978 s-0.918,3.366-0.918,4.59c1.632,8.568,5.304,18.36,11.016,29.376c4.896,9.792,12.444,21.726,22.644,35.802 s24.684,30.293,43.452,48.653c18.36,18.77,34.68,33.354,48.96,43.76c14.277,10.4,26.215,18.053,35.803,22.949 c9.588,4.896,16.932,7.854,22.031,8.871l7.648,1.531c0.816,0,2.145-0.307,3.979-0.918c1.836-0.613,3.162-1.326,3.979-2.143 l34.883-35.496c7.348-6.527,15.912-9.791,25.705-9.791c6.938,0,12.443,1.223,16.523,3.672h0.611l118.115,69.768 C571.098,441.238,576.197,447.968,577.83,456.128z"/></g></g><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/><g/></symbol><symbol viewBox="0 0 24 24" fill="none" id="f-i-plus" xmlns="http://www.w3.org/2000/svg"><path d="M6 12H18M12 6V18" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></symbol><symbol id="f-i-radio-group" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path d="M0,1h16V0H0V1z M0,3h16V2H0V3z M5,6h10V5H5V6z M15,9H5v1h10V9z M15,14v-1H5v1H15z M1.5,7C0.7,7,0,6.3,0,5.5S0.7,4,1.5,4 S3,4.7,3,5.5S2.3,7,1.5,7z M1.5,5C1.2,5,1,5.2,1,5.5S1.2,6,1.5,6S2,5.8,2,5.5S1.8,5,1.5,5z M1.5,11.1C0.7,11.1,0,10.4,0,9.6 s0.7-1.5,1.5-1.5S3,8.7,3,9.6S2.3,11.1,1.5,11.1z M1.5,9.1C1.2,9.1,1,9.3,1,9.6s0.2,0.5,0.5,0.5S2,9.8,2,9.6S1.8,9.1,1.5,9.1z M1.5,15C0.7,15,0,14.3,0,13.5S0.7,12,1.5,12S3,12.7,3,13.5S2.3,15,1.5,15z M1.5,13C1.2,13,1,13.2,1,13.5S1.2,14,1.5,14 S2,13.8,2,13.5S1.8,13,1.5,13z"/></symbol><symbol viewBox="0 0 512 512" id="f-i-remove" xmlns="http://www.w3.org/2000/svg"><path d="M193.694-139.2h87.322v510.916h-87.322zM-18.103 159.92V72.597h510.915v87.322z" transform="rotate(45 77.994 208.636)"/></symbol><symbol id="f-i-rich-text" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path d="M15,1H1C0.4,1,0,1.4,0,2v12c0,0.6,0.4,1,1,1h14c0.6,0,1-0.4,1-1V2C16,1.4,15.6,1,15,1z M1,3.1h0.8v0.3H1V3.1z M1,3.6h0.8 v0.3H1V3.6z M15,14H1V5.1h14V14z M15,4.9H1V4.6h14V4.9z M15,4.4H1V4.1h0.8v0.2h1.5V4.1h1.3v0.2H6V4.1h1.3v0.2h1.5V4.1H10v0.2h1.5 V4.1h1.3v0.2h1.5V4.1H15V4.4z M4.5,3.6v0.3H3.3V3.6H4.5z M3.3,3.4V3.1h1.3v0.3H3.3z M7.3,3.6v0.3H6V3.6H7.3z M6,3.4V3.1h1.3v0.3H6z M10,3.6v0.3H8.8V3.6H10z M8.8,3.4V3.1H10v0.3H8.8z M12.8,3.6v0.3h-1.3V3.6H12.8z M11.5,3.4V3.1h1.3v0.3H11.5z M15,3.9h-0.8V3.6H15 V3.9z M15,3.4h-0.8V3.1H15V3.4z M15,2.9h-0.8V2.8h-1.5v0.2h-1.3V2.8H10v0.2H8.8V2.8H7.3v0.2H6V2.8H4.5v0.2H3.3V2.8H1.8v0.2H1V2.6h14 V2.9z M15,2.4H1V2.1h14V2.4z M3,12v-1h10v1H3z M13,10H3V9h10V10z M11,8H3V7h8V8z"/></symbol><symbol xml:space="preserve" viewBox="0 0 16 16" id="f-i-rows" xmlns="http://www.w3.org/2000/svg"><metadata id="bfprefix__metadata4318"><rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"><cc:Work rdf:about="" xmlns:cc="http://creativecommons.org/ns#"><dc:format xmlns:dc="http://purl.org/dc/elements/1.1/">image/svg+xml</dc:format><dc:type rdf:resource="http://purl.org/dc/dcmitype/StillImage" xmlns:dc="http://purl.org/dc/elements/1.1/"/><dc:title xmlns:dc="http://purl.org/dc/elements/1.1/"/></cc:Work></rdf:RDF></metadata><g transform="matrix(0,1,-1,0,3.0984025,11.835155)" id="bfprefix__g7209"><path id="bfprefix__rect4860-3-5" d="m 4.1640625,-12.402344 a 0.50004997,0.50004997 0 0 0 -0.5,-0.5 l -5,0 -5,0 -5.0000005,0 a 0.50004997,0.50004997 0 0 0 -0.5,0.5 l 0,15.0000002 a 0.50004997,0.50004997 0 0 0 0.5,0.5 l 4.9648442,0 a 0.50004997,0.50004997 0 0 0 0.035156,0 l 4.9648437,0 a 0.50004997,0.50004997 0 0 0 0.035156,0 l 5,0 a 0.50004997,0.50004997 0 0 0 0.5,-0.5 l 0,-15.0000002 z m -1,0.5 0,14.0000002 -4,0 0,-14.0000002 4,0 z m -5,0 0,14.0000002 -4,0 0,-14.0000002 4,0 z m -5,0 0,14.0000002 -4.0000005,0 0,-14.0000002 4.0000005,0 z"/></g></symbol><symbol id="f-i-select" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path id="bgprefix__XMLID_1_" d="M0,0v14h0c0,0.6,0.4,1,1,1h10c0.6,0,1-0.4,1-1h0V5h4V0H0z M1,1h10v3H1V1z M1,7h10v3H1V7z M1,14v-3h10v3H1z M15,4h-3V1h3V4z M2,2h1v1H2V2z M2,12h1v1H2V12z M4,12h1v1H4V12z M6,12h1v1H6V12z M9,12v1H8v-1H9z M2,8h1v1H2V8z M4,8h1v1H4V8z M6,8 h1v1H6V8z M13.5,3.1l-1-1.1h1.9L13.5,3.1z M2,6V5h1v1H2L2,6z M4,6V5h1v1H4L4,6z"/></symbol><symbol viewBox="0 0 448 512" id="f-i-settings" xmlns="http://www.w3.org/2000/svg"><g id="bhprefix__icomoon-ignore"/><path d="M223.969 175c-44.703 0-80.969 36.266-80.969 81 0 44.688 36.266 81.031 80.969 81.031 44.719 0 80.719-36.344 80.719-81.031-0-44.734-36-81-80.719-81zM386.313 302.531l-14.594 35.156 29.469 57.875-36.094 36.094-59.218-27.969-35.156 14.438-17.844 54.625-2.281 7.25h-51.016l-22.078-61.656-35.156-14.5-57.952 29.344-36.078-36.063 27.938-59.25-14.484-35.125-61.767-20.156v-50.984l61.703-22.109 14.485-35.094-25.953-51.234-3.422-6.719 36.031-36.031 59.297 27.922 35.109-14.516 17.828-54.594 2.297-7.234h51l22.094 61.734 35.063 14.516 58.031-29.406 36.063 36.031-27.938 59.203 14.438 35.172 61.875 20.125v50.969l-61.688 22.187z"/></symbol><symbol id="f-i-text-input" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path id="biprefix__XMLID_10_" d="M15,4H4.5V3H6V2H4.5h-1H2v1h1.5v1H1C0.4,4,0,4.5,0,5v6c0,0.6,0.4,1,1,1h2.5v1H2v1h4v-1H4.5v-1H15 c0.6,0,1-0.4,1-1V5C16,4.5,15.6,4,15,4z M1,11V5h2.5v6H1z M15,11H4.5V5H15V11z"/></symbol><symbol id="f-i-textarea" viewBox="0 0 16 16" xml:space="preserve" xmlns="http://www.w3.org/2000/svg"><path id="bjprefix__XMLID_1_" d="M3,11v-1h8v1H3L3,11z M3,7h10V6H3V7L3,7z M3,8v1h10V8H3L3,8z M13,4H3v1h10V4L13,4z M16,14V2c0-0.6-0.4-1-1-1 H1C0.4,1,0,1.4,0,2v12c0,0.6,0.4,1,1,1h14C15.6,15,16,14.6,16,14z M15,2v12H1V2H15z"/></symbol><symbol viewBox="0 0 24 32" id="f-i-triangle-down" xmlns="http://www.w3.org/2000/svg"><path fill="#444" d="M0 12l11.992 11.992 11.992-11.992h-23.984z"/></symbol><symbol viewBox="0 0 12 32" id="f-i-triangle-left" xmlns="http://www.w3.org/2000/svg"><path fill="#444" d="M0 15.996l11.992 11.992v-23.984l-11.992 11.992z"/></symbol><symbol viewBox="0 0 12 32" id="f-i-triangle-right" xmlns="http://www.w3.org/2000/svg"><path fill="#444" d="M0.002 4.008l11.992 11.992-11.992 11.992v-23.984z"/></symbol><symbol viewBox="0 0 24 32" id="f-i-triangle-up" xmlns="http://www.w3.org/2000/svg"><path fill="#444" d="M11.992 8l-11.992 11.992h23.984l-11.992-11.992z"/></symbol><symbol viewBox="0 0 512 512" id="f-i-upload" xmlns="http://www.w3.org/2000/svg"><g id="boprefix__icomoon-ignore"/><path d="M240 352h-240v128h480v-128h-240zM448 416h-64v-32h64v32zM112 160l128-128 128 128h-80v160h-96v-160z"/></symbol></svg>',Hs=ju.name,Ws=ju.version,qn=Hs,Pf="formeo-sprite",Hf=null,Wf=`https://cdn.jsdelivr.net/npm/formeo@${Ws}/dist/${Pf}.svg`,zf=`https://cdn.jsdelivr.net/npm/formeo@${Ws}/dist/formeo.min.css`,ic="https://draggable.github.io/formeo/assets/css/formeo.min.css",ah="f-panel",lt="control-group",Nt=`${qn}-stage`,et=`${qn}-row`,tt=`${qn}-column`,Ft=`${qn}-field`,As="custom-column-widths",lh="column-preset",jr="resizing-columns",Bf=new Map([[Nt,et],[et,tt],[tt,Ft]]),zs=["stage","row","column","field"],Bs=zs.map(l=>`${l}s`);new Map(Bs.map((l,e)=>[l,zs[e]]));const jf=new RegExp(`^${Bs.join("|")}.`),ch=[...zs],Vf=[...Bs],Uf=new Map(Vf.map((l,e)=>[l,ch[e]])),Vr=ch.reduce((l,e)=>(l[e]=e,l),{}),Gf=[{name:"controls",className:lt},{name:"stage",className:Nt},{name:"row",className:et},{name:"column",className:tt},{name:"field",className:Ft}],js={controls:lt,stage:Nt,row:et,column:tt,field:Ft},qf=Object.entries(js).reduce((l,[e,t])=>(l[t]=e,l),{}),Kf=Object.values(js),Yf=new RegExp(`${Kf.join("|")}`,"g"),{childTypeMapVals:uh,childTypeIndexMapVals:Zf}=Gf.reduce((l,{name:e},t,n)=>{const{name:d}=n[t+1]||{};return d&&(l.childTypeMapVals.push([e,d]),l.childTypeIndexMapVals.push([`${e}s`,`${d}s`])),l},{childTypeMapVals:[],childTypeIndexMapVals:[]}),Xf=uh.slice().map(l=>l.slice().reverse()).reverse(),rc=new Map(uh),Qf=new Map(Zf),Jf=new Map(Xf.slice()),ep=[[{value:"100.0",label:"100%"}],[{value:"50.0,50.0",label:"50 | 50"},{value:"33.3,66.6",label:"33 | 66"},{value:"66.6,33.3",label:"66 | 33"}],[{value:"33.3,33.3,33.3",label:"33 | 33 | 33"},{value:"25.0,25.0,50.0",label:"25 | 25 | 50"},{value:"50.0,25.0,25.0",label:"50 | 25 | 25"},{value:"25.0,50.0,25.0",label:"25 | 50 | 25"}],[{value:"25.0,25.0,25.0,25.0",label:"25 | 25 | 25 | 25"}],[{value:"20.0,20.0,20.0,20.0,20.0",label:"20 | 20 | 20 | 20 | 20"}],[{value:"16.66,16.66,16.66,16.66,16.66,16.66",label:"16.66 | 16.66 | 16.66 | 16.66 | 16.66 | 16.66"}]],tp=new Map(ep.reduce((l,e,t)=>(l.push([t,e]),l),[])),hh=`${Hs}-formData`,oc=`${Hs}-locale`,Ze=333,vt=Math.round(Ze/2),Vs=Math.round(Ze*2),dh="formeoSaved",nn="formeoUpdated",np="formeoChanged",fh="formeoUpdatedStage",ph="formeoUpdatedRow",gh="formeoUpdatedColumn",mh="formeoUpdatedField",ip="formeoCleared",vh="formeoOnRender",rp="formeoConditionUpdated",Us="formeoAddedRow",Gs="formeoAddedColumn",qs="formeoAddedField",Ks="formeoRemovedRow",Ys="formeoRemovedColumn",Zs="formeoRemovedField",yh={equals:"==",notEquals:"!=",contains:"⊃",notContains:"!⊃"},op={and:"&&",or:"||"},bh={equals:"="},sp=["logical","source","sourceProperty","comparison","target","targetProperty","assignment","value"],sc=["isChecked","isNotChecked"],ac=["isVisible","isNotVisible"],yn=["value"],ap={comparison:yh,assignment:bh,logical:op},wh="if",lp="then",Xs=()=>({[wh]:[{source:"",sourceProperty:"",comparison:"",target:"",targetProperty:""}],[lp]:[{target:"",targetProperty:"",assignment:"",value:""}]}),cp=/(\b[0-9a-f]{8}\b-[0-9a-f]{4}-[0-9a-f]{4}-[0-9a-f]{4}-\b[0-9a-f]{12}\b)|(\b[0-9a-f]{8}\b)/g,$s=/\bcol-\w+-\d+/g,Ch="f-i-",Tn=()=>({id:He(),stages:{[He()]:{}},rows:{},columns:{},fields:{}}),Ln=["selected","checked"],up=Ln.toReversed(),hp=new Map([["config",new Set(["label","helpText","hideLabel","labelAfter","disableHtmlLabel","tooltip"])]]),dp="a an and as at but by for for from in into near nor of on onto or the to with".split(" ").map(l=>String.raw`\s${l}\s`),fp=new RegExp(String.raw`(?!${dp.join("|")})\w\S*`,"g"),pp=/\s+/g;function Xe(l){return typeof l!="string"||l.trim().match(pp)?l:l.replace(fp,t=>t.charAt(0).toUpperCase()+t.substring(1).replace(/[A-Z]/g,n=>` ${n}`))}const Sh=(l,e="-")=>l.toString().normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().trim().replace(/[^a-z0-9 -]/g,"").replace(/\s+/g,e),yt=l=>{if(Array.isArray(l))return l;const e=/[.[\]]/g,t=[];let n=0,d=e.exec(l);for(;d!==null;)t.push(l.slice(n,d.index)),n=d.index+d[0].length,d=e.exec(l);return n<l.length&&t.push(l.slice(n)),t.filter(Boolean)},lc=(l,e="-")=>yt(l).join(e),gp=l=>{const e=document.createElement("div");return e.innerHTML=l,e.textContent||e.innerText||""},mp=(l,e,t="…")=>{if(l.length<=e)return l;const n=l.slice(0,e),d=n.lastIndexOf(" ");let h=`${d>0?n.slice(0,d):n}`;return t&&(h+=t),h},vp=/^attrs\.|^meta\.|^options\.|^config\./g;function Rn(l){return l.replaceAll(vp,"")}var Ur,cc;function Qs(){if(cc)return Ur;cc=1;var l=It(),e=wt(),t="[object Symbol]";function n(d){return typeof d=="symbol"||e(d)&&l(d)==t}return Ur=n,Ur}var Gr,uc;function yp(){if(uc)return Gr;uc=1;var l=Ct(),e=Qs(),t=/\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,n=/^\w*$/;function d(h,g){if(l(h))return!1;var m=typeof h;return m=="number"||m=="symbol"||m=="boolean"||h==null||e(h)?!0:n.test(h)||!t.test(h)||g!=null&&h in Object(g)}return Gr=d,Gr}var qr,hc;function bp(){if(hc)return qr;hc=1;var l=Ds(),e="Expected a function";function t(n,d){if(typeof n!="function"||d!=null&&typeof d!="function")throw new TypeError(e);var h=function(){var g=arguments,m=d?d.apply(this,g):g[0],c=h.cache;if(c.has(m))return c.get(m);var f=n.apply(this,g);return h.cache=c.set(m,f)||c,f};return h.cache=new(t.Cache||l),h}return t.Cache=l,qr=t,qr}var Kr,dc;function wp(){if(dc)return Kr;dc=1;var l=bp(),e=500;function t(n){var d=l(n,function(g){return h.size===e&&h.clear(),g}),h=d.cache;return d}return Kr=t,Kr}var Yr,fc;function Cp(){if(fc)return Yr;fc=1;var l=wp(),e=/[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g,t=/\\(\\)?/g,n=l(function(d){var h=[];return d.charCodeAt(0)===46&&h.push(""),d.replace(e,function(g,m,c,f){h.push(c?f.replace(t,"$1"):m||g)}),h});return Yr=n,Yr}var Zr,pc;function Sp(){if(pc)return Zr;pc=1;function l(e,t){for(var n=-1,d=e==null?0:e.length,h=Array(d);++n<d;)h[n]=t(e[n],n,e);return h}return Zr=l,Zr}var Xr,gc;function Ap(){if(gc)return Xr;gc=1;var l=Bn(),e=Sp(),t=Ct(),n=Qs(),d=l?l.prototype:void 0,h=d?d.toString:void 0;function g(m){if(typeof m=="string")return m;if(t(m))return e(m,g)+"";if(n(m))return h?h.call(m):"";var c=m+"";return c=="0"&&1/m==-1/0?"-0":c}return Xr=g,Xr}var Qr,mc;function Kn(){if(mc)return Qr;mc=1;var l=Ap();function e(t){return t==null?"":l(t)}return Qr=e,Qr}var Jr,vc;function Ah(){if(vc)return Jr;vc=1;var l=Ct(),e=yp(),t=Cp(),n=Kn();function d(h,g){return l(h)?h:e(h,g)?[h]:t(n(h))}return Jr=d,Jr}var eo,yc;function $h(){if(yc)return eo;yc=1;var l=Qs();function e(t){if(typeof t=="string"||l(t))return t;var n=t+"";return n=="0"&&1/t==-1/0?"-0":n}return eo=e,eo}var to,bc;function $p(){if(bc)return to;bc=1;var l=Ah(),e=$h();function t(n,d){d=l(d,n);for(var h=0,g=d.length;n!=null&&h<g;)n=n[e(d[h++])];return h&&h==g?n:void 0}return to=t,to}var no,wc;function xp(){if(wc)return no;wc=1;var l=$p();function e(t,n,d){var h=t==null?void 0:l(t,n);return h===void 0?d:h}return no=e,no}var Mp=xp();const Ep=Ot(Mp);var io,Cc;function _p(){if(Cc)return io;Cc=1;var l=th(),e=Ah(),t=Ps(),n=ut(),d=$h();function h(g,m,c,f){if(!n(g))return g;m=e(m,g);for(var r=-1,o=m.length,a=o-1,s=g;s!=null&&++r<o;){var i=d(m[r]),u=c;if(i==="__proto__"||i==="constructor"||i==="prototype")return g;if(r!=a){var p=s[i];u=f?f(p,i,s):void 0,u===void 0&&(u=n(p)?p:t(m[r+1])?[]:{})}l(s,i,u),s=s[i]}return g}return io=h,io}var ro,Sc;function Tp(){if(Sc)return ro;Sc=1;var l=_p();function e(t,n,d){return t==null?t:l(t,n,d)}return ro=e,ro}var Lp=Tp();const Rp=Ot(Lp),Re=Ep,Yn=Rp;function kp(l,e={}){const t={...l};for(const n in e)Object.hasOwn(e,n)&&(Object.hasOwn(t,n)?Array.isArray(t[n])?t[n].push(e[n]):t[n]=[t[n],e[n]]:t[n]=e[n]);return t}function bn(...l){return l.flat().reduce((e,t)=>(e[t]=t,e),{})}var oo,Ac;function Dp(){if(Ac)return oo;Ac=1;var l="__lodash_hash_undefined__";function e(t){return this.__data__.set(t,l),this}return oo=e,oo}var so,$c;function Op(){if($c)return so;$c=1;function l(e){return this.__data__.has(e)}return so=l,so}var ao,xc;function Ip(){if(xc)return ao;xc=1;var l=Ds(),e=Dp(),t=Op();function n(d){var h=-1,g=d==null?0:d.length;for(this.__data__=new l;++h<g;)this.add(d[h])}return n.prototype.add=n.prototype.push=e,n.prototype.has=t,ao=n,ao}var lo,Mc;function Np(){if(Mc)return lo;Mc=1;function l(e,t){for(var n=-1,d=e==null?0:e.length;++n<d;)if(t(e[n],n,e))return!0;return!1}return lo=l,lo}var co,Ec;function Fp(){if(Ec)return co;Ec=1;function l(e,t){return e.has(t)}return co=l,co}var uo,_c;function xh(){if(_c)return uo;_c=1;var l=Ip(),e=Np(),t=Fp(),n=1,d=2;function h(g,m,c,f,r,o){var a=c&n,s=g.length,i=m.length;if(s!=i&&!(a&&i>s))return!1;var u=o.get(g),p=o.get(m);if(u&&p)return u==m&&p==g;var y=-1,b=!0,M=c&d?new l:void 0;for(o.set(g,m),o.set(m,g);++y<s;){var $=g[y],A=m[y];if(f)var S=a?f(A,$,y,m,g,o):f($,A,y,g,m,o);if(S!==void 0){if(S)continue;b=!1;break}if(M){if(!e(m,function(E,R){if(!t(M,R)&&($===E||r($,E,c,f,o)))return M.push(R)})){b=!1;break}}else if(!($===A||r($,A,c,f,o))){b=!1;break}}return o.delete(g),o.delete(m),b}return uo=h,uo}var ho,Tc;function Pp(){if(Tc)return ho;Tc=1;function l(e){var t=-1,n=Array(e.size);return e.forEach(function(d,h){n[++t]=[h,d]}),n}return ho=l,ho}var fo,Lc;function Hp(){if(Lc)return fo;Lc=1;function l(e){var t=-1,n=Array(e.size);return e.forEach(function(d){n[++t]=d}),n}return fo=l,fo}var po,Rc;function Wp(){if(Rc)return po;Rc=1;var l=Bn(),e=Yu(),t=sn(),n=xh(),d=Pp(),h=Hp(),g=1,m=2,c="[object Boolean]",f="[object Date]",r="[object Error]",o="[object Map]",a="[object Number]",s="[object RegExp]",i="[object Set]",u="[object String]",p="[object Symbol]",y="[object ArrayBuffer]",b="[object DataView]",M=l?l.prototype:void 0,$=M?M.valueOf:void 0;function A(S,E,R,L,_,D,w){switch(R){case b:if(S.byteLength!=E.byteLength||S.byteOffset!=E.byteOffset)return!1;S=S.buffer,E=E.buffer;case y:return!(S.byteLength!=E.byteLength||!D(new e(S),new e(E)));case c:case f:case a:return t(+S,+E);case r:return S.name==E.name&&S.message==E.message;case s:case u:return S==E+"";case o:var v=d;case i:var C=L&g;if(v||(v=h),S.size!=E.size&&!C)return!1;var x=w.get(S);if(x)return x==E;L|=m,w.set(S,E);var T=n(v(S),v(E),L,_,D,w);return w.delete(S),T;case p:if($)return $.call(S)==$.call(E)}return!1}return po=A,po}var go,kc;function zp(){if(kc)return go;kc=1;function l(e,t){for(var n=-1,d=t.length,h=e.length;++n<d;)e[h+n]=t[n];return e}return go=l,go}var mo,Dc;function Bp(){if(Dc)return mo;Dc=1;var l=zp(),e=Ct();function t(n,d,h){var g=d(n);return e(n)?g:l(g,h(n))}return mo=t,mo}var vo,Oc;function jp(){if(Oc)return vo;Oc=1;function l(e,t){for(var n=-1,d=e==null?0:e.length,h=0,g=[];++n<d;){var m=e[n];t(m,n,e)&&(g[h++]=m)}return g}return vo=l,vo}var yo,Ic;function Vp(){if(Ic)return yo;Ic=1;function l(){return[]}return yo=l,yo}var bo,Nc;function Up(){if(Nc)return bo;Nc=1;var l=jp(),e=Vp(),t=Object.prototype,n=t.propertyIsEnumerable,d=Object.getOwnPropertySymbols,h=d?function(g){return g==null?[]:(g=Object(g),l(d(g),function(m){return n.call(g,m)}))}:e;return bo=h,bo}var wo,Fc;function Gp(){if(Fc)return wo;Fc=1;var l=Zu(),e=l(Object.keys,Object);return wo=e,wo}var Co,Pc;function qp(){if(Pc)return Co;Pc=1;var l=Is(),e=Gp(),t=Object.prototype,n=t.hasOwnProperty;function d(h){if(!l(h))return e(h);var g=[];for(var m in Object(h))n.call(h,m)&&m!="constructor"&&g.push(m);return g}return Co=d,Co}var So,Hc;function Kp(){if(Hc)return So;Hc=1;var l=nh(),e=qp(),t=Un();function n(d){return t(d)?l(d):e(d)}return So=n,So}var Ao,Wc;function Yp(){if(Wc)return Ao;Wc=1;var l=Bp(),e=Up(),t=Kp();function n(d){return l(d,t,e)}return Ao=n,Ao}var $o,zc;function Zp(){if(zc)return $o;zc=1;var l=Yp(),e=1,t=Object.prototype,n=t.hasOwnProperty;function d(h,g,m,c,f,r){var o=m&e,a=l(h),s=a.length,i=l(g),u=i.length;if(s!=u&&!o)return!1;for(var p=s;p--;){var y=a[p];if(!(o?y in g:n.call(g,y)))return!1}var b=r.get(h),M=r.get(g);if(b&&M)return b==g&&M==h;var $=!0;r.set(h,g),r.set(g,h);for(var A=o;++p<s;){y=a[p];var S=h[y],E=g[y];if(c)var R=o?c(E,S,y,g,h,r):c(S,E,y,h,g,r);if(!(R===void 0?S===E||f(S,E,m,c,r):R)){$=!1;break}A||(A=y=="constructor")}if($&&!A){var L=h.constructor,_=g.constructor;L!=_&&"constructor"in h&&"constructor"in g&&!(typeof L=="function"&&L instanceof L&&typeof _=="function"&&_ instanceof _)&&($=!1)}return r.delete(h),r.delete(g),$}return $o=d,$o}var xo,Bc;function Xp(){if(Bc)return xo;Bc=1;var l=bt(),e=Ke(),t=l(e,"DataView");return xo=t,xo}var Mo,jc;function Qp(){if(jc)return Mo;jc=1;var l=bt(),e=Ke(),t=l(e,"Promise");return Mo=t,Mo}var Eo,Vc;function Jp(){if(Vc)return Eo;Vc=1;var l=bt(),e=Ke(),t=l(e,"Set");return Eo=t,Eo}var _o,Uc;function eg(){if(Uc)return _o;Uc=1;var l=bt(),e=Ke(),t=l(e,"WeakMap");return _o=t,_o}var To,Gc;function tg(){if(Gc)return To;Gc=1;var l=Xp(),e=ks(),t=Qp(),n=Jp(),d=eg(),h=It(),g=Uu(),m="[object Map]",c="[object Object]",f="[object Promise]",r="[object Set]",o="[object WeakMap]",a="[object DataView]",s=g(l),i=g(e),u=g(t),p=g(n),y=g(d),b=h;return(l&&b(new l(new ArrayBuffer(1)))!=a||e&&b(new e)!=m||t&&b(t.resolve())!=f||n&&b(new n)!=r||d&&b(new d)!=o)&&(b=function(M){var $=h(M),A=$==c?M.constructor:void 0,S=A?g(A):"";if(S)switch(S){case s:return a;case i:return m;case u:return f;case p:return r;case y:return o}return $}),To=b,To}var Lo,qc;function ng(){if(qc)return Lo;qc=1;var l=Gu(),e=xh(),t=Wp(),n=Zp(),d=tg(),h=Ct(),g=Ns(),m=Fs(),c=1,f="[object Arguments]",r="[object Array]",o="[object Object]",a=Object.prototype,s=a.hasOwnProperty;function i(u,p,y,b,M,$){var A=h(u),S=h(p),E=A?r:d(u),R=S?r:d(p);E=E==f?o:E,R=R==f?o:R;var L=E==o,_=R==o,D=E==R;if(D&&g(u)){if(!g(p))return!1;A=!0,L=!1}if(D&&!L)return $||($=new l),A||m(u)?e(u,p,y,b,M,$):t(u,p,E,y,b,M,$);if(!(y&c)){var w=L&&s.call(u,"__wrapped__"),v=_&&s.call(p,"__wrapped__");if(w||v){var C=w?u.value():u,x=v?p.value():p;return $||($=new l),M(C,x,y,b,$)}}return D?($||($=new l),n(u,p,y,b,M,$)):!1}return Lo=i,Lo}var Ro,Kc;function ig(){if(Kc)return Ro;Kc=1;var l=ng(),e=wt();function t(n,d,h,g,m){return n===d?!0:n==null||d==null||!e(n)&&!e(d)?n!==n&&d!==d:l(n,d,h,g,t,m)}return Ro=t,Ro}var ko,Yc;function rg(){if(Yc)return ko;Yc=1;var l=ig();function e(t,n){return l(t,n)}return ko=e,ko}var og=rg();const xs=Ot(og),sg=(l,e)=>l===void 0?"added":e===void 0?"removed":xs(l,e)?"unchanged":"changed";class Js{constructor(e,t=Object.create(null)){this.name=e,this.data=t,this.dataPath=""}get size(){return Object.keys(this.data).length}get js(){return this.data}get json(){return this.data}toJSON=(e,t)=>JSON.stringify(e,null,t);get=e=>Re(this.data,e);set(e,t){const n=Re(this.data,e),d=Yn(this.data,e,t),h=Array.isArray(e)?e.join("."):e,g=Object.keys(this.setCallbacks).filter(c=>new RegExp(c).test(h)),m={newVal:t,oldVal:n,path:e};for(const c of g)for(const f of this.setCallbacks[c])f(m);if(!this.disableEvents){const c={entity:this,dataPath:this.dataPath.replace(/\.+$/,""),changePath:this.dataPath+e,value:t,data:d,changeType:sg(n,t),src:this.dom};if(n&&(c.previousValue=n),J.formeoUpdated(c),this.name){const r={stage:fh,row:ph,column:gh,field:mh}[this.name];r&&J.formeoUpdated(c,r)}}return d}addSetCallback(e,t){this.setCallbacks[e]?this.setCallbacks[e].push(t):this.setCallbacks[e]=[t]}removeSetCallback(e,t){this.setCallbacks[e]=this.setCallbacks[e].filter(n=>n!==t)}add=(e,t=Object.create(null))=>{const{id:n}=t,d=e||n||He();return this.set(d,t)};remove=e=>{const t=yt(e),n=t.pop(),d=this.get(t);return Array.isArray(d)?d.splice(Number(n),1):d&&delete d[n],d};empty(){this.data=Object.create(null)}getData=()=>Object.entries(this.data).reduce((e,[t,n])=>(e[t]=n?.data?n.getData():n,e),{});setCallbacks={};configVal=Object.create(null)}class Zn extends Js{load=e=>{const t=Gn(e);this.empty();for(const[n,d]of Object.entries(t))this.add(n,d);return this.data};get=e=>e?Re(this.data,e):this.add();add=(e,t=Object.create(null))=>{const n=e||He(),d=this.Component({...t,id:n});this.data[n]=d,this.active=d;const g={row:Us,column:Gs,field:qs}[this.name];return g&&J.formeoUpdated({entity:d,componentId:n,componentType:this.name,data:d.data},g),d};remove=e=>{if(Array.isArray(e))for(const t of e)this.get(t).remove();else this.get(e).remove();return this.data};delete=e=>(delete this.data[e],e);clearAll=(e=!0)=>{const t=Object.values(this.data).map(n=>n.empty(e));return Promise.all(t)};set config(e){this.configVal=Ve(this.configVal,Je(e))}get config(){return this.configVal}conditionMap=new Map}function Zc(l,e){var t=Object.keys(l);if(Object.getOwnPropertySymbols){var n=Object.getOwnPropertySymbols(l);e&&(n=n.filter(function(d){return Object.getOwnPropertyDescriptor(l,d).enumerable})),t.push.apply(t,n)}return t}function qe(l){for(var e=1;e<arguments.length;e++){var t=arguments[e]!=null?arguments[e]:{};e%2?Zc(Object(t),!0).forEach(function(n){ag(l,n,t[n])}):Object.getOwnPropertyDescriptors?Object.defineProperties(l,Object.getOwnPropertyDescriptors(t)):Zc(Object(t)).forEach(function(n){Object.defineProperty(l,n,Object.getOwnPropertyDescriptor(t,n))})}return l}function wn(l){"@babel/helpers - typeof";return typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?wn=function(e){return typeof e}:wn=function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},wn(l)}function ag(l,e,t){return e in l?Object.defineProperty(l,e,{value:t,enumerable:!0,configurable:!0,writable:!0}):l[e]=t,l}function nt(){return nt=Object.assign||function(l){for(var e=1;e<arguments.length;e++){var t=arguments[e];for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(l[n]=t[n])}return l},nt.apply(this,arguments)}function lg(l,e){if(l==null)return{};var t={},n=Object.keys(l),d,h;for(h=0;h<n.length;h++)d=n[h],!(e.indexOf(d)>=0)&&(t[d]=l[d]);return t}function cg(l,e){if(l==null)return{};var t=lg(l,e),n,d;if(Object.getOwnPropertySymbols){var h=Object.getOwnPropertySymbols(l);for(d=0;d<h.length;d++)n=h[d],!(e.indexOf(n)>=0)&&Object.prototype.propertyIsEnumerable.call(l,n)&&(t[n]=l[n])}return t}var ug="1.15.3";function Qe(l){if(typeof window<"u"&&window.navigator)return!!navigator.userAgent.match(l)}var rt=Qe(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),an=Qe(/Edge/i),Xc=Qe(/firefox/i),Zt=Qe(/safari/i)&&!Qe(/chrome/i)&&!Qe(/android/i),Mh=Qe(/iP(ad|od|hone)/i),Eh=Qe(/chrome/i)&&Qe(/android/i),_h={capture:!1,passive:!1};function se(l,e,t){l.addEventListener(e,t,!rt&&_h)}function oe(l,e,t){l.removeEventListener(e,t,!rt&&_h)}function kn(l,e){if(e){if(e[0]===">"&&(e=e.substring(1)),l)try{if(l.matches)return l.matches(e);if(l.msMatchesSelector)return l.msMatchesSelector(e);if(l.webkitMatchesSelector)return l.webkitMatchesSelector(e)}catch{return!1}return!1}}function Th(l){return l.host&&l!==document&&l.host.nodeType?l.host:l.parentNode}function je(l,e,t,n){if(l){t=t||document;do{if(e!=null&&(e[0]===">"?l.parentNode===t&&kn(l,e):kn(l,e))||n&&l===t)return l;if(l===t)break}while(l=Th(l))}return null}var Qc=/\s+/g;function Oe(l,e,t){if(l&&e)if(l.classList)l.classList[t?"add":"remove"](e);else{var n=(" "+l.className+" ").replace(Qc," ").replace(" "+e+" "," ");l.className=(n+(t?" "+e:"")).replace(Qc," ")}}function ne(l,e,t){var n=l&&l.style;if(n){if(t===void 0)return document.defaultView&&document.defaultView.getComputedStyle?t=document.defaultView.getComputedStyle(l,""):l.currentStyle&&(t=l.currentStyle),e===void 0?t:t[e];!(e in n)&&e.indexOf("webkit")===-1&&(e="-webkit-"+e),n[e]=t+(typeof t=="string"?"":"px")}}function Tt(l,e){var t="";if(typeof l=="string")t=l;else do{var n=ne(l,"transform");n&&n!=="none"&&(t=n+" "+t)}while(!e&&(l=l.parentNode));var d=window.DOMMatrix||window.WebKitCSSMatrix||window.CSSMatrix||window.MSCSSMatrix;return d&&new d(t)}function Lh(l,e,t){if(l){var n=l.getElementsByTagName(e),d=0,h=n.length;if(t)for(;d<h;d++)t(n[d],d);return n}return[]}function Ge(){var l=document.scrollingElement;return l||document.documentElement}function we(l,e,t,n,d){if(!(!l.getBoundingClientRect&&l!==window)){var h,g,m,c,f,r,o;if(l!==window&&l.parentNode&&l!==Ge()?(h=l.getBoundingClientRect(),g=h.top,m=h.left,c=h.bottom,f=h.right,r=h.height,o=h.width):(g=0,m=0,c=window.innerHeight,f=window.innerWidth,r=window.innerHeight,o=window.innerWidth),(e||t)&&l!==window&&(d=d||l.parentNode,!rt))do if(d&&d.getBoundingClientRect&&(ne(d,"transform")!=="none"||t&&ne(d,"position")!=="static")){var a=d.getBoundingClientRect();g-=a.top+parseInt(ne(d,"border-top-width")),m-=a.left+parseInt(ne(d,"border-left-width")),c=g+h.height,f=m+h.width;break}while(d=d.parentNode);if(n&&l!==window){var s=Tt(d||l),i=s&&s.a,u=s&&s.d;s&&(g/=u,m/=i,o/=i,r/=u,c=g+r,f=m+o)}return{top:g,left:m,bottom:c,right:f,width:o,height:r}}}function Jc(l,e,t){for(var n=at(l,!0),d=we(l)[e];n;){var h=we(n)[t],g=void 0;if(g=d>=h,!g)return n;if(n===Ge())break;n=at(n,!1)}return!1}function Rt(l,e,t,n){for(var d=0,h=0,g=l.children;h<g.length;){if(g[h].style.display!=="none"&&g[h]!==te.ghost&&(n||g[h]!==te.dragged)&&je(g[h],t.draggable,l,!1)){if(d===e)return g[h];d++}h++}return null}function ea(l,e){for(var t=l.lastElementChild;t&&(t===te.ghost||ne(t,"display")==="none"||e&&!kn(t,e));)t=t.previousElementSibling;return t||null}function Fe(l,e){var t=0;if(!l||!l.parentNode)return-1;for(;l=l.previousElementSibling;)l.nodeName.toUpperCase()!=="TEMPLATE"&&l!==te.clone&&(!e||kn(l,e))&&t++;return t}function eu(l){var e=0,t=0,n=Ge();if(l)do{var d=Tt(l),h=d.a,g=d.d;e+=l.scrollLeft*h,t+=l.scrollTop*g}while(l!==n&&(l=l.parentNode));return[e,t]}function hg(l,e){for(var t in l)if(l.hasOwnProperty(t)){for(var n in e)if(e.hasOwnProperty(n)&&e[n]===l[t][n])return Number(t)}return-1}function at(l,e){if(!l||!l.getBoundingClientRect)return Ge();var t=l,n=!1;do if(t.clientWidth<t.scrollWidth||t.clientHeight<t.scrollHeight){var d=ne(t);if(t.clientWidth<t.scrollWidth&&(d.overflowX=="auto"||d.overflowX=="scroll")||t.clientHeight<t.scrollHeight&&(d.overflowY=="auto"||d.overflowY=="scroll")){if(!t.getBoundingClientRect||t===document.body)return Ge();if(n||e)return t;n=!0}}while(t=t.parentNode);return Ge()}function dg(l,e){if(l&&e)for(var t in e)e.hasOwnProperty(t)&&(l[t]=e[t]);return l}function Do(l,e){return Math.round(l.top)===Math.round(e.top)&&Math.round(l.left)===Math.round(e.left)&&Math.round(l.height)===Math.round(e.height)&&Math.round(l.width)===Math.round(e.width)}var Xt;function Rh(l,e){return function(){if(!Xt){var t=arguments,n=this;t.length===1?l.call(n,t[0]):l.apply(n,t),Xt=setTimeout(function(){Xt=void 0},e)}}}function fg(){clearTimeout(Xt),Xt=void 0}function kh(l,e,t){l.scrollLeft+=e,l.scrollTop+=t}function Dh(l){var e=window.Polymer,t=window.jQuery||window.Zepto;return e&&e.dom?e.dom(l).cloneNode(!0):t?t(l).clone(!0)[0]:l.cloneNode(!0)}function Oh(l,e,t){var n={};return Array.from(l.children).forEach(function(d){var h,g,m,c;if(!(!je(d,e.draggable,l,!1)||d.animated||d===t)){var f=we(d);n.left=Math.min((h=n.left)!==null&&h!==void 0?h:1/0,f.left),n.top=Math.min((g=n.top)!==null&&g!==void 0?g:1/0,f.top),n.right=Math.max((m=n.right)!==null&&m!==void 0?m:-1/0,f.right),n.bottom=Math.max((c=n.bottom)!==null&&c!==void 0?c:-1/0,f.bottom)}}),n.width=n.right-n.left,n.height=n.bottom-n.top,n.x=n.left,n.y=n.top,n}var ke="Sortable"+new Date().getTime();function pg(){var l=[],e;return{captureAnimationState:function(){if(l=[],!!this.options.animation){var n=[].slice.call(this.el.children);n.forEach(function(d){if(!(ne(d,"display")==="none"||d===te.ghost)){l.push({target:d,rect:we(d)});var h=qe({},l[l.length-1].rect);if(d.thisAnimationDuration){var g=Tt(d,!0);g&&(h.top-=g.f,h.left-=g.e)}d.fromRect=h}})}},addAnimationState:function(n){l.push(n)},removeAnimationState:function(n){l.splice(hg(l,{target:n}),1)},animateAll:function(n){var d=this;if(!this.options.animation){clearTimeout(e),typeof n=="function"&&n();return}var h=!1,g=0;l.forEach(function(m){var c=0,f=m.target,r=f.fromRect,o=we(f),a=f.prevFromRect,s=f.prevToRect,i=m.rect,u=Tt(f,!0);u&&(o.top-=u.f,o.left-=u.e),f.toRect=o,f.thisAnimationDuration&&Do(a,o)&&!Do(r,o)&&(i.top-o.top)/(i.left-o.left)===(r.top-o.top)/(r.left-o.left)&&(c=mg(i,a,s,d.options)),Do(o,r)||(f.prevFromRect=r,f.prevToRect=o,c||(c=d.options.animation),d.animate(f,i,o,c)),c&&(h=!0,g=Math.max(g,c),clearTimeout(f.animationResetTimer),f.animationResetTimer=setTimeout(function(){f.animationTime=0,f.prevFromRect=null,f.fromRect=null,f.prevToRect=null,f.thisAnimationDuration=null},c),f.thisAnimationDuration=c)}),clearTimeout(e),h?e=setTimeout(function(){typeof n=="function"&&n()},g):typeof n=="function"&&n(),l=[]},animate:function(n,d,h,g){if(g){ne(n,"transition",""),ne(n,"transform","");var m=Tt(this.el),c=m&&m.a,f=m&&m.d,r=(d.left-h.left)/(c||1),o=(d.top-h.top)/(f||1);n.animatingX=!!r,n.animatingY=!!o,ne(n,"transform","translate3d("+r+"px,"+o+"px,0)"),this.forRepaintDummy=gg(n),ne(n,"transition","transform "+g+"ms"+(this.options.easing?" "+this.options.easing:"")),ne(n,"transform","translate3d(0,0,0)"),typeof n.animated=="number"&&clearTimeout(n.animated),n.animated=setTimeout(function(){ne(n,"transition",""),ne(n,"transform",""),n.animated=!1,n.animatingX=!1,n.animatingY=!1},g)}}}}function gg(l){return l.offsetWidth}function mg(l,e,t,n){return Math.sqrt(Math.pow(e.top-l.top,2)+Math.pow(e.left-l.left,2))/Math.sqrt(Math.pow(e.top-t.top,2)+Math.pow(e.left-t.left,2))*n.animation}var St=[],Oo={initializeByDefault:!0},ln={mount:function(e){for(var t in Oo)Oo.hasOwnProperty(t)&&!(t in e)&&(e[t]=Oo[t]);St.forEach(function(n){if(n.pluginName===e.pluginName)throw"Sortable: Cannot mount plugin ".concat(e.pluginName," more than once")}),St.push(e)},pluginEvent:function(e,t,n){var d=this;this.eventCanceled=!1,n.cancel=function(){d.eventCanceled=!0};var h=e+"Global";St.forEach(function(g){t[g.pluginName]&&(t[g.pluginName][h]&&t[g.pluginName][h](qe({sortable:t},n)),t.options[g.pluginName]&&t[g.pluginName][e]&&t[g.pluginName][e](qe({sortable:t},n)))})},initializePlugins:function(e,t,n,d){St.forEach(function(m){var c=m.pluginName;if(!(!e.options[c]&&!m.initializeByDefault)){var f=new m(e,t,e.options);f.sortable=e,f.options=e.options,e[c]=f,nt(n,f.defaults)}});for(var h in e.options)if(e.options.hasOwnProperty(h)){var g=this.modifyOption(e,h,e.options[h]);typeof g<"u"&&(e.options[h]=g)}},getEventProperties:function(e,t){var n={};return St.forEach(function(d){typeof d.eventProperties=="function"&&nt(n,d.eventProperties.call(t[d.pluginName],e))}),n},modifyOption:function(e,t,n){var d;return St.forEach(function(h){e[h.pluginName]&&h.optionListeners&&typeof h.optionListeners[t]=="function"&&(d=h.optionListeners[t].call(e[h.pluginName],n))}),d}};function vg(l){var e=l.sortable,t=l.rootEl,n=l.name,d=l.targetEl,h=l.cloneEl,g=l.toEl,m=l.fromEl,c=l.oldIndex,f=l.newIndex,r=l.oldDraggableIndex,o=l.newDraggableIndex,a=l.originalEvent,s=l.putSortable,i=l.extraEventProperties;if(e=e||t&&t[ke],!!e){var u,p=e.options,y="on"+n.charAt(0).toUpperCase()+n.substr(1);window.CustomEvent&&!rt&&!an?u=new CustomEvent(n,{bubbles:!0,cancelable:!0}):(u=document.createEvent("Event"),u.initEvent(n,!0,!0)),u.to=g||t,u.from=m||t,u.item=d||t,u.clone=h,u.oldIndex=c,u.newIndex=f,u.oldDraggableIndex=r,u.newDraggableIndex=o,u.originalEvent=a,u.pullMode=s?s.lastPutMode:void 0;var b=qe(qe({},i),ln.getEventProperties(n,e));for(var M in b)u[M]=b[M];t&&t.dispatchEvent(u),p[y]&&p[y].call(e,u)}}var yg=["evt"],Te=function(e,t){var n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{},d=n.evt,h=cg(n,yg);ln.pluginEvent.bind(te)(e,t,qe({dragEl:q,parentEl:ve,ghostEl:ie,rootEl:fe,nextEl:gt,lastDownEl:Cn,cloneEl:pe,cloneHidden:st,dragStarted:Gt,putSortable:Se,activeSortable:te.active,originalEvent:d,oldIndex:Et,oldDraggableIndex:Qt,newIndex:Ie,newDraggableIndex:ot,hideGhostForTarget:Ph,unhideGhostForTarget:Hh,cloneNowHidden:function(){st=!0},cloneNowShown:function(){st=!1},dispatchSortableEvent:function(m){Me({sortable:t,name:m,originalEvent:d})}},h))};function Me(l){vg(qe({putSortable:Se,cloneEl:pe,targetEl:q,rootEl:fe,oldIndex:Et,oldDraggableIndex:Qt,newIndex:Ie,newDraggableIndex:ot},l))}var q,ve,ie,fe,gt,Cn,pe,st,Et,Ie,Qt,ot,hn,Se,$t=!1,Dn=!1,On=[],ft,ze,Io,No,tu,nu,Gt,At,Jt,en=!1,dn=!1,Sn,Ae,Fo=[],Ms=!1,In=[],Xn=typeof document<"u",fn=Mh,iu=an||rt?"cssFloat":"float",bg=Xn&&!Eh&&!Mh&&"draggable"in document.createElement("div"),Ih=(function(){if(Xn){if(rt)return!1;var l=document.createElement("x");return l.style.cssText="pointer-events:auto",l.style.pointerEvents==="auto"}})(),Nh=function(e,t){var n=ne(e),d=parseInt(n.width)-parseInt(n.paddingLeft)-parseInt(n.paddingRight)-parseInt(n.borderLeftWidth)-parseInt(n.borderRightWidth),h=Rt(e,0,t),g=Rt(e,1,t),m=h&&ne(h),c=g&&ne(g),f=m&&parseInt(m.marginLeft)+parseInt(m.marginRight)+we(h).width,r=c&&parseInt(c.marginLeft)+parseInt(c.marginRight)+we(g).width;if(n.display==="flex")return n.flexDirection==="column"||n.flexDirection==="column-reverse"?"vertical":"horizontal";if(n.display==="grid")return n.gridTemplateColumns.split(" ").length<=1?"vertical":"horizontal";if(h&&m.float&&m.float!=="none"){var o=m.float==="left"?"left":"right";return g&&(c.clear==="both"||c.clear===o)?"vertical":"horizontal"}return h&&(m.display==="block"||m.display==="flex"||m.display==="table"||m.display==="grid"||f>=d&&n[iu]==="none"||g&&n[iu]==="none"&&f+r>d)?"vertical":"horizontal"},wg=function(e,t,n){var d=n?e.left:e.top,h=n?e.right:e.bottom,g=n?e.width:e.height,m=n?t.left:t.top,c=n?t.right:t.bottom,f=n?t.width:t.height;return d===m||h===c||d+g/2===m+f/2},Cg=function(e,t){var n;return On.some(function(d){var h=d[ke].options.emptyInsertThreshold;if(!(!h||ea(d))){var g=we(d),m=e>=g.left-h&&e<=g.right+h,c=t>=g.top-h&&t<=g.bottom+h;if(m&&c)return n=d}}),n},Fh=function(e){function t(h,g){return function(m,c,f,r){var o=m.options.group.name&&c.options.group.name&&m.options.group.name===c.options.group.name;if(h==null&&(g||o))return!0;if(h==null||h===!1)return!1;if(g&&h==="clone")return h;if(typeof h=="function")return t(h(m,c,f,r),g)(m,c,f,r);var a=(g?m:c).options.group.name;return h===!0||typeof h=="string"&&h===a||h.join&&h.indexOf(a)>-1}}var n={},d=e.group;(!d||wn(d)!="object")&&(d={name:d}),n.name=d.name,n.checkPull=t(d.pull,!0),n.checkPut=t(d.put),n.revertClone=d.revertClone,e.group=n},Ph=function(){!Ih&&ie&&ne(ie,"display","none")},Hh=function(){!Ih&&ie&&ne(ie,"display","")};Xn&&!Eh&&document.addEventListener("click",function(l){if(Dn)return l.preventDefault(),l.stopPropagation&&l.stopPropagation(),l.stopImmediatePropagation&&l.stopImmediatePropagation(),Dn=!1,!1},!0);var pt=function(e){if(q){e=e.touches?e.touches[0]:e;var t=Cg(e.clientX,e.clientY);if(t){var n={};for(var d in e)e.hasOwnProperty(d)&&(n[d]=e[d]);n.target=n.rootEl=t,n.preventDefault=void 0,n.stopPropagation=void 0,t[ke]._onDragOver(n)}}},Sg=function(e){q&&q.parentNode[ke]._isOutsideThisEl(e.target)};function te(l,e){if(!(l&&l.nodeType&&l.nodeType===1))throw"Sortable: `el` must be an HTMLElement, not ".concat({}.toString.call(l));this.el=l,this.options=e=nt({},e),l[ke]=this;var t={group:null,sort:!0,disabled:!1,store:null,handle:null,draggable:/^[uo]l$/i.test(l.nodeName)?">li":">*",swapThreshold:1,invertSwap:!1,invertedSwapThreshold:null,removeCloneOnHide:!0,direction:function(){return Nh(l,this.options)},ghostClass:"sortable-ghost",chosenClass:"sortable-chosen",dragClass:"sortable-drag",ignore:"a, img",filter:null,preventOnFilter:!0,animation:0,easing:null,setData:function(g,m){g.setData("Text",m.textContent)},dropBubble:!1,dragoverBubble:!1,dataIdAttr:"data-id",delay:0,delayOnTouchOnly:!1,touchStartThreshold:(Number.parseInt?Number:window).parseInt(window.devicePixelRatio,10)||1,forceFallback:!1,fallbackClass:"sortable-fallback",fallbackOnBody:!1,fallbackTolerance:0,fallbackOffset:{x:0,y:0},supportPointer:te.supportPointer!==!1&&"PointerEvent"in window&&!Zt,emptyInsertThreshold:5};ln.initializePlugins(this,l,t);for(var n in t)!(n in e)&&(e[n]=t[n]);Fh(e);for(var d in this)d.charAt(0)==="_"&&typeof this[d]=="function"&&(this[d]=this[d].bind(this));this.nativeDraggable=e.forceFallback?!1:bg,this.nativeDraggable&&(this.options.touchStartThreshold=1),e.supportPointer?se(l,"pointerdown",this._onTapStart):(se(l,"mousedown",this._onTapStart),se(l,"touchstart",this._onTapStart)),this.nativeDraggable&&(se(l,"dragover",this),se(l,"dragenter",this)),On.push(this.el),e.store&&e.store.get&&this.sort(e.store.get(this)||[]),nt(this,pg())}te.prototype={constructor:te,_isOutsideThisEl:function(e){!this.el.contains(e)&&e!==this.el&&(At=null)},_getDirection:function(e,t){return typeof this.options.direction=="function"?this.options.direction.call(this,e,t,q):this.options.direction},_onTapStart:function(e){if(e.cancelable){var t=this,n=this.el,d=this.options,h=d.preventOnFilter,g=e.type,m=e.touches&&e.touches[0]||e.pointerType&&e.pointerType==="touch"&&e,c=(m||e).target,f=e.target.shadowRoot&&(e.path&&e.path[0]||e.composedPath&&e.composedPath()[0])||c,r=d.filter;if(Lg(n),!q&&!(/mousedown|pointerdown/.test(g)&&e.button!==0||d.disabled)&&!f.isContentEditable&&!(!this.nativeDraggable&&Zt&&c&&c.tagName.toUpperCase()==="SELECT")&&(c=je(c,d.draggable,n,!1),!(c&&c.animated)&&Cn!==c)){if(Et=Fe(c),Qt=Fe(c,d.draggable),typeof r=="function"){if(r.call(this,e,c,this)){Me({sortable:t,rootEl:f,name:"filter",targetEl:c,toEl:n,fromEl:n}),Te("filter",t,{evt:e}),h&&e.cancelable&&e.preventDefault();return}}else if(r&&(r=r.split(",").some(function(o){if(o=je(f,o.trim(),n,!1),o)return Me({sortable:t,rootEl:o,name:"filter",targetEl:c,fromEl:n,toEl:n}),Te("filter",t,{evt:e}),!0}),r)){h&&e.cancelable&&e.preventDefault();return}d.handle&&!je(f,d.handle,n,!1)||this._prepareDragStart(e,m,c)}}},_prepareDragStart:function(e,t,n){var d=this,h=d.el,g=d.options,m=h.ownerDocument,c;if(n&&!q&&n.parentNode===h){var f=we(n);if(fe=h,q=n,ve=q.parentNode,gt=q.nextSibling,Cn=n,hn=g.group,te.dragged=q,ft={target:q,clientX:(t||e).clientX,clientY:(t||e).clientY},tu=ft.clientX-f.left,nu=ft.clientY-f.top,this._lastX=(t||e).clientX,this._lastY=(t||e).clientY,q.style["will-change"]="all",c=function(){if(Te("delayEnded",d,{evt:e}),te.eventCanceled){d._onDrop();return}d._disableDelayedDragEvents(),!Xc&&d.nativeDraggable&&(q.draggable=!0),d._triggerDragStart(e,t),Me({sortable:d,name:"choose",originalEvent:e}),Oe(q,g.chosenClass,!0)},g.ignore.split(",").forEach(function(r){Lh(q,r.trim(),Po)}),se(m,"dragover",pt),se(m,"mousemove",pt),se(m,"touchmove",pt),se(m,"mouseup",d._onDrop),se(m,"touchend",d._onDrop),se(m,"touchcancel",d._onDrop),Xc&&this.nativeDraggable&&(this.options.touchStartThreshold=4,q.draggable=!0),Te("delayStart",this,{evt:e}),g.delay&&(!g.delayOnTouchOnly||t)&&(!this.nativeDraggable||!(an||rt))){if(te.eventCanceled){this._onDrop();return}se(m,"mouseup",d._disableDelayedDrag),se(m,"touchend",d._disableDelayedDrag),se(m,"touchcancel",d._disableDelayedDrag),se(m,"mousemove",d._delayedDragTouchMoveHandler),se(m,"touchmove",d._delayedDragTouchMoveHandler),g.supportPointer&&se(m,"pointermove",d._delayedDragTouchMoveHandler),d._dragStartTimer=setTimeout(c,g.delay)}else c()}},_delayedDragTouchMoveHandler:function(e){var t=e.touches?e.touches[0]:e;Math.max(Math.abs(t.clientX-this._lastX),Math.abs(t.clientY-this._lastY))>=Math.floor(this.options.touchStartThreshold/(this.nativeDraggable&&window.devicePixelRatio||1))&&this._disableDelayedDrag()},_disableDelayedDrag:function(){q&&Po(q),clearTimeout(this._dragStartTimer),this._disableDelayedDragEvents()},_disableDelayedDragEvents:function(){var e=this.el.ownerDocument;oe(e,"mouseup",this._disableDelayedDrag),oe(e,"touchend",this._disableDelayedDrag),oe(e,"touchcancel",this._disableDelayedDrag),oe(e,"mousemove",this._delayedDragTouchMoveHandler),oe(e,"touchmove",this._delayedDragTouchMoveHandler),oe(e,"pointermove",this._delayedDragTouchMoveHandler)},_triggerDragStart:function(e,t){t=t||e.pointerType=="touch"&&e,!this.nativeDraggable||t?this.options.supportPointer?se(document,"pointermove",this._onTouchMove):t?se(document,"touchmove",this._onTouchMove):se(document,"mousemove",this._onTouchMove):(se(q,"dragend",this),se(fe,"dragstart",this._onDragStart));try{document.selection?An(function(){document.selection.empty()}):window.getSelection().removeAllRanges()}catch{}},_dragStarted:function(e,t){if($t=!1,fe&&q){Te("dragStarted",this,{evt:t}),this.nativeDraggable&&se(document,"dragover",Sg);var n=this.options;!e&&Oe(q,n.dragClass,!1),Oe(q,n.ghostClass,!0),te.active=this,e&&this._appendGhost(),Me({sortable:this,name:"start",originalEvent:t})}else this._nulling()},_emulateDragOver:function(){if(ze){this._lastX=ze.clientX,this._lastY=ze.clientY,Ph();for(var e=document.elementFromPoint(ze.clientX,ze.clientY),t=e;e&&e.shadowRoot&&(e=e.shadowRoot.elementFromPoint(ze.clientX,ze.clientY),e!==t);)t=e;if(q.parentNode[ke]._isOutsideThisEl(e),t)do{if(t[ke]){var n=void 0;if(n=t[ke]._onDragOver({clientX:ze.clientX,clientY:ze.clientY,target:e,rootEl:t}),n&&!this.options.dragoverBubble)break}e=t}while(t=Th(t));Hh()}},_onTouchMove:function(e){if(ft){var t=this.options,n=t.fallbackTolerance,d=t.fallbackOffset,h=e.touches?e.touches[0]:e,g=ie&&Tt(ie,!0),m=ie&&g&&g.a,c=ie&&g&&g.d,f=fn&&Ae&&eu(Ae),r=(h.clientX-ft.clientX+d.x)/(m||1)+(f?f[0]-Fo[0]:0)/(m||1),o=(h.clientY-ft.clientY+d.y)/(c||1)+(f?f[1]-Fo[1]:0)/(c||1);if(!te.active&&!$t){if(n&&Math.max(Math.abs(h.clientX-this._lastX),Math.abs(h.clientY-this._lastY))<n)return;this._onDragStart(e,!0)}if(ie){g?(g.e+=r-(Io||0),g.f+=o-(No||0)):g={a:1,b:0,c:0,d:1,e:r,f:o};var a="matrix(".concat(g.a,",").concat(g.b,",").concat(g.c,",").concat(g.d,",").concat(g.e,",").concat(g.f,")");ne(ie,"webkitTransform",a),ne(ie,"mozTransform",a),ne(ie,"msTransform",a),ne(ie,"transform",a),Io=r,No=o,ze=h}e.cancelable&&e.preventDefault()}},_appendGhost:function(){if(!ie){var e=this.options.fallbackOnBody?document.body:fe,t=we(q,!0,fn,!0,e),n=this.options;if(fn){for(Ae=e;ne(Ae,"position")==="static"&&ne(Ae,"transform")==="none"&&Ae!==document;)Ae=Ae.parentNode;Ae!==document.body&&Ae!==document.documentElement?(Ae===document&&(Ae=Ge()),t.top+=Ae.scrollTop,t.left+=Ae.scrollLeft):Ae=Ge(),Fo=eu(Ae)}ie=q.cloneNode(!0),Oe(ie,n.ghostClass,!1),Oe(ie,n.fallbackClass,!0),Oe(ie,n.dragClass,!0),ne(ie,"transition",""),ne(ie,"transform",""),ne(ie,"box-sizing","border-box"),ne(ie,"margin",0),ne(ie,"top",t.top),ne(ie,"left",t.left),ne(ie,"width",t.width),ne(ie,"height",t.height),ne(ie,"opacity","0.8"),ne(ie,"position",fn?"absolute":"fixed"),ne(ie,"zIndex","100000"),ne(ie,"pointerEvents","none"),te.ghost=ie,e.appendChild(ie),ne(ie,"transform-origin",tu/parseInt(ie.style.width)*100+"% "+nu/parseInt(ie.style.height)*100+"%")}},_onDragStart:function(e,t){var n=this,d=e.dataTransfer,h=n.options;if(Te("dragStart",this,{evt:e}),te.eventCanceled){this._onDrop();return}Te("setupClone",this),te.eventCanceled||(pe=Dh(q),pe.removeAttribute("id"),pe.draggable=!1,pe.style["will-change"]="",this._hideClone(),Oe(pe,this.options.chosenClass,!1),te.clone=pe),n.cloneId=An(function(){Te("clone",n),!te.eventCanceled&&(n.options.removeCloneOnHide||fe.insertBefore(pe,q),n._hideClone(),Me({sortable:n,name:"clone"}))}),!t&&Oe(q,h.dragClass,!0),t?(Dn=!0,n._loopId=setInterval(n._emulateDragOver,50)):(oe(document,"mouseup",n._onDrop),oe(document,"touchend",n._onDrop),oe(document,"touchcancel",n._onDrop),d&&(d.effectAllowed="move",h.setData&&h.setData.call(n,d,q)),se(document,"drop",n),ne(q,"transform","translateZ(0)")),$t=!0,n._dragStartId=An(n._dragStarted.bind(n,t,e)),se(document,"selectstart",n),Gt=!0,Zt&&ne(document.body,"user-select","none")},_onDragOver:function(e){var t=this.el,n=e.target,d,h,g,m=this.options,c=m.group,f=te.active,r=hn===c,o=m.sort,a=Se||f,s,i=this,u=!1;if(Ms)return;function p(O,I){Te(O,i,qe({evt:e,isOwner:r,axis:s?"vertical":"horizontal",revert:g,dragRect:d,targetRect:h,canSort:o,fromSortable:a,target:n,completed:b,onMove:function(P,B){return pn(fe,t,q,d,P,we(P),e,B)},changed:M},I))}function y(){p("dragOverAnimationCapture"),i.captureAnimationState(),i!==a&&a.captureAnimationState()}function b(O){return p("dragOverCompleted",{insertion:O}),O&&(r?f._hideClone():f._showClone(i),i!==a&&(Oe(q,Se?Se.options.ghostClass:f.options.ghostClass,!1),Oe(q,m.ghostClass,!0)),Se!==i&&i!==te.active?Se=i:i===te.active&&Se&&(Se=null),a===i&&(i._ignoreWhileAnimating=n),i.animateAll(function(){p("dragOverAnimationComplete"),i._ignoreWhileAnimating=null}),i!==a&&(a.animateAll(),a._ignoreWhileAnimating=null)),(n===q&&!q.animated||n===t&&!n.animated)&&(At=null),!m.dragoverBubble&&!e.rootEl&&n!==document&&(q.parentNode[ke]._isOutsideThisEl(e.target),!O&&pt(e)),!m.dragoverBubble&&e.stopPropagation&&e.stopPropagation(),u=!0}function M(){Ie=Fe(q),ot=Fe(q,m.draggable),Me({sortable:i,name:"change",toEl:t,newIndex:Ie,newDraggableIndex:ot,originalEvent:e})}if(e.preventDefault!==void 0&&e.cancelable&&e.preventDefault(),n=je(n,m.draggable,t,!0),p("dragOver"),te.eventCanceled)return u;if(q.contains(e.target)||n.animated&&n.animatingX&&n.animatingY||i._ignoreWhileAnimating===n)return b(!1);if(Dn=!1,f&&!m.disabled&&(r?o||(g=ve!==fe):Se===this||(this.lastPutMode=hn.checkPull(this,f,q,e))&&c.checkPut(this,f,q,e))){if(s=this._getDirection(e,n)==="vertical",d=we(q),p("dragOverValid"),te.eventCanceled)return u;if(g)return ve=fe,y(),this._hideClone(),p("revert"),te.eventCanceled||(gt?fe.insertBefore(q,gt):fe.appendChild(q)),b(!0);var $=ea(t,m.draggable);if(!$||Mg(e,s,this)&&!$.animated){if($===q)return b(!1);if($&&t===e.target&&(n=$),n&&(h=we(n)),pn(fe,t,q,d,n,h,e,!!n)!==!1)return y(),$&&$.nextSibling?t.insertBefore(q,$.nextSibling):t.appendChild(q),ve=t,M(),b(!0)}else if($&&xg(e,s,this)){var A=Rt(t,0,m,!0);if(A===q)return b(!1);if(n=A,h=we(n),pn(fe,t,q,d,n,h,e,!1)!==!1)return y(),t.insertBefore(q,A),ve=t,M(),b(!0)}else if(n.parentNode===t){h=we(n);var S=0,E,R=q.parentNode!==t,L=!wg(q.animated&&q.toRect||d,n.animated&&n.toRect||h,s),_=s?"top":"left",D=Jc(n,"top","top")||Jc(q,"top","top"),w=D?D.scrollTop:void 0;At!==n&&(E=h[_],en=!1,dn=!L&&m.invertSwap||R),S=Eg(e,n,h,s,L?1:m.swapThreshold,m.invertedSwapThreshold==null?m.swapThreshold:m.invertedSwapThreshold,dn,At===n);var v;if(S!==0){var C=Fe(q);do C-=S,v=ve.children[C];while(v&&(ne(v,"display")==="none"||v===ie))}if(S===0||v===n)return b(!1);At=n,Jt=S;var x=n.nextElementSibling,T=!1;T=S===1;var k=pn(fe,t,q,d,n,h,e,T);if(k!==!1)return(k===1||k===-1)&&(T=k===1),Ms=!0,setTimeout($g,30),y(),T&&!x?t.appendChild(q):n.parentNode.insertBefore(q,T?x:n),D&&kh(D,0,w-D.scrollTop),ve=q.parentNode,E!==void 0&&!dn&&(Sn=Math.abs(E-we(n)[_])),M(),b(!0)}if(t.contains(q))return b(!1)}return!1},_ignoreWhileAnimating:null,_offMoveEvents:function(){oe(document,"mousemove",this._onTouchMove),oe(document,"touchmove",this._onTouchMove),oe(document,"pointermove",this._onTouchMove),oe(document,"dragover",pt),oe(document,"mousemove",pt),oe(document,"touchmove",pt)},_offUpEvents:function(){var e=this.el.ownerDocument;oe(e,"mouseup",this._onDrop),oe(e,"touchend",this._onDrop),oe(e,"pointerup",this._onDrop),oe(e,"touchcancel",this._onDrop),oe(document,"selectstart",this)},_onDrop:function(e){var t=this.el,n=this.options;if(Ie=Fe(q),ot=Fe(q,n.draggable),Te("drop",this,{evt:e}),ve=q&&q.parentNode,Ie=Fe(q),ot=Fe(q,n.draggable),te.eventCanceled){this._nulling();return}$t=!1,dn=!1,en=!1,clearInterval(this._loopId),clearTimeout(this._dragStartTimer),Es(this.cloneId),Es(this._dragStartId),this.nativeDraggable&&(oe(document,"drop",this),oe(t,"dragstart",this._onDragStart)),this._offMoveEvents(),this._offUpEvents(),Zt&&ne(document.body,"user-select",""),ne(q,"transform",""),e&&(Gt&&(e.cancelable&&e.preventDefault(),!n.dropBubble&&e.stopPropagation()),ie&&ie.parentNode&&ie.parentNode.removeChild(ie),(fe===ve||Se&&Se.lastPutMode!=="clone")&&pe&&pe.parentNode&&pe.parentNode.removeChild(pe),q&&(this.nativeDraggable&&oe(q,"dragend",this),Po(q),q.style["will-change"]="",Gt&&!$t&&Oe(q,Se?Se.options.ghostClass:this.options.ghostClass,!1),Oe(q,this.options.chosenClass,!1),Me({sortable:this,name:"unchoose",toEl:ve,newIndex:null,newDraggableIndex:null,originalEvent:e}),fe!==ve?(Ie>=0&&(Me({rootEl:ve,name:"add",toEl:ve,fromEl:fe,originalEvent:e}),Me({sortable:this,name:"remove",toEl:ve,originalEvent:e}),Me({rootEl:ve,name:"sort",toEl:ve,fromEl:fe,originalEvent:e}),Me({sortable:this,name:"sort",toEl:ve,originalEvent:e})),Se&&Se.save()):Ie!==Et&&Ie>=0&&(Me({sortable:this,name:"update",toEl:ve,originalEvent:e}),Me({sortable:this,name:"sort",toEl:ve,originalEvent:e})),te.active&&((Ie==null||Ie===-1)&&(Ie=Et,ot=Qt),Me({sortable:this,name:"end",toEl:ve,originalEvent:e}),this.save()))),this._nulling()},_nulling:function(){Te("nulling",this),fe=q=ve=ie=gt=pe=Cn=st=ft=ze=Gt=Ie=ot=Et=Qt=At=Jt=Se=hn=te.dragged=te.ghost=te.clone=te.active=null,In.forEach(function(e){e.checked=!0}),In.length=Io=No=0},handleEvent:function(e){switch(e.type){case"drop":case"dragend":this._onDrop(e);break;case"dragenter":case"dragover":q&&(this._onDragOver(e),Ag(e));break;case"selectstart":e.preventDefault();break}},toArray:function(){for(var e=[],t,n=this.el.children,d=0,h=n.length,g=this.options;d<h;d++)t=n[d],je(t,g.draggable,this.el,!1)&&e.push(t.getAttribute(g.dataIdAttr)||Tg(t));return e},sort:function(e,t){var n={},d=this.el;this.toArray().forEach(function(h,g){var m=d.children[g];je(m,this.options.draggable,d,!1)&&(n[h]=m)},this),t&&this.captureAnimationState(),e.forEach(function(h){n[h]&&(d.removeChild(n[h]),d.appendChild(n[h]))}),t&&this.animateAll()},save:function(){var e=this.options.store;e&&e.set&&e.set(this)},closest:function(e,t){return je(e,t||this.options.draggable,this.el,!1)},option:function(e,t){var n=this.options;if(t===void 0)return n[e];var d=ln.modifyOption(this,e,t);typeof d<"u"?n[e]=d:n[e]=t,e==="group"&&Fh(n)},destroy:function(){Te("destroy",this);var e=this.el;e[ke]=null,oe(e,"mousedown",this._onTapStart),oe(e,"touchstart",this._onTapStart),oe(e,"pointerdown",this._onTapStart),this.nativeDraggable&&(oe(e,"dragover",this),oe(e,"dragenter",this)),Array.prototype.forEach.call(e.querySelectorAll("[draggable]"),function(t){t.removeAttribute("draggable")}),this._onDrop(),this._disableDelayedDragEvents(),On.splice(On.indexOf(this.el),1),this.el=e=null},_hideClone:function(){if(!st){if(Te("hideClone",this),te.eventCanceled)return;ne(pe,"display","none"),this.options.removeCloneOnHide&&pe.parentNode&&pe.parentNode.removeChild(pe),st=!0}},_showClone:function(e){if(e.lastPutMode!=="clone"){this._hideClone();return}if(st){if(Te("showClone",this),te.eventCanceled)return;q.parentNode==fe&&!this.options.group.revertClone?fe.insertBefore(pe,q):gt?fe.insertBefore(pe,gt):fe.appendChild(pe),this.options.group.revertClone&&this.animate(q,pe),ne(pe,"display",""),st=!1}}};function Ag(l){l.dataTransfer&&(l.dataTransfer.dropEffect="move"),l.cancelable&&l.preventDefault()}function pn(l,e,t,n,d,h,g,m){var c,f=l[ke],r=f.options.onMove,o;return window.CustomEvent&&!rt&&!an?c=new CustomEvent("move",{bubbles:!0,cancelable:!0}):(c=document.createEvent("Event"),c.initEvent("move",!0,!0)),c.to=e,c.from=l,c.dragged=t,c.draggedRect=n,c.related=d||e,c.relatedRect=h||we(e),c.willInsertAfter=m,c.originalEvent=g,l.dispatchEvent(c),r&&(o=r.call(f,c,g)),o}function Po(l){l.draggable=!1}function $g(){Ms=!1}function xg(l,e,t){var n=we(Rt(t.el,0,t.options,!0)),d=Oh(t.el,t.options,ie),h=10;return e?l.clientX<d.left-h||l.clientY<n.top&&l.clientX<n.right:l.clientY<d.top-h||l.clientY<n.bottom&&l.clientX<n.left}function Mg(l,e,t){var n=we(ea(t.el,t.options.draggable)),d=Oh(t.el,t.options,ie),h=10;return e?l.clientX>d.right+h||l.clientY>n.bottom&&l.clientX>n.left:l.clientY>d.bottom+h||l.clientX>n.right&&l.clientY>n.top}function Eg(l,e,t,n,d,h,g,m){var c=n?l.clientY:l.clientX,f=n?t.height:t.width,r=n?t.top:t.left,o=n?t.bottom:t.right,a=!1;if(!g){if(m&&Sn<f*d){if(!en&&(Jt===1?c>r+f*h/2:c<o-f*h/2)&&(en=!0),en)a=!0;else if(Jt===1?c<r+Sn:c>o-Sn)return-Jt}else if(c>r+f*(1-d)/2&&c<o-f*(1-d)/2)return _g(e)}return a=a||g,a&&(c<r+f*h/2||c>o-f*h/2)?c>r+f/2?1:-1:0}function _g(l){return Fe(q)<Fe(l)?1:-1}function Tg(l){for(var e=l.tagName+l.className+l.src+l.href+l.textContent,t=e.length,n=0;t--;)n+=e.charCodeAt(t);return n.toString(36)}function Lg(l){In.length=0;for(var e=l.getElementsByTagName("input"),t=e.length;t--;){var n=e[t];n.checked&&In.push(n)}}function An(l){return setTimeout(l,0)}function Es(l){return clearTimeout(l)}Xn&&se(document,"touchmove",function(l){(te.active||$t)&&l.cancelable&&l.preventDefault()});te.utils={on:se,off:oe,css:ne,find:Lh,is:function(e,t){return!!je(e,t,e,!1)},extend:dg,throttle:Rh,closest:je,toggleClass:Oe,clone:Dh,index:Fe,nextTick:An,cancelNextTick:Es,detectDirection:Nh,getChild:Rt,expando:ke};te.get=function(l){return l[ke]};te.mount=function(){for(var l=arguments.length,e=new Array(l),t=0;t<l;t++)e[t]=arguments[t];e[0].constructor===Array&&(e=e[0]),e.forEach(function(n){if(!n.prototype||!n.prototype.constructor)throw"Sortable: Mounted plugin must be a constructor function, not ".concat({}.toString.call(n));n.utils&&(te.utils=qe(qe({},te.utils),n.utils)),ln.mount(n)})};te.create=function(l,e){return new te(l,e)};te.version=ug;var be=[],qt,_s,Ts=!1,Ho,Wo,Nn,Kt;function Rg(){function l(){this.defaults={scroll:!0,forceAutoScrollFallback:!1,scrollSensitivity:30,scrollSpeed:10,bubbleScroll:!0};for(var e in this)e.charAt(0)==="_"&&typeof this[e]=="function"&&(this[e]=this[e].bind(this))}return l.prototype={dragStarted:function(t){var n=t.originalEvent;this.sortable.nativeDraggable?se(document,"dragover",this._handleAutoScroll):this.options.supportPointer?se(document,"pointermove",this._handleFallbackAutoScroll):n.touches?se(document,"touchmove",this._handleFallbackAutoScroll):se(document,"mousemove",this._handleFallbackAutoScroll)},dragOverCompleted:function(t){var n=t.originalEvent;!this.options.dragOverBubble&&!n.rootEl&&this._handleAutoScroll(n)},drop:function(){this.sortable.nativeDraggable?oe(document,"dragover",this._handleAutoScroll):(oe(document,"pointermove",this._handleFallbackAutoScroll),oe(document,"touchmove",this._handleFallbackAutoScroll),oe(document,"mousemove",this._handleFallbackAutoScroll)),ru(),$n(),fg()},nulling:function(){Nn=_s=qt=Ts=Kt=Ho=Wo=null,be.length=0},_handleFallbackAutoScroll:function(t){this._handleAutoScroll(t,!0)},_handleAutoScroll:function(t,n){var d=this,h=(t.touches?t.touches[0]:t).clientX,g=(t.touches?t.touches[0]:t).clientY,m=document.elementFromPoint(h,g);if(Nn=t,n||this.options.forceAutoScrollFallback||an||rt||Zt){zo(t,this.options,m,n);var c=at(m,!0);Ts&&(!Kt||h!==Ho||g!==Wo)&&(Kt&&ru(),Kt=setInterval(function(){var f=at(document.elementFromPoint(h,g),!0);f!==c&&(c=f,$n()),zo(t,d.options,f,n)},10),Ho=h,Wo=g)}else{if(!this.options.bubbleScroll||at(m,!0)===Ge()){$n();return}zo(t,this.options,at(m,!1),!1)}}},nt(l,{pluginName:"scroll",initializeByDefault:!0})}function $n(){be.forEach(function(l){clearInterval(l.pid)}),be=[]}function ru(){clearInterval(Kt)}var zo=Rh(function(l,e,t,n){if(e.scroll){var d=(l.touches?l.touches[0]:l).clientX,h=(l.touches?l.touches[0]:l).clientY,g=e.scrollSensitivity,m=e.scrollSpeed,c=Ge(),f=!1,r;_s!==t&&(_s=t,$n(),qt=e.scroll,r=e.scrollFn,qt===!0&&(qt=at(t,!0)));var o=0,a=qt;do{var s=a,i=we(s),u=i.top,p=i.bottom,y=i.left,b=i.right,M=i.width,$=i.height,A=void 0,S=void 0,E=s.scrollWidth,R=s.scrollHeight,L=ne(s),_=s.scrollLeft,D=s.scrollTop;s===c?(A=M<E&&(L.overflowX==="auto"||L.overflowX==="scroll"||L.overflowX==="visible"),S=$<R&&(L.overflowY==="auto"||L.overflowY==="scroll"||L.overflowY==="visible")):(A=M<E&&(L.overflowX==="auto"||L.overflowX==="scroll"),S=$<R&&(L.overflowY==="auto"||L.overflowY==="scroll"));var w=A&&(Math.abs(b-d)<=g&&_+M<E)-(Math.abs(y-d)<=g&&!!_),v=S&&(Math.abs(p-h)<=g&&D+$<R)-(Math.abs(u-h)<=g&&!!D);if(!be[o])for(var C=0;C<=o;C++)be[C]||(be[C]={});(be[o].vx!=w||be[o].vy!=v||be[o].el!==s)&&(be[o].el=s,be[o].vx=w,be[o].vy=v,clearInterval(be[o].pid),(w!=0||v!=0)&&(f=!0,be[o].pid=setInterval((function(){n&&this.layer===0&&te.active._onTouchMove(Nn);var x=be[this.layer].vy?be[this.layer].vy*m:0,T=be[this.layer].vx?be[this.layer].vx*m:0;typeof r=="function"&&r.call(te.dragged.parentNode[ke],T,x,l,Nn,be[this.layer].el)!=="continue"||kh(be[this.layer].el,T,x)}).bind({layer:o}),24))),o++}while(e.bubbleScroll&&a!==c&&(a=at(a,!1)));Ts=f}},30),Wh=function(e){var t=e.originalEvent,n=e.putSortable,d=e.dragEl,h=e.activeSortable,g=e.dispatchSortableEvent,m=e.hideGhostForTarget,c=e.unhideGhostForTarget;if(t){var f=n||h;m();var r=t.changedTouches&&t.changedTouches.length?t.changedTouches[0]:t,o=document.elementFromPoint(r.clientX,r.clientY);c(),f&&!f.el.contains(o)&&(g("spill"),this.onSpill({dragEl:d,putSortable:n}))}};function ta(){}ta.prototype={startIndex:null,dragStart:function(e){var t=e.oldDraggableIndex;this.startIndex=t},onSpill:function(e){var t=e.dragEl,n=e.putSortable;this.sortable.captureAnimationState(),n&&n.captureAnimationState();var d=Rt(this.sortable.el,this.startIndex,this.options);d?this.sortable.el.insertBefore(t,d):this.sortable.el.appendChild(t),this.sortable.animateAll(),n&&n.animateAll()},drop:Wh};nt(ta,{pluginName:"revertOnSpill"});function na(){}na.prototype={onSpill:function(e){var t=e.dragEl,n=e.putSortable,d=n||this.sortable;d.captureAnimationState(),t.parentNode&&t.parentNode.removeChild(t),d.animateAll()},drop:Wh};nt(na,{pluginName:"removeOnSpill"});te.mount(new Rg);te.mount(na,ta);const xe={getStyle:(l,e=!1)=>{let t;return window.getComputedStyle?t=window.getComputedStyle(l,null):l.currentStyle&&(t=l.currentStyle),e?t[e]:t},fadeOut:(l,e=250)=>{const t=1/(e/60);l.style.opacity=1,(function n(){const d=Number(l.style.opacity)-t;d>0?(l.style.opacity=d,window.requestAnimationFrame(n)):l.remove()})()},slideDown:(l,e=250,t=!1)=>{l.style.display="block";const n=xe.getStyle(l),d=Number.parseInt(n.height,10),h=d/(e/60);l.style.height="0px",(function g(){const m=Number.parseFloat(l.style.height),c=m+h;m<d?(l.style.height=`${c}px`,window.requestAnimationFrame(g)):(l.style.height="auto",t&&t(l))})()},slideUp:(l,e=250,t=!1)=>{const n=xe.getStyle(l),d=Number.parseInt(n.height,10),h=n.overflow;l.style.overflow="hidden",l.style.height=`${d}px`;const g=n.minHeight;l.style.minHeight="auto";const m=parseFloat(d/(e/60)).toFixed(2);(function c(){const r=Number.parseInt(l.style.height,10)-m;r>0?(l.style.height=`${r}px`,window.requestAnimationFrame(c)):(l.style.overflow=h,l.style.display="none",l.style.minHeight=g,delete l.style.height,t&&t(l))})()},slideToggle:(l,e=250,t=xe.getStyle(l,"display")==="none")=>{t?xe.slideDown(l,e):xe.slideUp(l,e)}},zh=l=>Number.isInteger(Number(l)),ct=l=>{let e=0,t=l;for(;t?.previousElementSibling;)t=t.previousElementSibling,e++;return e},Fn=(l,e,t)=>{const n=t.split("||"),h=mt(e).map(g=>l.find(m=>{const c=n.find(f=>!!Re(m,f));return c&&Re(m,c)===g})).filter(Boolean).concat(l);return mt(h)},Qn=(l,e,t)=>{for(let n=0;n<l.length;n++)e.call(t,l[n],n)},ia=(l,e)=>{const t=[];return Qn(l,(n,d)=>t.push(e(n,d))),t},Bo={},Bh=l=>{const e={className:"class"};if(Bo[l])return Bo[l];const n=(e[l]||l).replace(/^\d+/,"").replace(/[^a-zA-Z0-9-:]/g,"");return Bo[l]=n,n},jh=l=>l.replace(/\b\w/g,e=>e.toUpperCase()),kg=l=>window.JSON.parse(window.JSON.stringify(l)),Dg=(l,e)=>e.filter(t=>!~l.indexOf(t)),Ne={capitalize:jh,safeAttrName:Bh,forEach:Qn,copyObj:kg,map:ia,subtract:Dg,indexOfNode:ct,isInt:zh,get:Re,orderObjectsBy:Fn},We={js:new Set,css:new Set,formeoSprite:null},ou=(l,e,t=Ss)=>new Promise(n=>fetch(l).then(d=>{if(!d.ok)return n(t(d));n(e?e(d):d)}).catch(d=>t(d))),Vh=(l,e)=>{l.removeEventListener("load",Vh),e(l.src)},Uh=(l,e)=>{l.removeEventListener("load",Uh),e(l.src)},Og=l=>new Promise((e,t)=>{if(We.js.has(l))return e(l);We.js.add(l);const n=V.create({tag:"script",attrs:{type:"text/javascript",async:!0,src:l},action:{load:()=>Uh(n,e),error:()=>t(new Error(`${l} failed to load.`))}});document.head.appendChild(n)}),Ls=l=>{l=Array.isArray(l)?l:[l];const e=l.map(t=>new Promise((n,d)=>{if(We.css.has(t))return n(t);We.css.add(t);const h=V.create({tag:"link",attrs:{rel:"stylesheet",href:t},action:{load:()=>Vh(h,n),error:()=>d(new Error(`${t} failed to load.`))}});document.head.appendChild(h)}));return Promise.all(e)},Ig=l=>{l=Array.isArray(l)?l:[l];const e=l.map(t=>Og(t));return Promise.all(e)},Ng=l=>{l=Array.isArray(l)?l:[l];const e=l.map(t=>Ls(t));return Promise.all(e)},su=l=>{const t=new DOMParser().parseFromString(l,"image/svg+xml");return We.formeoSprite=t.documentElement,We.formeoSprite},Fg=async(l=Hf)=>{if(We.formeoSprite)return We.formeoSprite;if(!l)return su(Ff);const e=async t=>su(await t.text());return ou(l,e,()=>ou(Wf,e))},Pg={js:Ig,css:Ng},Gh=l=>{const e=Object.entries(l).map(([t,n])=>Pg[t](n));return Promise.all(e)},Hg=async l=>{if(l&&!We.css.has(l)&&(await Ls(l),!We.css.has(l)&&!We.css.has(ic)))return await Ls(ic)},Wg={glyphicons:l=>`<span class="glyphicon glyphicon-${l}" aria-hidden="true"></span>`,"font-awesome":l=>{const[e,t]=l.split(" ");return`<i class="${e} fa-${t}"></i>`},fontello:l=>`<i class="${Ch}${l}">${l}</i>`},zg=new Set(["input","textarea","select"]),Bg=l=>l.replace(/^on([A-Z])/,(e,t)=>t.toLowerCase()),jg=new Set(["focus","blur"]),Vg=l=>{const e=Bg(l);return(t,n)=>t.addEventListener(e,n,jg.has(e))},qh=(l={})=>{let e=l?.attrs?.name||l?.name;if(e)return e;const t=He(l);let n=l.config?.label||l.attrs?.label||l?.label;return n&&(typeof n=="object"&&(n=V.create(n).textContent),/^<.+>.+<.+>$/gim.test(n)&&(n=gp(n)),e=`${t}-${Sh(mp(n,24,null))}`),e||t};class Ug{constructor(e=Object.create(null)){this.options=e}set setOptions(e){this.options=Ve(this.options,e)}processElemArg(e){let t=e,n;if(typeof t=="string")return n=t,t={tag:n},t;if(t.attrs){const{tag:d,...h}=t.attrs;d&&(typeof d=="string"?n=d:n=(d.find(m=>m.selected===!0)||d[0]).value),t.attrs=h}return t.tag=n||t.tag||"div",t}render=e=>(e.id=`f-${e.id||He()}`,this.create(e));create=(e,t=!1)=>{if(!e)return;if(this.isDOMElement(e))return e;const n=this,d=["children","content"],{className:h,options:g,dataset:m,...c}=this.processElemArg(e);d.push("tag");let f;const{tag:r}=c;let o;const a={attrs:{},className:[Ne.get(c,"config.inputWrap")],children:[],config:{}};let s=document.createElement(r);const i={string:p=>{s.innerHTML+=p},object:p=>p&&s.appendChild(n.create(p,t)),node:p=>s.appendChild(p),component:p=>s.appendChild(p.dom),array:p=>{for(const y of p)f=n.childType(y),i[f](y)},function:p=>{p=p(),f=n.childType(p),i[f](p)},undefined:()=>null,boolean:()=>null};if(h&&(c.attrs=Ve(c.attrs,{className:h})),g){const p=this.processOptions(g,c,t);if(this.holdsContent(s)&&r!=="button")i.array.call(this,p),c.content=void 0;else return Ne.forEach(p,y=>{a.children.push(n.create(y,t))}),c.attrs.className&&(a.className=c.attrs.className),a.id=c.id,a.config={...c.config},this.create(a,t);d.push("options")}if(c.attrs&&(n.processAttrs(c,s,t),d.push("attrs")),c.config){if(c.config.label&&(c.config.label&&r!=="button"||["radio","checkbox"].includes(Ne.get(c,"attrs.type")))&&!t){const p=n.label(c);if(!c.config.hideLabel){const y=[p,s];n.labelAfter(c)&&y.reverse(),a.children.push(y)}}d.push("config")}if(c.content||c.children){const p=c.content||c.children;f=n.childType(p),i[f]||console.error(`childType: ${f} is not supported`),i[f].call(this,p)}if(m){for(const p in m)Object.hasOwn(m,p)&&(s.dataset[p]=typeof m[p]=="function"?m[p]():m[p]);d.push("dataset")}c.action&&(this.actionHandler(s,c.action),d.push("action"));const u=Ne.subtract(d,Object.keys(c));for(o=u.length-1;o>=0;o--)s[u[o]]=c[u[o]];return a.children.length&&(s=this.create(a)),s};onRender=(e,t,n=Ze)=>{const d=Date.now(),h=()=>{!e.parentElement&&Date.now()-d<n?window.requestAnimationFrame(h):e.parentElement&&t(e)};h()};actionHandler(e,t){const n={onRender:V.onRender,render:V.onRender};return Object.entries(t).map(([d,h])=>(Array.isArray(h)?h:[h]).map(m=>(n[d]||Vg(d))(e,m)))}get icons(){if(this.iconSymbols)return this.iconSymbols;const e=We.formeoSprite.querySelectorAll("svg symbol"),t=n=>{const d=n.getAttribute("viewBox")||"0 0 24 24",h=Array.from(n.children).map(g=>g.cloneNode(!0).outerHTML).join("");return{tag:"svg",attrs:{className:["svg-icon",n.id],viewBox:d,xmlns:"http://www.w3.org/2000/svg"},children:h}};return this.iconSymbols=Array.from(e).reduce((n,d)=>{const h=d.id.replace(Ch,"");return n[h]=t(d),n},{}),this.cachedIcons={},this.iconSymbols}icon(e,t){if(!e)return;const n=`${e}?${new URLSearchParams(t).toString()}`;if(this.cachedIcons?.[n])return this.cachedIcons[n];const d=this.icons[e];if(d){if(t){const h=Ve(d,t);return this.cachedIcons[n]=V.create(h).outerHTML,this.cachedIcons[n]}return this.cachedIcons[n]=V.create(d).outerHTML,this.cachedIcons[n]}return Wg[V.options.iconFont]?.(e)||e}processAttrs(e,t,n){const{attrs:d={}}=e;if(!n&&!d.name&&d.name!==null&&this.isInput(e.tag)){const h=qh(e);h&&t.setAttribute("name",h)}for(const h of Object.keys(d)){const g=Ne.safeAttrName(h),m=this.processAttrValue(d[h]);if(m!==!1)try{t.setAttribute(g,m)}catch(c){console.warn(`Could not set attribute ${g} with value ${m}`,c)}}}processAttrValue(e){if(typeof e=="function")return e();if(typeof e=="boolean")return e&&"";let t=e||"";if(Array.isArray(t))if(typeof t[0]=="object"){const n=t.filter(d=>d.selected===!0);t=n.length?n[0].value:t[0].value}else t=t.join(" ");return t}toggleElementsByStr=(e,t)=>{const n=[],d=(h,g)=>{g?(h.style.display="block",n.push(h)):h.style.display="none"};return V.elementsContainText(e,t,d),n};elementsContainText=(e,t,n)=>{const d=[];return Qn(e,h=>{const m=h.textContent.toLowerCase().indexOf(t.toLowerCase())!==-1;n?.(h,m),m&&d.push(h)}),d};generateOption=({type:e="option",label:t,value:n,i:d=0,selected:h})=>({tag:e==="option"?"option":"input",attrs:{type:e,value:n||`${e}-${d}`,[e==="option"?"selected":"checked"]:h||!d},config:{label:t||X.get("labelCount",{label:X.get("option"),count:d})}});processOptions(e,t,n){const{action:d,attrs:h={}}=t,g=h.type||t.tag,m=h.id||t.id,c=(r,o)=>{const{label:a,value:s,...i}=r,u=()=>{const y={tag:"input",attrs:{name:m,type:g,value:s||"",id:`${m}-${o}`,...i},action:d},b={tag:"label",attrs:{for:`${m}-${o}`},children:a},M={children:[y,b],className:[`f-${g}`]};return h.className&&(t.config.inputWrap=h.className),t.config.inline&&M.className.push(`f-${g}-inline`),r.selected&&(y.attrs.checked=!0),n&&(b.attrs.contenteditable=!0),M};return{select:()=>{const y=r.attrs||r,b={attrs:y,...r,...y},{label:M,checked:$,selected:A,attrs:S}=b;return{tag:"option",attrs:{...S,selected:!!($||A)},children:M}},button:y=>{const{type:b,label:M,className:$,id:A}=y;return{...t,attrs:{type:b},className:$,id:A||He(),options:void 0,children:M,action:t.action}},checkbox:u,radio:u}[g]?.(r)};return e.map(c)}holdsContent(e){return e.outerHTML.includes("/")}isBlockInput(e){return!this.isInput(e)&&this.holdsContent(e)}isInput(e){let t=e;return typeof t!="string"&&(t=t.tagName),zg.has(t)}parsedHtml(e){const t=document.createElement("textarea");return t.innerHTML=e,t.textContent}labelAfter(e){const t=Ne.get(e,"attrs.type"),n=Ne.get(e,"config.labelAfter");return n===void 0?t==="checkbox"||t==="radio":n}requiredMark=()=>({tag:"span",className:"text-error",children:"*"});tooltip=e=>({tag:"span",className:"f-tooltip",dataset:{tooltip:e},content:V.icon("info-circle")});helpText=e=>({tag:"small",className:"f-help-text",children:e});label(e,t){const n=Ne.get(e,"attrs.required");let{config:{label:d="",helpText:h="",tooltip:g=null}}=e;const{id:m,attrs:c}=e;typeof d=="function"&&(d=d());const f={tag:"label",attrs:{for:m||c?.id},className:[],children:[d,n&&this.requiredMark(),g&&this.tooltip(g),h&&this.helpText(h)],action:{}};return t&&(f.attrs.for=void 0,f.attrs.contenteditable=!0,f.fMap=t),f}childType(e){return e===void 0?e:[["array",t=>Array.isArray(t)],["node",t=>t instanceof window.Node||t instanceof window.HTMLElement],["component",()=>e?.dom],[typeof e,()=>!0]].find(t=>t[1](e))[0]}getStyle(e,t=!1){let n;return window.getComputedStyle?n=window.getComputedStyle(e,null):e.currentStyle&&(n=e.currentStyle),t?n[t]:n}getElement(e){const t={node:()=>e,object:()=>document.getElementById(e.id),string:()=>document.getElementById(e)},n=this.childType(e);return t[n]()}empty(e){for(;e.firstChild;)this.remove(e.firstChild);return e}removeEmpty=e=>{const t=e.parentElement,n=Le(e),d=t.getElementsByClassName(`formeo-${n}`);if(this.remove(e),!d.length)return this.isStage(t)?this.emptyClass(t):this.removeEmpty(t)};remove(e){const t=Le(e);return t?ce.remove(`${t}s.${e.id}`):e.parentElement.removeChild(e)}removeClasses(e,t){const n={string:d=>d.classList.remove(t),array:d=>{for(const h of t)d.classList.remove(h)}};n.object=n.string,Ne.forEach(e,n[this.childType(t)])}addClasses(e,t){const n={string:d=>d.classList.add(t),array:d=>{for(const h of t)d.classList.add(h)}};Ne.forEach(e,n[this.childType(t)])}formGroup(e,t=""){return{className:["f-field-group",t],children:e}}coords(e){const t=e.getBoundingClientRect(),n=document.body.getBoundingClientRect();return{pageX:t.left+t.width/2,pageY:t.top-n.top-t.height/2}}clearStage(e){e.classList.add("removing-all-fields");const t=()=>{V.empty(e),e.classList.remove("removing-all-fields"),V.emptyClass(e),xe.slideDown(e,300)};xe.slideUp(e,600,t)}toggleSortable(e,t){let n=t;const d=Le(e);if(!d)return;const h=Le(e.parentElement),g=V[d].get(e.id).sortable;n||(n=!g.option("disabled")),g.option("disabled",n),h&&["rows","columns","stages"].includes(h)&&this.toggleSortable(e.parentElement,n)}emptyClass(e){const t=e.getElementsByClassName(Bf.get(e.classList.item(0)));e.classList.toggle("empty",!t.length)}btnTemplate=({title:e="",...t})=>({tag:"button",attrs:{type:"button",title:e},...t});isControls=e=>Le(e)===lt;isStage=e=>Le(e)===Nt;isRow=e=>Le(e)===et;isColumn=e=>Le(e)===tt;isField=e=>Le(e)===Ft;asComponent=e=>ce[`${Le(e)}s`].get(e.id);isDOMElement(e){return e instanceof window.Element||e instanceof window.HTMLElement||!!(e&&typeof e=="object"&&e.nodeType===1&&typeof e.nodeName=="string")}}const V=new Ug,Gg="modulepreload",qg=function(l){return"/formeo/"+l},au={},xt=function(e,t,n){let d=Promise.resolve();if(t&&t.length>0){let c=function(f){return Promise.all(f.map(r=>Promise.resolve(r).then(o=>({status:"fulfilled",value:o}),o=>({status:"rejected",reason:o}))))};document.getElementsByTagName("link");const g=document.querySelector("meta[property=csp-nonce]"),m=g?.nonce||g?.getAttribute("nonce");d=c(t.map(f=>{if(f=qg(f),f in au)return;au[f]=!0;const r=f.endsWith(".css"),o=r?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${f}"]${o}`))return;const a=document.createElement("link");if(a.rel=r?"stylesheet":Gg,r||(a.as="script"),a.crossOrigin="",a.href=f,m&&a.setAttribute("nonce",m),document.head.appendChild(a),r)return new Promise((s,i)=>{a.addEventListener("load",s),a.addEventListener("error",()=>i(new Error(`Unable to preload CSS for ${f}`)))})}))}function h(g){const m=new Event("vite:preloadError",{cancelable:!0});if(m.payload=g,window.dispatchEvent(m),!m.defaultPrevented)throw g}return d.then(g=>{for(const m of g||[])m.status==="rejected"&&h(m.reason);return e().catch(h)})},_t="f-autocomplete",Kg=`${_t}-display-field`,ra=`${_t}-list`,Wt="highlight-component",Pn=`${ra}-item`,Yg=(l,e)=>{const t=l.reduce((n,d)=>n+(d===e),0);return t>1?`(${t})`:""},Kh=["config.label","config.controlId"],Zg=["config.legend","name"],Xg=[...Kh,...Zg],jo=l=>Kh.reduce((e,t)=>e||l.get(t),null),lu=l=>Xg.reduce((e,t)=>e||l.get(t),null)||Xe(l.name),Qg=new Map([["condition.source",jo],["if.condition.source",jo],["if.condition.target",jo],["then.condition.target",lu],["condition.target",lu]]),Yh=({id:l,...e},t)=>{const{name:n,label:d}=e;return n?Qg.get(t)(e):d},Jg=({selectedId:l,...e})=>(e.value===l&&(e.selected=!0),e),Vo=l=>(l.classList.contains(Pn)||(l=l.parentElement),l),Zh=({value:l,textLabel:e,htmlLabel:t,componentType:n,depth:d=0},h)=>{const g={tag:"li",children:t,dataset:{value:l,label:e},className:[Pn,`${Pn}-depth-${d}`,`component-type-${n}`],action:{mousedown:({target:m})=>{m=Vo(m),h.setValue(m),h.selectOption(m),h.hideList()},mouseover:({target:m})=>{m=Vo(m),h.removeHighlight(),h.highlightComponent(m)},mouseleave:({target:m})=>{m=Vo(m),h.removeHighlight()}}};return V.create(g)},em=(l,e)=>{const t=l.data.options.map((d,h)=>{const g=`${l.address}.options[${h}]`,m=d.label,c=d.label;return Zh({value:g,textLabel:m,htmlLabel:c,componentType:"option",depth:1},e)});return V.create({tag:"ul",attrs:{className:[ra,"options-list"]},children:t})},tm=l=>{const e=l.value,t=[],n=ce.flatList();return Object.entries(n).reduce((h,[g,m])=>{const c=Yh(m,l.key);if(c){const f=m.name,r={tag:"span",content:` ${Xe(f)}`,className:"component-type"},o=`${f}.${c}`;t.push(o);const a=Yg(t,o),s={tag:"span",content:a,className:"component-label-count"},i=[`${c} `,s,r],u=[c,a].join(" ").trim();if(m.isCheckable){const y=em(m,l);i.push(y)}const p=Jg({value:g,textLabel:u,htmlLabel:i,componentType:f,selectedId:e});h.push(Zh(p,l))}return h},[])};class nm{lastCache=Date.now();optionsCache=null;constructor({key:e,value:t,className:n,onChange:d=Ss}){this.key=e,this.className=[n||this.key.replace(/\./g,"-")].flat(),this.value=t,this.onChange=d||Ss,this.events=[],this.build()}createProxy(){return new Proxy(this,{get(e,t){if(t in e)return e[t];if(t in e.dom){const n=e.dom[t];return typeof n=="function"?n.bind(e.dom):n}},set(e,t,n){return t in e?e[t]=n:e.dom[t]=n,!0}})}get isAddress(){return Pe(this.value)}get valueComponent(){return Pe(this.value)&&ce.getAddress(this.value)}build(){const e=n=>{const d=this.list,h=this.getActiveOption();let m=new Map([[38,()=>{const c=this.getPreviousOption(h);c&&this.selectOption(c)}],[40,()=>{const c=this.getNextOption(h);c&&this.selectOption(c)}],[13,()=>{h&&(this.selectOption(h),this.setValue(h),d.style.display==="none"?this.showList(h):this.hideList()),n.preventDefault()}],[27,()=>{this.hideList()}]]).get(n.keyCode);return m||(m=()=>!1),m()},t={focus:({target:n})=>{this.updateOptions(),n.parentElement.classList.add(`${_t}-focused`);const d=V.toggleElementsByStr(this.list.querySelectorAll(`.${Pn}-depth-0`),n.value);n.addEventListener("keydown",e);const h=this.list.querySelector(".active-option")||d[0];this.showList(h)},blur:({target:n})=>{n.parentElement.classList.remove(`${_t}-focused`),n.removeEventListener("keydown",e),this.hideList()},input:n=>{const{value:d}=n.target,h=V.toggleElementsByStr(this.list.querySelectorAll("li"),d);if(d.length===0&&this.clearValue(),h.length===0)this.hideList();else{const g=this.getActiveOption()||h[0];this.showList(g)}this.setValue({dataset:{label:d,value:d}})}};return this.displayField=V.create({tag:"input",autocomplete:"off",action:t,attrs:{type:"text",className:Kg,value:this.label||this.value,placeholder:X.get(`${this.key}.placeholder`)}}),this.hiddenField=V.create({tag:"input",attrs:{type:"hidden",className:_t,value:this.value}}),this.list=V.create({tag:"ul",attrs:{className:ra}}),this.clearButton=V.create({tag:"span",content:V.icon("remove"),className:"clear-button hidden",action:{click:()=>this.clearValue()}}),this.dom=V.create({children:[this.displayField,this.clearButton,this.hiddenField],className:[_t,this.className].flat(),action:{onRender:n=>{this.stage=n.closest(".formeo-stage"),this.value&&(this.displayField.value=this.label),this.clearButton.classList.toggle("hidden",!this.value.length)}}}),this.dom}get label(){if(!Pe(this.value))return this.value;const e=this.value&&ce.getAddress(this.value);return e&&Yh(e,`${this.key}`)||this.value}updateOptions(){let e=this.optionsCache;const t=Date.now();(t-this.lastCache>Vs*5||!e)&&(V.empty(this.list),e=this.generateOptions(),this.lastCache=t),this.list.children.length||this.list.append(...e)}generateOptions(){return this.optionsCache=tm(this),this.optionsCache}setListPosition(){const{offsetHeight:e,offsetWidth:t}=this.displayField,n=this.displayField.closest(".formeo-stage").getBoundingClientRect(),d=this.displayField.getBoundingClientRect(),h={position:"absolute",top:`${d.y+e-n.y}px`,left:`${d.x+window.scrollX-n.x+2}px`,width:`${t}px`};Object.assign(this.list.style,h)}showList(e,t=this.list){this.stage.contains(this.list)||this.stage.appendChild(this.list),this.setListPosition(),this.selectOption(e),xe.slideDown(t,vt)}hideList(e=this.list){xe.slideUp(e,vt),this.removeHighlight(),this.stage.contains(this.list)&&this.stage.removeChild(this.list)}getActiveOption(e=this.list){const t=e.querySelector(".active-option");return t?.style.display!=="none"?t:null}getPreviousOption(e){let t=e;do t=t?t.previousSibling:null;while(t!=null&&t.style.display==="none");return t}getNextOption(e){let t=e;do t=t?t.nextSibling:null;while(t!=null&&t.style.display==="none");return t}selectOption(e,t=this.list){const n=t.querySelectorAll("li");for(const d of n){const{dataset:{value:h}}=d;d.classList.remove("active-option"),Pe(h)&&ce.getAddress(h)?.dom?.classList.remove(Wt)}e&&(e.classList.add("active-option"),this.highlightComponent(e))}removeHighlight(){const e=document.getElementsByClassName(Wt);for(const t of e)t.classList.remove(Wt)}highlightComponent(e){const{dataset:{value:t}}=e;if(Pe(t)){const{componentAddress:n,isOptionAddress:d,optionIndex:h}=yt(t).reduce((m,c)=>c==="options"?(m.isOptionAddress=!0,m):m.isOptionAddress?(m.optionIndex=+c,m):(m.componentAddress.push(c),m),{componentAddress:[],optionIndex:null,isOptionAddress:!1}),g=ce.getAddress(n);g?.dom&&(g.dom.classList.add(Wt),d&&g.dom.querySelectorAll(".field-preview .f-checkbox, .field-preview .f-radio")[h]?.classList.add(Wt))}}clearValue(){this.selectOption(null),this.setValue({dataset:{label:"",value:""}}),this.displayField.focus()}setValue(e){const{label:t,value:n}=e.dataset;this.displayField.value=t,this.hiddenField.value=n,this.value=n,this.clearButton.classList.toggle("hidden",!n.length),this.onChange?.({target:this.hiddenField})}}const Xh=l=>X.get(`${l}.placeholder`)||Xe(Rn(l)),oa=l=>l.replaceAll(".","-"),cu=new Map([["config.helpText",(...l)=>uu(...l)],["config.tooltip",(...l)=>uu(...l)]]);function Uo({key:l,value:e,type:t="text",checked:n}){const d={tag:"input",attrs:{type:t,value:e,placeholder:Xh(l)},className:[oa(l)],config:{}};return n&&(d.attrs.checked=!0),d}function uu({key:l,value:e}){return{tag:"textarea",attrs:{placeholder:Xh(l)},className:[oa(l)],config:{},textContent:e}}function Ue(l){const e=X.get(l);if(e)return e;const t=Rn(l);return X.get(t)||Xe(t)}const kt={autocomplete:(...l)=>new nm(...l).createProxy(),string:({key:l,value:e})=>cu.has(l)?cu.get(l)({key:l,value:e}):Uo({key:l,value:e}),boolean:({key:l,value:e})=>Uo({key:l,value:e,type:l==="selected"?"radio":"checkbox",checked:!!e}),number:({key:l,value:e})=>Uo({key:l,value:e,type:"number"}),array:({key:l,value:e})=>({tag:"select",attrs:{placeholder:Ue(`placeholder.${l}`)},className:[oa(l)],options:e}),object:l=>Object.entries(l).map(([e,t])=>kt[V.childType(t)]({key:e,value:t}))},im={boolean:(l,e)=>({click:({target:t})=>{if(t.type==="radio"){const n=e.data.options.map(d=>({...d,selected:!1}));e.set("options",n)}e.set(l,t.checked),e.updatePreview()}}),string:(l,e)=>({input:({target:{value:t}})=>{e.set(l,t),e.debouncedUpdatePreview()}}),number:(l,e)=>({input:({target:{value:t}})=>{e.set(l,Number(t)),e.debouncedUpdatePreview()}}),array:(l,e)=>({change:({target:{value:t}})=>{e.set(l,t),e.debouncedUpdatePreview()}}),object:()=>({})},rm=Object.freeze({title:"",content:null,confirmText:()=>Ue("save"),cancelText:()=>Ue("cancel"),onConfirm:()=>{},onCancel:()=>{},className:"",closeOnEscape:!0,position:"top",triggerElement:null,triggerCoords:null});class Lt{constructor(e){this.opts=Ve(rm,e),this.dialog=null}createDialog(){const{title:e,content:t,confirmText:n,cancelText:d,className:h,closeOnEscape:g,position:m}=this.opts,c=`dialog-position-${m}`,f=[];return e&&f.push({tag:"h3",className:"dialog-title",textContent:e}),t&&f.push({tag:"div",className:"dialog-body",children:Array.isArray(t)?t:[t]}),f.push({tag:"div",className:"dialog-actions",children:[{tag:"button",type:"button",className:"btn btn-sm btn-secondary",textContent:typeof d=="function"?d():d,action:{click:()=>this.handleCancel()}},{tag:"button",type:"submit",className:"btn btn-sm btn-primary",textContent:typeof n=="function"?n():n}]}),V.create({tag:"dialog",className:["formeo-dialog","formeo",c,h],children:[{tag:"form",className:"dialog-form",method:"dialog",children:f,action:{submit:o=>this.handleSubmit(o)}}],action:{cancel:o=>{g?this.handleCancel():o.preventDefault()}}})}handleSubmit(e){e.preventDefault();const t=new FormData(e.target);this.opts.onConfirm(t,this),this.close()}handleCancel(){this.opts.onCancel(this),this.close()}setPosition(){const{position:e,triggerElement:t,triggerCoords:n}=this.opts;if(e!=="trigger"||!this.dialog)return;let d=n;if(!d&&t){const h=t.getBoundingClientRect();d={x:h.left+h.width/2,y:h.bottom+8}}if(d){const h=this.dialog.getBoundingClientRect(),g=window.innerWidth,m=window.innerHeight;let c=d.x-h.width/2,f=d.y;const r=16;c=Math.max(r,Math.min(c,g-h.width-r)),f=Math.max(r,Math.min(f,m-h.height-r)),this.dialog.style.left=`${c}px`,this.dialog.style.top=`${f}px`,this.dialog.style.transform="none"}}open(){if(this.dialog||(this.dialog=this.createDialog()),document.body.appendChild(this.dialog),this.dialog.showModal(),this.opts.position==="trigger"){const e=setTimeout(()=>{this.setPosition(),clearTimeout(e)},0)}return this}close(){this.dialog&&(this.dialog.close(),this.dialog.remove(),this.dialog=null)}static alert(e,t=()=>{}){return new Lt({content:{tag:"p",className:"dialog-message",textContent:e},confirmText:()=>X.get("ok")||"OK",cancelText:"",onConfirm:()=>t()})}static confirm(e,t=()=>{},n=()=>{}){return new Lt({content:{tag:"p",className:"dialog-message",textContent:e},confirmText:()=>X.get("confirm")||"Confirm",onConfirm:()=>t(),onCancel:()=>n()})}static prompt(e,t=()=>{},n=""){return new Lt({content:[{tag:"label",className:"dialog-prompt-label",children:[{tag:"p",className:"dialog-message",textContent:e},{tag:"input",type:"text",name:"prompt-value",className:"dialog-prompt-input",value:n}]}],onConfirm:d=>{const h=d.get("prompt-value");t(h)}})}}const Qh="hidden-property",om="hidden-option",Go=/\.options\[\d+\]$/,sm={"if-sourceProperty":bn(yn,sc,ac),"if-targetProperty":bn(yn),"then-targetProperty":bn(yn,sc,ac),...Object.entries(ap).reduce((l,[e,t])=>(l[`if-${e}`]=t,l[`then-${e}`]=t,l),{})},Jh={assignment:zt,comparison:zt,logical:zt,source:({key:l,value:e,onChange:t,conditionType:n})=>kt.autocomplete({key:`${n}.condition.${l}`,value:e,onChange:t,className:`condition-${l}`}),sourceProperty:zt,targetProperty:zt,target:l=>Jh.source(l),value:({key:l,value:e,onChange:t},n)=>{const d=kt.string({key:`condition.${l}`,value:e});return d.action={input:t},d}};function am({key:l,value:e,conditionType:t}){const n=`${t}-${l}`,d=sm[n];return Object.entries(d||{}).map(([h,g])=>lm({fieldName:l,fieldValue:e,key:h,optionValue:g}))}function lm({fieldName:l,fieldValue:e,key:t,optionValue:n}){return{label:X.get(`${l}.${t}`)||Xe(t).toLowerCase(),value:n,selected:n===e}}function zt({key:l,value:e,onChange:t,conditionType:n}){const d=am({key:l,value:e,conditionType:n}),h=kt.array({key:`condition.${l}`,value:d});return h.action={change:t},h}const cm=l=>!l?.classList.contains(Qh),um={sourceProperty:l=>{const e=l.get("source"),t=l.get("sourceProperty"),n=!!e.value,d=!!e.value.match(Go);return du(d,t),!n},comparison:l=>{const e=l.get("source"),t=l.get("sourceProperty"),n=!!e.value,d=!!e.value.match(Go);return!n||d||t.value!=="value"},assignment:l=>{const e=l.get("target"),t=l.get("targetProperty");return!!!e.value||t.value.startsWith("is")},targetProperty:l=>{const e=l.get("target"),t=l.get("targetProperty"),n=!!e.value.match(Go);return du(n,t),!If(e.value)},target:l=>{const e=l.get("source"),t=l.get("sourceProperty"),n=!!e?.value;return t&&!n?!0:t&&t?.value!=="value"},value:l=>{const e=l.get("target"),t=l.get("targetProperty");return t===void 0?!1:e&&!e.value||!cm(l.get("comparison"))||t.value===ed?!0:t.value.startsWith("is")}},hu=l=>{for(const[e,t]of l){const n=!!um[e]?.(l)||!1;t.classList.toggle(Qh,n)}},ed="isChecked",qo=l=>l.value.endsWith("Checked"),du=(l,e)=>{if(l&&qo(e))return null;const t=Array.from(e.querySelectorAll("option")),n=[];for(const d of t){const h=qo(d),g=l?!h:h;g&&n.push(d.value),d.classList.toggle(om,g)}n.includes(e.value)&&(e.value=l?ed:t.find(d=>!qo(d))?.value||e.value)};function hm(l,e=sp){return e.reduce((t,n)=>(l[n]!==void 0&&t.push([n,l[n]]),t),[])}class dm{constructor({conditionValues:e,conditionType:t,conditionCount:n,index:d},h){this.values=new Map(hm(e)),this.conditionType=t,this.parent=h,this.baseAddress=`${h.address}.${t}`,this.fields=new Map,this.conditionCount=n,this.index=d,this.dom=this.generateDom()}setConditionIndex(e){this.index=e}get address(){return`${this.baseAddress}[${this.index}]`}destroy(){const e=ce.getAddress(this.baseAddress);e.splice(this.index,1),ce.setAddress(this.baseAddress,e),xe.slideUp(this.dom,vt,()=>{this.dom.remove()})}label(){return this.index?null:{tag:"label",className:`condition-label ${this.conditionType}-condition-label`,content:X.get(`condition.type.${this.conditionType}`)}}generateDom(){const e=[];for(const[d,h]of this.values){const g=r=>this.onChangeCondition({key:d,target:r.target}),m={key:d,value:h,conditionType:this.conditionType,onChange:g},c=Jh[d](m,this.values),f=c.dom||V.create(c);this.fields.set(d,c.dom?c:f),e.push(f)}const n={children:[this.label(),...e,...this.generateConditionTypeActionButtons()],className:`f-condition-row ${this.conditionType}-condition-row display-none`,action:{onRender:d=>{this.processUiState()}}};return V.create(n)}generateConditionTypeActionButtons(){const e=[],t="manage-condition-type",n=g=>`${g}-condition-type`,d=V.btnTemplate({title:X.get(`remove${this.conditionType}Condition`),className:[t,n("remove")],content:V.icon("minus"),action:{click:()=>this.destroy(),mouseover:g=>{this.dom.classList.add("to-remove")},mouseout:g=>{this.dom.classList.remove("to-remove")}}});e.push(d);const h=V.btnTemplate({title:X.get(`add${this.conditionType}Condition`),className:[t,n("add")],content:V.icon("plus"),action:{click:()=>{const g=this.parent.addConditionType(this.conditionType),m={changedProperty:null,dataPath:g.address,value:g.value,src:g.dom};this.updateDataDebounced(m)}}});return e.push(h),e}get value(){return Array.from(this.fields).reduce((e,[t,n])=>(e[t]=n.value,e),{})}processUiState(){hu(this.fields),this.dom.classList.remove("display-none")}updateDataDebounced=_n(e=>{J.formeoUpdated(e),ce.setAddress(e.dataPath,e.value)});onChangeCondition=({key:e,target:t})=>{const n={changedProperty:e,dataPath:this.address,value:this.value,src:t};hu(this.fields),this.updateDataDebounced(n)}}const fm=new Map([["attrs",({itemKey:l})=>l],["options",({itemKey:l,key:e})=>`${l}.${e}`]]),td=(l,e)=>{if(e.controlId==="select"){const t=e.editPanels.get("options"),[n,d]=l?Ln:up,h=t.data.map(({[n]:g,...m})=>({[d]:g,...m}));t.setData(h)}},pm=new Map([["attrs-multiple",l=>({change:({target:e})=>{l.field.controlId==="select"&&td(e.checked,l.field)}})]]);class Bt{constructor({key:e,index:t,field:n,panel:d,data:h}){this.field=n,this.itemKey=e,this.itemIndex=t,this.panel=d,this.panelName=d.name,this.isDisabled=n.isDisabledProp(e,this.panelName),this.isHidden=this.isDisabled&&n.config.panels[this.panelName].hideDisabled,this.isLocked=n.isLockedProp(e,this.panelName),this.address=`${n.indexName}.${n.id}.${e}`,this.itemSlug=lc(e),this.conditionTypeWrap=new Map,h!==void 0&&this.field.get(this.itemKey)===void 0&&this.field.set(this.itemKey,h);const g=[`field-${this.itemSlug}`,"prop-wrap"];this.isHidden&&g.push("hidden-property"),this.dom=V.create({tag:"li",className:g,children:{className:"component-prop",children:[this.itemInputs(),this.itemControls]}})}get itemValues(){const e=this.field.get(this.itemKey);return e?.constructor===Object?Fn(Object.entries(e),Ln,"0"):[[this.itemKey,e]]}findOrCreateConditionTypeWrap(e){let t=this.conditionTypeWrap.get(e);return t||(t=V.create({className:`type-conditions-wrap ${e}-conditions-wrap`}),this.conditionTypeWrap.set(e,t),t)}itemInputs(){const e=V.create({className:`${this.panelName}-prop-inputs prop-inputs f-input-group`,children:this.itemValues.map(([t,n])=>this.panelName==="conditions"?this.generateConditionFields(t,n):this.itemInput(t,n))});return this.inputs&&this.inputs.replaceWith(e),this.inputs=e,e}addConditionType=(e,t)=>{const n=this.findOrCreateConditionTypeWrap(e);let d=t;if(!d){const[g]=Xs()[e],m=n.children.length;e===wh&&(g.logical="||"),d={conditionValues:g,conditionCount:m,index:m}}const h=new dm({conditionType:e,...d},this);return n.appendChild(h.dom),h};removeConditionType=(e,t)=>{const d=this.conditionTypeWrap.get(e).children[t];d.destroy(),d.dom.remove()};generateConditionFields=(e,t)=>(this.conditions=new Map,t.forEach((n,d)=>{const h=this.addConditionType(e,{index:d,conditionCount:t.length,conditionValues:n});this.conditions.set(d,h)}),this.findOrCreateConditionTypeWrap(e));get itemControls(){if(this.isLocked)return{className:`${this.panelName}-prop-controls prop-controls`,content:[]};const e={tag:"button",attrs:{type:"button",className:"prop-remove prop-control"},action:{click:()=>{xe.slideUp(this.dom,Ze,n=>{this.field.remove(this.itemKey),n.remove(),this.panel.updateProps()})},mouseover:n=>{this.dom.classList.add("to-remove")},mouseout:n=>{this.dom.classList.remove("to-remove")}},content:V.icon("remove")};return{className:`${this.panelName}-prop-controls prop-controls`,content:[e]}}getConfigAttrOptions(e){const t=e.split(".").pop(),n=this.field.config?.attrs?.[t];return Array.isArray(n)?n:null}itemInput(e,t){if(this.isDisabled)return null;let n=V.childType(t)||"string",d=t;if(this.panelName==="attrs"){const i=this.getConfigAttrOptions(e);i&&(d=i.map(u=>({...u,selected:u.value===t})),n="array")}const h=fm.get(this.panelName)?.({itemKey:this.itemKey,key:e})||this.itemKey,g=h.split(".").filter(Number.isNaN).join(".")||e,m=kt[n]({key:e,value:d}),c=`${this.field.shortId}-${lc(h).replaceAll(/-\d+-(selected)/g,"-$1")}`,f={label:this.panelName!=="options"&&Ue(g),labelAfter:!1,inputWrap:["f-input-wrap",this.isLocked&&"locked-prop",this.isDisabled&&"disabled-prop"].filter(Boolean).join(" ")},r={name:m.attrs.type==="checkbox"?`${c}[]`:c};r.disabled=this.isDisabled,r.readonly=this.isLocked;const o=pm.get(this.itemSlug)?.(this),a=kp(im[n](h,this.field),o||{}),s=Ve(kt[n]({key:e,value:d}),{action:a,attrs:r,config:f});return Ln.includes(e)?{className:"f-addon",children:s}:s}}const gm={multiple:(l,e)=>{td(!!l,e)}},mm=[{label:Ue("config.label"),value:"label"},{label:Ue("config.hideLabel"),value:"hideLabel"},{label:Ue("config.helpText"),value:"helpText"},{label:Ue("config.labelAfter"),value:"labelAfter"},{label:Ue("config.disableHtmlLabel"),value:"disableHtmlLabel"},{label:Ue("config.tooltip"),value:"tooltip"}],vm={label:"New Field",hideLabel:!1,helpText:"",labelAfter:!1,disableHtmlLabel:!1,tooltip:""};class ym{constructor(e,t,n){this.type=V.childType(e),this.name=t,this.component=n,this.panelConfig=this.getPanelConfig(this.data)}get data(){const e=this.component.get(this.name);return this.type==="object"?Object.entries(e):e}getPanelConfig(e){return this.props=this.createProps(e),this.editButtons=this.createEditButtons(),{config:{label:X.get(`panel.label.${this.name}`)},attrs:{className:`${ah} ${this.name}-panel`},children:[this.props,this.editButtons]}}createProps(e=this.data){this.editPanelItems=Array.from(e).map((n,d)=>{const h=this.type==="array",g=n[0],m=h?`[${d}]`:`.${n[0]}`,c=h?n:{[n[0]]:n[1]},f=`${this.name}${m}`,r=this.component.isDisabledProp(f,this.name),o=hp.get(this.name)?.has(g)??!0;return r||!o?null:new Bt({key:f,data:c,field:this.component,index:d,panel:this})}).filter(Boolean);const t={tag:"ul",attrs:{className:["edit-group",`${this.component.name}-edit-group`,`${this.component.name}-edit-${this.name}`]},editGroup:this.name,isSortable:this.name==="options",content:this.editPanelItems};return V.create(t)}updateProps(){const e=this.createProps();this.props.replaceWith(e),this.props=e}createEditButtons(){const e=this.name,t={attrs:this.addAttribute,options:this.addOption,conditions:this.addCondition,config:this.addConfiguration},n=[];if(e==="conditions"){X.current&&!X.current.clearAll&&X.put("clearAll","Clear All");const m={...V.btnTemplate({content:[V.icon("bin"),X.get("clearAll")],title:X.get("clearAll")}),className:`clear-all-${e}`,action:{click:()=>{this.clearAllItems()}}};n.push(m)}const d=X.get(`panelEditButtons.${e}`)||`+ Add ${Xe(e)}`,h={...V.btnTemplate({content:d,title:d}),className:`add-${e}`,action:{click:m=>{const c={btnCoords:V.coords(m.target),addAction:t[e]};e==="attrs"&&(c.isDisabled=this.component.isDisabledProp,c.isLocked=this.component.isLockedProp,c.message={attr:X.get(`action.add.${e}.attr`),value:X.get(`action.add.${e}.value`)});const f=Xe(e),r=new globalThis.CustomEvent(`onAdd${f}`,{detail:c});$e.add[e](c),document.dispatchEvent(r)}}};return n.push(h),{className:"panel-action-buttons",content:n}}addAttribute=(e,t)=>{let n=t;const d=Bh(e),h=`attrs.${d}`;X.current[h]||X.put(h,jh(e)),typeof n=="string"&&["true","false"].includes(n)&&(n=JSON.parse(n)),this.component.set(`attrs.${e}`,n),gm[d]?.(n,this.component);const g=this.props.querySelector(`.${this.component.name}-attrs-${d}`),m=new Bt({key:h,data:{[d]:n},field:this.component,panel:this});g?g.replaceWith(m.dom):this.props.appendChild(m.dom),this.component.resizePanelWrap()};addOption=()=>{const e=this.component.data.config.controlId,t=this.component.get("options"),n=e==="select"?"option":e,d=X.get("newOptionLabel",{type:n})||"New Option",h=`${this.name}[${this.data.length}]`,g=t[t.length-1],c={...t.length?g:{},label:d};e!=="button"&&(c.value=Sh(d));const f=new Bt({key:h,data:c,field:this.component,index:this.props.children.length,panel:this});this.editPanelItems.push(f),this.props.appendChild(f.dom),this.component.debouncedUpdatePreview(),this.component.resizePanelWrap()};addCondition=e=>{const n=`conditions[${this.component.get("conditions").length}]`,d=new Bt({key:n,data:e.template,field:this.component,panel:this});this.props.appendChild(d.dom),this.component.set(n,e.template),this.component.resizePanelWrap()};addConfiguration=()=>{const e=this.component.get("config");new Lt({className:"config-item-dialog",content:[{tag:"select",config:{label:X.get("selectConfigKey")||"Select Configuration Key"},attrs:{name:"selectConfigKey",required:!0,className:"config-key-select"},options:mm.filter(n=>!(n.value in e))}],onConfirm:n=>{const d=n.get("selectConfigKey").trim(),h=`config.${d}`;if(d){const g=new Bt({key:h,data:vm[d],field:this.component,panel:this});this.editPanelItems.push(g),this.props.appendChild(g.dom),this.component.debouncedUpdatePreview(),this.component.resizePanelWrap()}}}).open()};clearAllItems=()=>{const e=this.type==="array"?[]:{},t={type:this.name,removeAction:()=>{this.component.set(this.name,e),this.updateProps()}};$e.remove[this.name](t);const n=Xe(this.name),d=new globalThis.CustomEvent(`onRemove${n}`,{detail:t});document.dispatchEvent(d)};setData(e){this.data=e,this.component.set(this.name,e),this.updateProps()}}const fu=Object.freeze({type:"field",displayType:"slider"}),gn=l=>({transform:`translateX(${l?`${l}px`:0})`});class nd{constructor(e){this.opts=Ve(fu,e),this.panelDisplay=this.opts.displayType,this.activePanelIndex=0,this.panelNav=this.createPanelNav();const t=this.createPanelsWrap();this.nav=this.navActions(),this.nav.groupChange(this.activePanelIndex);const n=new window.ResizeObserver(([{contentRect:{width:h}}])=>{this.currentWidth!==h&&(this.toggleTabbedLayout(),this.currentWidth=h,this.nav.setTranslateX(this.activePanelIndex,!1))}),d=window.setTimeout(()=>{n.observe(t),window.clearTimeout(d)},Vs)}getPanelDisplay(){const e=this.panelsWrap,n=Number.parseInt(V.getStyle(e,"width"),10)>390?"tabbed":"slider",d=this.opts.displayType==="auto";return this.panelDisplay=d?n:this.opts.displayType||fu.displayType,this.panelDisplay}toggleTabbedLayout=()=>{this.getPanelDisplay();const e=this.isTabbed;return this.panelsWrap.parentElement?.classList.toggle("tabbed-panels",e),e&&this.panelNav.removeAttribute("style"),e};resizePanels=()=>{this.toggleTabbedLayout()};createPanelsWrap(){const e=V.create({className:"panels",content:this.opts.panels.map(({config:t,...n})=>n)});return this.opts.type==="field"&&this.sortableProperties(e),this.panelsWrap=e,this.panels=e.children,this.currentPanel=this.panels[this.activePanelIndex],e}sortableProperties(e){const t=e.getElementsByClassName("field-edit-group");return Ne.forEach(t,n=>{n.fieldId=this.opts.id,n.isSortable&&te.create(n,{animation:150,group:{name:`edit-${n.editGroup}`,pull:!0,put:["properties"]},sort:!0,handle:".prop-order",onSort:d=>{this.propertySave(d.to),this.resizePanels()}})})}createPanelNavLabels(){const e=this.opts.panels.map(d=>({tag:"h5",action:{click:h=>{const g=ct(h.target);this.nav.setTranslateX(g,!1),this.nav.groupChange(g)}},content:d.config.label})),t={className:"panel-labels",content:{content:e}},[n]=e;return n.className="active-tab",V.create(t)}createPanelNav(){this.labels=this.createPanelNavLabels();const e={tag:"button",attrs:{className:"next-group",title:X.get("controlGroups.nextGroup"),type:"button"},action:{click:n=>this.nav.nextGroup(n)},content:V.icon("triangle-right")},t={tag:"button",attrs:{className:"prev-group",title:X.get("controlGroups.prevGroup"),type:"button"},action:{click:n=>this.nav.prevGroup(n)},content:V.icon("triangle-left")};return V.create({tag:"nav",attrs:{className:"panel-nav"},content:[t,this.labels,e]})}get isTabbed(){return this.panelDisplay==="tabbed"}navActions(){const e={},t=this.currentPanel.parentElement,n=this.labels.firstChild,d=n.children,h=this.currentPanel.parentElement.childNodes;this.activePanelIndex=ct(this.currentPanel);let g={nav:0,panel:0},m={...g};e.groupChange=r=>(this.activePanelIndex=r,this.currentPanel=h[r],V.removeClasses(h,"active-panel"),V.removeClasses(d,"active-tab"),this.currentPanel.classList.add("active-panel"),d[r].classList.add("active-tab"),this.currentPanel);const c=r=>({nav:-n.offsetWidth*r,panel:-t.offsetWidth*r}),f=({offset:r,reset:o,duration:a=vt,animate:s=!this.isTabbed})=>{const i=[gn(m.panel),gn(r.panel)],u=[gn(m.nav),gn(this.isTabbed?0:r.nav)];if(o){const[M]=i,[$]=u;i.push(M),u.push($)}const p={easing:"ease-in-out",duration:s?a:0,fill:"forwards"},y=t.animate(i,p);n.animate(u,p);const b=()=>{y.removeEventListener("finish",b),o||(m=r)};y.addEventListener("finish",b)};return e.setTranslateX=(r=this.activePanelIndex,o=!0)=>{g=c(r),f({offset:g,animate:o})},e.refresh=(r=this.activePanelIndex)=>{this.activePanelIndex!==r&&e.groupChange(r),e.setTranslateX(this.activePanelIndex,!1),this.resizePanels()},e.nextGroup=()=>{const r=this.activePanelIndex+1;if(r!==h.length){const o=h[r];g={nav:-n.offsetWidth*r,panel:-o.offsetLeft},f({offset:g}),e.groupChange(r)}else g={nav:m.nav-8,panel:m.panel-8},f({offset:g,reset:!0});return this.currentPanel},e.prevGroup=()=>{if(this.activePanelIndex!==0){const r=this.activePanelIndex-1,o=h[r];g={nav:-n.offsetWidth*r,panel:-o.offsetLeft},f({offset:g}),e.groupChange(r)}else g={nav:8,panel:8},f({offset:g,reset:!0})},e}}let Ko=null;const Yo=bn(yn);class Jn extends Js{constructor(e,t={}){const n={...t,id:t.id||He()};super(e,n),this.id=n.id,this.shortId=this.id.slice(0,this.id.indexOf("-")),this.name=e,this.indexName=`${e}s`,this.config={...n.config,...ce[`${this.name}s`].config},this.address=`${this.name}s.${this.id}`,this.dataPath=`${this.address}.`,this.editPanels=new Map,this.eventListeners=new Map,this.initEventHandlers()}initEventHandlers(){this.config.events&&Object.entries(this.config.events).forEach(([e,t])=>{this.addEventListener(e,t)})}addEventListener(e,t){this.eventListeners.has(e)||this.eventListeners.set(e,[]),this.eventListeners.get(e).push(t)}removeEventListener(e,t){if(!this.eventListeners?.has(e))return;const n=this.eventListeners.get(e),d=n.indexOf(t);d>-1&&n.splice(d,1)}dispatchComponentEvent(e,t={}){const n={component:this,target:this,type:e,timestamp:Date.now(),...t};return this.eventListeners?.has(e)&&this.eventListeners.get(e).forEach(d=>{try{typeof d=="function"&&d(n)}catch(h){console.error(`Error in ${e} event handler for ${this.name} ${this.id}:`,h)}}),n}set(e,t){const n=this.get(e),d=super.set(e,t);return n!==t&&this.dom&&this.dispatchComponentEvent("onUpdate",{path:e,oldValue:n,newValue:t}),d}get js(){return this.data}get json(){return this.data}remove=e=>{if(e){const g=yt(e),m=g.pop(),c=this.get(g);return Array.isArray(c)?zh(m)?c.splice(Number(m),1):this.set(g,c.filter(f=>f!==m)):delete c[m],c}if(this.name==="stage")return null;const t=this.parent,n=this.children;this.dispatchComponentEvent("onRemove",{path:e,parent:t,children:[...n]}),Qn(n,g=>g.remove()),this.dom.remove(),Of(ce.getAddress(`${t.name}s.${t.id}.children`),this.id),t.children.length||t.emptyClass(),t.name==="row"&&t.autoColumnWidths();const h={row:Ks,column:Ys,field:Zs}[this.name];return h&&J.formeoUpdated({componentId:this.id,componentType:this.name,parent:t},h),ce[`${this.name}s`].delete(this.id)};empty(){const e=this.children.map(t=>(t.remove(),t));return this.dom.classList.add("empty"),e}emptyClass=()=>this.dom.classList.toggle("empty",!this.children.length);getActionButtons(){const e=[`hovering-${this.name}`,"hovering"];return{className:[`${this.name}-actions`,"group-actions"],action:{mouseenter:()=>{ce.stages.active.dom.classList.add(`active-hover-${this.name}`),this.dom.classList.add(...e)},mouseleave:({target:t})=>{this.dom.classList.remove(...e),ce.stages.active.dom.classList.remove(`active-hover-${this.name}`),t.removeAttribute("style")}},children:[{...V.btnTemplate({content:V.icon(`handle-${this.name}`)}),className:["component-handle",`${this.name}-handle`]},{className:["action-btn-wrap",`${this.name}-action-btn-wrap`],children:this.buttons}]}}getComponentTag=()=>V.create({tag:"span",className:["component-tag",`${this.name}-tag`],children:[V.icon(`handle-${this.name}`),Xe(this.name)].filter(Boolean)});toggleEdit(e=!this.isEditing){this.isEditing=e;const t=this.dom,n="editing",d=`${n}-${this.name}`,h=this.dom.querySelector(`.${this.name}-edit`);xe.slideToggle(h,Ze,e),this.name==="field"&&(xe.slideToggle(this.preview,Ze,!e),t.parentElement.classList.toggle(`column-${d}`,e)),t.classList.toggle(n,e),t.classList.toggle(d,e)}get buttons(){if(this.actionButtons)return this.actionButtons;const e={handle:(g=`handle-${this.name}`)=>({...V.btnTemplate({content:V.icon(g)}),className:["component-handle"]}),move:(g="move")=>({...V.btnTemplate({content:V.icon(g)}),className:["item-move"],meta:{id:"move"}}),edit:(g="edit")=>({...V.btnTemplate({content:V.icon(g)}),className:["edit-toggle"],meta:{id:"edit"},action:{click:()=>{this.toggleEdit()}}}),remove:(g="remove")=>({...V.btnTemplate({content:V.icon(g)}),className:["item-remove"],meta:{id:"remove"},action:{click:()=>{xe.slideUp(this.dom,Ze,()=>{this.name==="column"?(this.parent.autoColumnWidths(),this.remove()):this.remove()})}}}),clone:(g="copy")=>({...V.btnTemplate({content:V.icon(g)}),className:["item-clone"],meta:{id:"clone"},action:{click:()=>{this.clone(this.parent),this.name==="column"&&this.parent.autoColumnWidths()}}})},{buttons:t,disabled:n}=this.config.actionButtons,h=t.filter(g=>!n.includes(g)).map(g=>e[g]?.()||g);return this.actionButtons=h,this.actionButtons}get index(){return ct(this.dom)}removeClasses=e=>{const t={string:()=>this.dom.classList.remove(e),array:()=>e.map(n=>this.dom.classList.remove(n))};return t.object=t.string,t[V.childType(e)](this.dom)};get parentType(){return Jf.get(this.name)}get parent(){const e=this.parentType;if(!this.dom||!e)return null;const t=this.dom.closest(`.${js[e]}`);return t&&V.asComponent(t)}get children(){if(!this.dom)return[];const e=this.domChildren,t=rc.get(this.name);return ia(e,n=>ce.getAddress(`${t}s.${n.id}`)).filter(Boolean)}loadChildren=(e=this.data.children)=>e.map(t=>this.addChild({id:t}));get domChildren(){const e=this.dom.querySelector(".children");return e?e.children:[]}addChild(e={},t=this.domChildren.length){let n=e;typeof e!="object"&&(n={id:n});const d=this.dom.querySelector(".children"),{id:h=He()}=n,g=rc.get(this.name);if(!g)return null;const m=`${g}s`,c=ce.getAddress(`${m}.${h}`)||ce[m].add(h,n);t>=d.children.length?d.appendChild(c.dom):d.children[t].before(c.dom),this.dispatchComponentEvent("onAddChild",{parent:this,target:c,child:c,index:t}),c.dispatchComponentEvent("onAdd",{parent:this,target:c,index:t,addedVia:"addChild"}),this.config.events?.onAddChild?.({parent:this,child:c});const f=c.get("children");return f?.length&&c.loadChildren(f),this.removeClasses("empty"),this.saveChildOrder(),c}saveChildOrder=()=>{if(this.render)return;const e=this.children.map(({id:t})=>t);return this.set("children",e),e};onAdd({from:e,to:t,item:n,newIndex:d}){e.classList.contains(lt)||(e=e.parentElement);const h=Le(e),g=Le(t.parentElement),m=()=>{this.saveChildOrder(),this.removeClasses("empty")},c=new Map([[-2,()=>{const o=this.addChild({},d).addChild();return o.addChild.bind(o)}],[-1,()=>{const o=this.addChild({},d);return o.addChild.bind(o)}],[0,()=>this.addChild.bind(this)],[1,o=>{const a=ct(this.dom);return()=>this.parent.addChild(o,a+1)}],[2,o=>()=>this.parent.parent.addChild(o)]]),r={controls:async()=>{if(!Ko){const{default:b}=await xt(async()=>{const{default:M}=await Promise.resolve().then(()=>Om);return{default:M}},void 0);Ko=b}const{controlData:{meta:{id:o},...a}}=Ko.get(n.id);Yn(a,"config.controlId",o);const s=o.startsWith("layout-")?o.replace(/^layout-/,""):"field",u=Re({stage:{row:0,column:-1,field:-2},row:{row:1,column:0,field:-1},column:{row:2,column:1,field:0},field:1},`${this.name}.${s}`),p=c.get(u)();return V.remove(n),p(a,d)},row:()=>{const o={stage:-1,row:0,column:1};return(c.get(o[g])||Cs)()?.({id:n.id},d)},column:()=>{const o={stage:-2,row:-1};return(c.get(o[g])||Cs)()?.(n.id)}}[h]?.(n,d);return this.dispatchComponentEvent("onAdd",{from:e,to:t,item:n,newIndex:d,fromType:h,toType:g,addedComponent:r,addedVia:"dragDrop"}),m(),r}onSort=()=>this.saveChildOrder();onRemove({from:{parentElement:e}}){return e.classList.contains(tt)&&e.classList.remove("column-editing-field"),this.name!=="stage"&&!this.children.length?this.remove():(this.emptyClass(),this.saveChildOrder())}onEnd=({to:{parentElement:e},from:{parentElement:t}})=>{e?.classList.remove(`hovering-${Le(e)}`),t?.classList.remove(`hovering-${Le(t)}`)};onRender(){this.dispatchComponentEvent("onRender",{dom:this.dom});const{events:e}=this.config;if(!e)return null;e.onRender&&V.onRender(this.dom,e.onRender)}set config(e){const t=Re(e,"all"),n=Re(this.data,"config.controlId"),d=n&&Re(e,n),h=Re(e,this.id),g=[t,d,h].reduce((m,c)=>c?Ve(m,c):m,this.configVal);this.configVal=g}get config(){return this.configVal}runConditions=()=>{const e=this.get("conditions");return e?.length?e.map(n=>{const d=this.processConditions(n.if),h=this.processResults(n.then);return d.map(g=>this.evaluateConditions(g)&&this.execResults(h))}):null};getComponent(e){const[t,n]=e.split("."),d=ce[t];return n===this.id?this:d?.get(n)}value=(e,t)=>{const n=e.split("."),d=this.getComponent(e),h=d&&n.slice(2,n.length).join(".");return[!d,!h,!Yo[h]].some(Boolean)?e:t?d.set(Yo[h],t):d.get(Yo[h])};getResult=e=>({"=":(n,d,h)=>n.set(d,h)})[e];processResults=e=>e.map(({operator:t,target:n,value:d})=>{const h=this.getComponent(n),g=h&&n.split(".").slice(2,n.length).join(".");return{target:h,propertyPath:g,action:this.getResult(t),value:this.value(d)}});execResults=e=>{const t=e.map(n=>this.execResult(n));return Promise.all(t)};execResult=({target:e,action:t,value:n,_propertyPath:d})=>new Promise((h,g)=>{try{return h(t(e,n))}catch(m){return g(m)}});cloneData=()=>{const e={...Je(this.data),id:He()};return this.name!=="field"&&(e.children=[]),e};clone=(e=this.parent)=>{const t=e.addChild(this.cloneData(),this.index+1);return this.name!=="field"&&this.cloneChildren(t),this.dispatchComponentEvent("onClone",{original:this,clone:t,parent:e}),t};cloneChildren(e){for(const t of this.children)t?.clone(e)}createChildWrap=e=>V.create({tag:"ul",attrs:{className:"children"},children:e});get isRow(){return this.name===Vr.row}get isColumn(){return this.name===Vr.column}get isField(){return this.name===Vr.field}isDisabledProp=(e,t="attrs")=>{if(Re(this.config,e))return!1;if((this.config?.disabled||[]).includes(e))return!0;const h=Rn(e);return(this.config?.panels[t]?.disabled||[]).includes(h)};isLockedProp=(e,t="attrs")=>{if((this.config?.locked||[]).includes(e))return!0;const h=Rn(e);return!!(this.config?.panels[t]?.locked||[]).includes(h)};get editWindow(){const e={className:["component-edit",`${this.name}-edit`,"slide-toggle","formeo-panels-wrap"]},t=this.editPanels.size;return t&&(e.className.push(`panel-count-${t}`),e.content=[this.panels.panelNav,this.panels.panelsWrap],this.panelNav=this.panels.nav,this.resizePanelWrap=this.panels.nav.refresh),e.action={onRender:()=>{if(t===0){const n=this.dom.querySelector(".edit-toggle"),d=this.dom.querySelector(`.${this.name}-actions`),h=d.getElementsByTagName("button");d.style.maxWidth=`${h.length*h[0].clientWidth}px`,V.remove(n)}else this.resizePanelWrap()}},V.create(e)}updateEditPanels=()=>{if(!this.config)return null;const e=new Set(["object","array"]),t=mt([...this.config.panels.order,...Object.keys(this.data)]),n=new Set(["children","meta","action","events",...this.config.panels.disabled]),d=t.filter(g=>!n.has(g));for(const g of d){const m=this.get(g),c=V.childType(m);if(e.has(c)){const f=new ym(m,g,this);this.editPanels.set(f.name,f)}}const h={panels:Array.from(this.editPanels.values()).map(({panelConfig:g})=>g),id:this.id,displayType:"auto"};this.panels=new nd(h),this.dom&&(this.dom.querySelector(".panel-nav").replaceWith(this.panels.panelNav),this.dom.querySelector(".panels").replaceWith(this.panels.panelsWrap))}}class bm{constructor(){this.onMove=this.onMove.bind(this),this.onStop=this.onStop.bind(this),this.cleanup=this.cleanup.bind(this)}getRowWidth(e){const t=e.querySelector(".children");if(!t)return 0;const n=t.children.length,d=V.getStyle(t,"gap")||"0px",h=parseFloat(d,10)||0;return this.totalGapWidth=h*(n-1),t.offsetWidth-this.totalGapWidth}validateResizeTarget(e,t){return e&&t&&e.offsetWidth&&t.offsetWidth}onStart(e){if(e.preventDefault(),this.resized=!1,e.button!==0)return;const t=e.target.parentElement,n=t.nextSibling||t.previousSibling,d=t.closest(`.${et}`);if(!this.validateResizeTarget(t,n)){console.warn("Invalid resize targets"),this.cleanup();return}if(this.startX=e.type==="touchstart"?e.touches[0].clientX:e.clientX,d.classList.add(jr),this.columnPreset=d.querySelector(`.${lh}`),this.originalColumnClass=t.className,this.originalSiblingClass=n.className,t.className=t.className.replace($s,""),n.className=n.className.replace($s,""),this.colStartWidth=t.offsetWidth,this.sibStartWidth=n.offsetWidth,this.rowWidth=this.getRowWidth(d),this.rowWidth<=0){console.warn("Invalid row width calculated"),this.cleanup();return}this.column=t,this.sibling=n,this.row=d;try{window.addEventListener("pointermove",this.onMove,!1),window.addEventListener("pointerup",this.onStop,!1)}catch(h){console.error("Failed to initialize resize listeners:",h),this.cleanup()}}calculateNewWidths(e){const t=this.colStartWidth+e-this.startX,n=this.sibStartWidth-e+this.startX,d=parseFloat(Br(t,this.rowWidth)),h=parseFloat(Br(n,this.rowWidth));return d<10||h<10?null:{colWidth:ws(d.toFixed(1)),siblingColWidth:ws(h.toFixed(1))}}onMove(e){e.preventDefault();const{column:t,sibling:n}=this,d=e.type==="touchmove"?e.touches[0].clientX:e.clientX,h=this.calculateNewWidths(d);if(!h)return;const{colWidth:g,siblingColWidth:m}=h;t.dataset.colWidth=g,n.dataset.colWidth=m,t.style.width=g,n.style.width=m,this.resized=!0}onStop(){const{column:e,sibling:t}=this;window.removeEventListener("pointermove",this.onMove),window.removeEventListener("pointerup",this.onStop),this.resized&&(this.setCustomWidthValue(),ce.setAddress(`columns.${e.id}.config.width`,e.dataset.colWidth),ce.setAddress(`columns.${t.id}.config.width`,t.dataset.colWidth),this.row.classList.remove(jr),this.resized=!1,this.cleanup())}cleanup(){this.column&&this.originalColumnClass&&(this.column.className=this.originalColumnClass),this.sibling&&this.originalSiblingClass&&(this.sibling.className=this.originalSiblingClass),this.row&&this.row.classList.remove(jr),window.removeEventListener("pointermove",this.onMove),window.removeEventListener("pointerup",this.onStop)}setCustomWidthValue(){const e=this.columnPreset;let t=e.querySelector(`.${As}`);const n=this.row.querySelector(".children").children,d=ia(n,m=>Br(m.clientWidth,this.rowWidth).toFixed(1)),h=d.join(","),g=d.join(" | ");return t||(t=V.create({tag:"option",attrs:{className:As,value:h,selected:!0},content:g}),e.append(t)),t.value=h,t.textContent=g,h}}const wm=()=>Object.freeze({config:{width:"100%"},children:[],className:[tt]}),pu={resizeHandle:l=>({className:"resize-x-handle",action:{pointerdown:l.onStart.bind(l)},content:[V.icon("triangle-down"),V.icon("triangle-up")]}),editWindow:()=>({className:"column-edit group-config"})};class Cm extends Jn{constructor(e){super("column",{...wm(),...e});const t=this.createChildWrap();this.dom=V.create({tag:"li",className:[tt,"empty"],dataset:{hoverTag:X.get("column")},id:this.id,content:[this.getComponentTag(),this.getActionButtons(),pu.editWindow(),pu.resizeHandle(new bm),t]}),this.processConfig(),J.columnResized=new window.CustomEvent("columnResized",{detail:{column:this.dom,instance:this}}),te.create(t,{animation:150,fallbackClass:"field-moving",forceFallback:!0,group:{name:"column",pull:!0,put:["column","controls"]},sort:!0,disabled:!1,onEnd:this.onEnd.bind(this),onAdd:this.onAdd.bind(this),onSort:this.onSort.bind(this),onRemove:this.onRemove.bind(this),onMove:n=>{n.from!==n.to&&n.from.classList.remove("hovering-column")},draggable:`.${Ft}`,handle:".item-move"})}processConfig(){const e=Ne.get(this.data,"config.width");e&&this.setDomWidth(e)}refreshFieldPanels=()=>{for(const e of this.children)e.panels.nav.refresh()};setDomWidth=e=>{this.dom.dataset.colWidth=e,this.dom.style.width=e};setWidth=e=>(this.setDomWidth(e),this.set("config.width",e))}const Sm={actionButtons:{buttons:["clone","move","remove"],disabled:[]}};let Am=class extends Zn{constructor(e){super("columns",e),this.config={all:Sm}}Component(e){return new Cm(e)}};const id=new Am,$m=()=>Object.freeze({config:{fieldset:!1,legend:"",inputGroup:!1},children:[],className:[et]});class xm extends Jn{constructor(e){super("row",{...$m(),...e});const t=this.createChildWrap();this.dom=V.create({tag:"li",className:[et,"empty"],dataset:{hoverTag:X.get("row"),editingHoverTag:X.get("editing.row")},id:this.id,content:[this.getComponentTag(),this.getActionButtons(),this.editWindow,t]}),te.create(t,{animation:150,fallbackClass:"column-moving",forceFallback:!0,group:{name:"row",pull:!0,put:["row","column","controls"]},sort:!0,disabled:!1,onRemove:this.onRemove.bind(this),onEnd:this.onEnd.bind(this),onAdd:this.onAdd.bind(this),onSort:this.onSort.bind(this),draggable:`.${tt}`,handle:".item-move"})}get editWindow(){const e={tag:"input",id:`${this.id}-fieldset`,attrs:{type:"checkbox",checked:this.get("config.fieldset"),ariaLabel:X.get("row.settings.fieldsetWrap.aria")},action:{click:({target:{checked:a}})=>{this.set("config.fieldset",!!a)}},config:{label:X.get("row.settings.fieldsetWrap")}},t={tag:"input",id:`${this.id}-inputGroup`,attrs:{type:"checkbox",checked:this.get("config.inputGroup"),ariaLabel:X.get("row.settings.inputGroup.aria")},action:{click:({target:{checked:a}})=>this.set("config.inputGroup",a)},config:{label:X.get("row.makeInputGroup"),description:X.get("row.makeInputGroupDesc")}},n={tag:"span",content:" ⓘ",dataset:{tooltip:"Row title will be used as the legend for the fieldset"}},h={className:"input-group",content:{tag:"input",attrs:{type:"text",ariaLabel:"Legend for fieldset",value:this.get("config.legend"),placeholder:"Title"},config:{label:{children:["Row Title",n]}},action:{input:({target:{value:a}})=>this.set("config.legend",a)},className:""}},g=V.formGroup([e,h]),m={tag:"label",content:X.get("defineColumnWidths"),className:"col-sm-4 form-control-label"};this.columnPresetControl=V.create(this.columnPresetControlConfig);const c={className:"col-sm-8",content:this.columnPresetControl,action:{onRender:()=>{this.updateColumnPreset()}}},f=V.formGroup([m,c],"row"),r=[t,"hr",g,"hr",f];return V.create({className:`${this.name}-edit group-config`,action:{onRender:a=>{const s=r.map(i=>V.create(i));a.append(...s)}}})}onAdd(...e){super.onAdd(...e),this.autoColumnWidths()}onRemove(...e){super.onRemove(...e),this.autoColumnWidths()}autoColumnWidths=()=>{const e=this.children;if(!e.length)return;const t=Number.parseFloat((100/e.length).toFixed(1))/1;for(const n of e){n.removeClasses($s);const d=n.dom,h=ws(t);n.set("config.width",h),d.style.width=h,d.dataset.colWidth=h;const g=setTimeout(()=>{clearTimeout(g),n.refreshFieldPanels()},vt);document.dispatchEvent(J.columnResized)}this.updateColumnPreset()};updateColumnPreset=()=>{this.columnPresetControl.innerHTML="";const e=this.getColumnPresetOptions.map(({label:t,...n})=>V.create({tag:"option",content:t,attrs:n}));this.columnPresetControl.append(...e)};setColumnWidths=e=>{typeof e=="string"&&(e=e.split(",")),this.children.forEach((t,n)=>{t.setWidth(`${e[n]}%`),t.refreshFieldPanels()})};get getColumnPresetOptions(){const e=this.children,n=tp.get(e.length-1)||[],d=e.map(h=>{const g=h.get("config.width")||"";return Number(g.replace("%","")).toFixed(1)}).join(",");if(n.length){const h=n.slice();return!h.find(m=>m.value===d)&&h.push({value:d,label:d.replace(/,/g," | "),className:As}),h.map(m=>{const c={...m};return c.selected=m.value===d,c})}return[]}get columnPresetControlConfig(){return{tag:"select",attrs:{ariaLabel:X.get("defineColumnLayout"),className:lh},action:{change:({target:t})=>{const{value:n}=t;this.setColumnWidths(n)}},options:this.getColumnPresetOptions}}}const Mm={actionButtons:{buttons:["move","edit","clone","remove"],disabled:[]}};let Em=class extends Zn{constructor(e){super("rows",e),this.config={all:Mm}}Component(e){return new xm(e)}};const sa=new Em,_m=()=>({conditions:[Xs()],children:[]});class Tm extends Jn{constructor(e){super("stage",{..._m(),...e}),this.updateEditPanels(),this.debouncedUpdateEditPanels=_n(this.updateEditPanels),X.get("Untitled Form"),X.get("Untitled Form"),X.get("Form Title"),X.get("Form novalidate"),X.get("Tags");const t=this.createChildWrap();this.dom=V.create({attrs:{className:[Nt,"empty"],id:this.id},children:[this.getComponentTag(),this.getActionButtons(),this.editWindow,t]}),te.create(t,{animation:150,fallbackClass:"row-moving",group:{name:"stage",pull:!0,put:["row","column","controls"]},sort:!0,disabled:!1,onAdd:this.onAdd.bind(this),onRemove:this.onRemove.bind(this),onStart:()=>{rn.active=this},onSort:this.onSort.bind(this),draggable:`.${et}`,handle:".item-move"})}empty(e=!0){return new Promise(t=>{e?(this.dom.classList.add("removing-all-fields"),xe.slideUp(this.dom,Ze,()=>{t(super.empty(e)),this.dom.classList.remove("removing-all-fields"),xe.slideDown(this.dom,Ze)})):t(super.empty())})}onAdd(...e){const t=super.onAdd(...e);t?.name==="column"&&t.parent.autoColumnWidths()}}const Lm=()=>({actionButtons:{buttons:["edit"],disabled:[]},panels:{disabled:[],order:["attrs","options","conditions"]}});let Rm=class extends Zn{constructor(e){super("stages",e),this.config={all:Lm()}}Component(e){return new Tm(e)}};const rn=new Rm;class km{controlCache=new Set;constructor({events:e={},dependencies:t={},controlAction:n,...d}){this.events=e,this.controlData=d,this.controlAction=n,this.dependencies=t,this.id=d.id||He()}get controlId(){return this.controlData.meta?.id||this.controlData.config?.controlId}get dom(){const{meta:e,config:t}=this.controlData;this.i18n(t.label)||t.label;const n={tag:"button",attrs:{type:"button"},content:[{tag:"span",className:"control-icon",children:V.icon(e.icon)},{tag:"span",className:"control-label",content:"controlLabel"}],action:{focus:({target:d})=>{const h=d.closest(`.${lt}`);return h&&Dt.panels.nav.refresh(ct(h))},click:({target:d})=>{const h=d.closest(".field-control")?.id;h&&Dt.addElement(h)}}};return V.create({tag:"li",id:this.id,className:["field-control",`${e.group}-control`,`${e.id}-control`],content:n,meta:e,action:this.controlAction})}promise(){return Gh(this.dependencies)}i18n(e,t){const n=X.locale,h=this.definition?.i18n?.[n]||{};return(h[e]?.()??h[e])||X.get(e,t)}}const Dm=Object.freeze({sortable:!0,elementOrder:{},groupOrder:[],groups:[{id:"layout",label:"controls.groups.layout",elementOrder:["row","column"]},{id:"common",label:"controls.groups.form",elementOrder:["button","checkbox"]},{id:"html",label:"controls.groups.html",elementOrder:["header","block-text"]}],disable:{groups:[],elements:[],formActions:[]},elements:[],container:null,panels:{displayType:"slider"}});let rd=class{constructor(){this.data=new Map,this.buttonActions={focus:({target:e})=>{const t=e.closest(`.${lt}`);return t&&this.panels.nav.refresh(ct(t))},click:({target:e})=>{this.addElement(e.parentElement.id)}}}async init(e,t=!1){return await this.applyOptions(e),this.buildDOM(t),this}registerControls(e){return this.controls=[],e.map(t=>{const d=typeof t=="function"?new t:new km(t);return this.add(d),this.controls.push(d.dom),d.promise()})}groupLabel=e=>X.get(e)||e||"";groupElements(){let e=this.options.groups.slice(),t=this.controls.slice(),n=[];const d=[];return e=Fn(e,this.groupOrder,"id"),e=e.filter(h=>nc(h.id,this.options.disable.groups)),n=e.map(h=>{const g={tag:"ul",attrs:{className:[lt,ah],id:`${h.id}-${lt}`},config:{label:this.groupLabel(h.label)}};if(this.options.elementOrder[h.id]){const m=this.options.elementOrder[h.id],c=mt(m.concat(h.elementOrder));h.elementOrder=c}return t=Fn(t,h.elementOrder,"meta.id"),g.content=t.filter(m=>{const{controlData:c}=this.get(m.id),f=c.meta.id||"",r=[nc(f,this.options.disable.elements),c.meta.group===h.id,!d.includes(f)];let o=!0;return o=r.every(a=>a===!0),o&&d.push(f),o}),g}),n}add(e=Object.create(null)){const t=Je(e);return this.data.set(t.id,t),t.controlData.meta.id&&this.data.set(t.controlData.meta.id,t.controlData),t}get(e){return Je(this.data.get(e))}formActions(){if(this.options.disable.formActions===!0)return null;const e={...V.btnTemplate({content:[V.icon("bin"),X.get("clear")],title:X.get("clearAll")}),className:["clear-form"],action:{click:d=>{sa.size?(J.confirmClearAll=new window.CustomEvent("confirmClearAll",{detail:{confirmationMessage:X.get("confirmClearAll"),clearAllAction:()=>{rn.clearAll().then(()=>{const h={src:d.target};J.formeoCleared(h)})},btnCoords:V.coords(d.target)}}),document.dispatchEvent(J.confirmClearAll)):window.alert(X.get("cannotClearFields"))}}},t={...V.btnTemplate({content:[V.icon("floppy-disk"),X.get("save")],title:X.get("save")}),className:["save-form"],action:{click:async({target:d})=>{const{default:h}=await xt(async()=>{const{default:c}=await Promise.resolve().then(()=>zm);return{default:c}},void 0),{formData:g}=h,m={action:()=>{},coords:V.coords(d),message:"",button:d};return $e.click.btn(m),$e.save.form(g)}}};return{className:"form-actions f-btn-group",content:Object.entries({clearBtn:e,saveBtn:t}).reduce((d,[h,g])=>(this.options.disable.formActions.includes(h)||d.push(g),d),[])}}buildDOM(e){const t=this.groupElements(),n=this.formActions(),{displayType:d}=this.options.panels;this.panels=new nd({panels:t,type:"controls",displayType:d});const h=["control-groups","formeo-panels-wrap",`panel-count-${t.length}`],g=V.create({className:h,content:[this.panels.panelNav,this.panels.panelsWrap]}),m=["formeo-controls"];e&&m.push("formeo-sticky");const c=V.create({className:m,content:[g,n]}),f=c.getElementsByClassName("control-group");this.dom=c,this.groups=f;const[r]=f;this.currentGroup=r,this.actions={filter:o=>{const a=o!=="",s=this.controls;let i=g.querySelector(".filtered-term");if(V.toggleElementsByStr(s,o),a){const u=X.get("controls.filteringTerm",o);c.classList.add("filtered"),i?i.textContent=u:(i=V.create({tag:"h5",className:"filtered-term",content:u}),g.insertBefore(i,g.firstChild))}else i&&(c.classList.remove("filtered"),i.remove())},addElement:this.addElement,addGroup:o=>console.log(o)};for(let o=f.length-1;o>=0;o--){const a=`formeo-controls-${f[o]}`;this.options.sortable||globalThis.localStorage.removeItem(a),te.create(f[o],{animation:150,fallbackClass:"control-moving",fallbackOnBody:!0,forceFallback:!0,fallbackTolerance:5,group:{name:"controls",pull:"clone",put:!1,revertClone:!0},onClone:({clone:s,item:i})=>{if(s.id=i.id,this.options.ghostPreview){const{controlData:u}=this.get(i.id);xt(async()=>{const{default:p}=await Promise.resolve().then(()=>Fm);return{default:p}},void 0).then(({default:p})=>{s.innerHTML="",s.appendChild(new p(u).preview)})}},onStart:()=>{this.originalDocumentOverflow=document.documentElement.style.overflow,document.documentElement.style.overflow="hidden"},onEnd:()=>{document.documentElement.style.overflow=this.originalDocumentOverflow,this.originalDocumentOverflow=null},sort:this.options.sortable,store:{get:()=>{const s=globalThis.localStorage.getItem(a);return s?s.split("|"):[]},set:s=>{const i=s.toArray();globalThis.localStorage.setItem(a,i.join("|"))}}})}return c}layoutTypes={row:()=>rn.active.addChild(),column:()=>this.layoutTypes.row().addChild(),field:e=>this.layoutTypes.column().addChild(e)};addElement=e=>{const{meta:{group:t,id:n},...d}=Re(this.get(e),"controlData");return Yn(d,"config.controlId",n),t==="layout"?this.layoutTypes[n.replace("layout-","")]():this.layoutTypes.field(d)};applyOptions=async(e={})=>{const{container:t,elements:n,groupOrder:d,...h}=Ve(Dm,e);this.container=t,this.groupOrder=mt(d.concat(["common","html","layout"])),this.options=h;const[g,m,c]=await Promise.all([xt(()=>import("./index.min.js"),[]),xt(()=>import("./index.min2.js"),[]),xt(()=>import("./index.min3.js"),[])]),f=[g.default,m.default,c.default].flat();return Promise.all(this.registerControls([...f,...n]))}};const Dt=new rd,Om=Object.freeze(Object.defineProperty({__proto__:null,Controls:rd,default:Dt},Symbol.toStringTag,{value:"Module"})),Im=new Set(["checkbox","radio"]),Nm=new Set(["radio","checkbox","select-one","select-multiple"]);class od extends Jn{constructor(e=Object.create(null)){super("field",e),this.debouncedUpdateEditPanels=_n(this.updateEditPanels),this.debouncedUpdatePreview=_n(this.updatePreview),this.label=V.create(this.labelConfig),this.preview=this.fieldPreview(),this.controlId=this.get("config.controlId")||this.get("meta.id");const t=this.getActionButtons(),n=this.actionButtons.some(h=>h.meta?.id==="edit");this.updateEditPanels();const d=V.create({tag:"li",attrs:{className:Ft},id:this.id,children:[this.label,this.getComponentTag(),t,n&&this.editWindow,this.preview].filter(Boolean),panelNav:this.panelNav,dataset:{hoverTag:X.get("field")}});this.dom=d,this.isEditing=!1}get labelConfig(){if(!!this.get("config.hideLabel"))return null;const{label:t,editorLabel:n,disableHtmlLabel:d,helpText:h,tooltip:g}=this.get("config"),{required:m}=this.get("attrs")||{},c=n||t,f={tag:"label",attrs:{}};return d?(f.tag="input",f.attrs.value=c):(f.attrs.contenteditable=!0,f.children=c),{className:"prev-label",children:[{...f,action:{input:({target:{innerHTML:a,value:s}})=>{const i=d?s:a;super.set("config.label",i);const u=this.dom.querySelector(".config-label");u&&(u.value=i)}}},m&&V.requiredMark(),g&&V.tooltip(g),h&&V.helpText(h)]}}setData=(e,t)=>super.set(e,t);set(e,t){return this.setData(e,t)}updateLabel(){const e=V.create(this.labelConfig);(this.label||!e)&&this.label.remove(),e&&(this.data.config?.labelAfter?this.dom.append(e):this.dom.prepend(e)),this.label=e}updatePreview=()=>{this.updateLabel();const e=this.fieldPreview();this.preview.replaceWith(e),this.preview=e};get defaultPreviewActions(){return{change:e=>{const{target:t}=e,{type:n}=t;if(Nm.has(n)){const d=this.preview.querySelectorAll(":checked"),h=this.get("options"),g=h?.[0]?.selected===void 0?"checked":"selected",m=h.reduce((c,f)=>(c[f.value]=f,c[f.value][g]=!1,c),{});for(const c of d)m[c.value][g]=c.value===m[c.value].value;return super.set("options",Object.values(m)),this.debouncedUpdateEditPanels()}},click:e=>{e.target.contentEditable==="true"&&e.preventDefault()},input:({target:e})=>{if(["input","meter","progress","button"].includes(e.tagName.toLowerCase()))return super.set("attrs.value",e.value),this.debouncedUpdateEditPanels();if(e.contentEditable&&!e.type?.startsWith("select-")){const t=e.parentElement.classList;if(t.contains("f-checkbox")||t.contains("f-radio")){const d=e.parentElement,h=ct(d);return this.setData(`options[${h}].label`,e.innerHTML),this.debouncedUpdateEditPanels()}this.setData("content",e.innerHTML||e.value)}}}}fieldPreview(){const{action:e={},...t}=Je(this.data);t.id=`prev-${this.id}`,t.action=Object.entries(e).reduce((d,[h,g])=>(d[h]=g.bind(this),d),{}),this.data?.config.editableContent&&(t.attrs={...t.attrs,contenteditable:!0});const n={attrs:{className:"field-preview",style:this.isEditing&&"display: none;"},content:V.create(t,!0),action:this.defaultPreviewActions};return V.create(n,!0)}get isCheckable(){return Im.has(this.get("config.controlId"))}}const Fm=Object.freeze(Object.defineProperty({__proto__:null,default:od},Symbol.toStringTag,{value:"Module"})),Pm=()=>({actionButtons:{buttons:["move","edit","clone","remove"],disabled:[]},panels:{disabled:[],attrs:{disabled:["type"],hideDisabled:!0,locked:[]},order:["attrs","options","conditions"]},label:{disableHTML:!1}});let Hm=class extends Zn{constructor(e){super("fields",e),this.config={all:Pm()}}Component(e){return new od(e)}get=e=>{let t=e&&Re(this.data,e);if(!t){const n=Dt.get(e);n&&(t=this.add(null,n.controlData))}return t};getData=()=>Object.entries(this.data).reduce((e,[t,n])=>{const{conditions:d,...h}=n?.getData()||n;if(d?.length){let g=!0;if(d.length===1){const[m]=d;g=!!m.if[0].source}g&&(h.conditions=d)}return e[t]=h,e},{});load=(e=Object.create(null))=>{const t=Gn(e);this.empty();for(const[n,d]of Object.entries(t)){const{meta:h,...g}=d;h?.id&&Yn(g,"config.controlId",h?.id),this.add(n,g)}return this.data}};const sd=new Hm,xn=rn,Mn=sa,tn=id,En=sd,Hn=Dt,Wm=(l,e=!1)=>l?Je(Gn(l)):e&&oh.get(hh)||Tn();class ad extends Js{constructor(){super("components"),this.disableEvents=!0,this.stages=xn,this.rows=Mn,this.columns=tn,this.fields=En,this.controls=Hn}load=(e,t)=>{this.empty();const n=Wm(e,t.sessionStorage);this.opts=t,this.set("id",n.id),this.add("stages",xn.load(n.stages)),this.add("rows",Mn.load(n.rows)),this.add("columns",tn.load(n.columns)),this.add("fields",En.load(n.fields));for(const d of Object.values(this.get("stages")))d.loadChildren();return this.data};flatList(){const e={};for(const t of Object.keys(this.data.stages))sh(this.data,t,"stages",e);return e}getChildData=({type:e,id:t})=>{const n=this.get(e,t);if(n)return n.getData()};get json(){return window.JSON.stringify({$schema:`https://cdn.jsdelivr.net/npm/formeo@${Ws}/dist/formData_schema.json`,...this.formData})}get formData(){return{id:this.get("id"),stages:rn.getData(),rows:sa.getData(),columns:id.getData(),fields:sd.getData()}}set config(e){const{stages:t,rows:n,columns:d,fields:h}=e;xn.config=t,Mn.config=n,tn.config=d,En.config=h}getIndex(e){return this[e]||this[Uf.get(e)]}setAddress(e,t){if(!Pe(e))return;const[n,d,...h]=Array.isArray(e)?e:yt(e),m=this.getIndex(n).get(d);return m?.set(h,t),m}getAddress(e){if(!Pe(e))return;const[t,n,...d]=Array.isArray(e)?e:yt(e),g=this.getIndex(t).get(n);if(!(d.length&&!g))return d.length?g.get(d):g}}const ce=new ad,zm=Object.freeze(Object.defineProperty({__proto__:null,Columns:tn,Components:ad,Controls:Hn,Dialog:Lt,Fields:En,Rows:Mn,Stages:xn,default:ce},Symbol.toStringTag,{value:"Module"})),gu="no-transition",Bm={debug:!1,bubbles:!0,formeoLoaded:l=>{},onAdd:()=>{},onChange:l=>J.opts?.debug&&console.log(l),onUpdate:l=>J.opts?.debug&&console.log(l),onUpdateStage:l=>J.opts?.debug&&console.log(l),onUpdateRow:l=>J.opts?.debug&&console.log(l),onUpdateColumn:l=>J.opts?.debug&&console.log(l),onUpdateField:l=>J.opts?.debug&&console.log(l),onAddRow:l=>J.opts?.debug&&console.log(l),onAddColumn:l=>J.opts?.debug&&console.log(l),onAddField:l=>J.opts?.debug&&console.log(l),onRemoveRow:l=>J.opts?.debug&&console.log(l),onRemoveColumn:l=>J.opts?.debug&&console.log(l),onRemoveField:l=>J.opts?.debug&&console.log(l),onRender:l=>J.opts?.debug&&console.log(l),onSave:l=>{},confirmClearAll:l=>{globalThis.confirm(l.confirmationMessage)&&l.clearAllAction(l)}},Be=({src:l,...e},t=nn)=>{const n=new globalThis.CustomEvent(t,{detail:e,bubbles:J.opts?.debug||J.opts?.bubbles});if(n.data=(l||document).dispatchEvent(n),t===nn){const d=new globalThis.CustomEvent(np,{detail:e,bubbles:J.opts?.debug||J.opts?.bubbles});(l||document).dispatchEvent(d)}return n},J={init:function(l){return this.opts={...Bm,...l},this},formeoSaved:l=>Be(l,dh),formeoUpdated:(l,e)=>Be(l,e||nn),formeoCleared:l=>Be(l,ip),formeoOnRender:l=>Be(l,vh),formeoConditionUpdated:l=>Be(l,rp),formeoAddedRow:l=>Be(l,Us),formeoAddedColumn:l=>Be(l,Gs),formeoAddedField:l=>Be(l,qs),formeoRemovedRow:l=>Be(l,Ks),formeoRemovedColumn:l=>Be(l,Ys),formeoRemovedField:l=>Be(l,Zs)},jm=Nf(()=>{const l={timeStamp:globalThis.performance.now(),type:nn,detail:ce.formData};J.opts.onUpdate(l),J.opts.onChange!==J.opts.onUpdate&&J.opts.onChange(l)},vt);document.addEventListener(nn,jm);document.addEventListener(fh,l=>{const{timeStamp:e,type:t,detail:n}=l,d={timeStamp:e,type:t,detail:n};J.opts.onUpdate(d),J.opts.onUpdateStage(d)});document.addEventListener(ph,l=>{const{timeStamp:e,type:t,detail:n}=l,d={timeStamp:e,type:t,detail:n};J.opts.onUpdate(d),J.opts.onUpdateRow(d)});document.addEventListener(gh,l=>{const{timeStamp:e,type:t,detail:n}=l,d={timeStamp:e,type:t,detail:n};J.opts.onUpdate(d),J.opts.onUpdateColumn(d)});document.addEventListener(mh,l=>{const{timeStamp:e,type:t,detail:n}=l,d={timeStamp:e,type:t,detail:n};J.opts.onUpdate(d),J.opts.onUpdateField(d)});document.addEventListener(Us,l=>{const{timeStamp:e,type:t,detail:n}=l,d={timeStamp:e,type:t,detail:n};J.opts.onAddRow(d)});document.addEventListener(Gs,l=>{const{timeStamp:e,type:t,detail:n}=l,d={timeStamp:e,type:t,detail:n};J.opts.onAddColumn(d)});document.addEventListener(qs,l=>{const{timeStamp:e,type:t,detail:n}=l,d={timeStamp:e,type:t,detail:n};J.opts.onAddField(d)});document.addEventListener(Ks,l=>{const{timeStamp:e,type:t,detail:n}=l,d={timeStamp:e,type:t,detail:n};J.opts.onRemoveRow(d)});document.addEventListener(Ys,l=>{const{timeStamp:e,type:t,detail:n}=l,d={timeStamp:e,type:t,detail:n};J.opts.onRemoveColumn(d)});document.addEventListener(Zs,l=>{const{timeStamp:e,type:t,detail:n}=l,d={timeStamp:e,type:t,detail:n};J.opts.onRemoveField(d)});document.addEventListener(vh,l=>{const{timeStamp:e,type:t,detail:n}=l;J.opts.onRender({timeStamp:e,type:t,detail:n})});document.addEventListener("confirmClearAll",l=>{l={timeStamp:l.timeStamp,type:l.type,confirmationMessage:l.detail.confirmationMessage,clearAllAction:l.detail.clearAllAction,btnCoords:l.detail.btnCoords},J.opts.confirmClearAll(l)});document.addEventListener(dh,({timeStamp:l,type:e,detail:{formData:t}})=>{const n={timeStamp:l,type:e,formData:t};J.opts.onSave(n)});document.addEventListener("formeoLoaded",l=>{J.opts.formeoLoaded(l.detail.formeo)});let Zo;function Vm(){Zo=Zo||window.requestAnimationFrame(()=>{Zo=!1;for(const l of Object.values(tn.data))l.dom.classList.add(gu),Hn.dom.classList.add(gu),Hn.panels.nav.refresh(),l.refreshFieldPanels()})}window.addEventListener("resize",Vm);const mu={add:{attr:l=>{const e=globalThis.prompt(l.message.attr);if(e&&l.isDisabled(e))return globalThis.alert(X.get("attributeNotPermitted",e)),$e.add.attrs(l);let t;e&&(t=String(globalThis.prompt(l.message.value,"")),l.addAction(e,t))},option:l=>{l.addAction()},condition:l=>{l.addAction(l)},config:l=>{l.addAction(l)}},remove:{attrs:l=>{l.removeAction()},options:l=>{l.removeAction()},conditions:l=>{l.removeAction()}},click:{btn:l=>{l.action()}},save:{form:Cs}},$e={init:function(l){const e=Object.keys(mu);return this.opts=e.reduce((t,n)=>(t[n]={...mu[n],...l[n]},t),l),this},add:{attrs:l=>$e.opts.add.attr(l),options:l=>$e.opts.add.option(l),conditions:l=>(l.template=l.template||Xs(),$e.opts.add.condition(l)),config:l=>$e.opts.add.config(l)},remove:{attrs:l=>$e.opts.remove.attrs(l),options:l=>$e.opts.remove.options(l),conditions:l=>$e.opts.remove.conditions(l)},click:{btn:l=>$e.opts.click.btn(l)},save:{form:l=>($e.opts.sessionStorage&&oh.set(hh,l),J.formeoSaved({formData:l}),$e.opts.save.form(l))}},Um={get editor(){return{stickyControls:!1,allowEdit:!0,dataType:"json",debug:!1,sessionStorage:!1,editorContainer:null,svgSprite:null,style:zf,iconFont:null,config:{},events:{},actions:{},controls:{},i18n:{location:"https://draggable.github.io/formeo/assets/lang/"},onLoad:()=>{}}}};let ld=class{constructor({formData:e,...t},n){const d=Ve(Um.editor,t),{actions:h,events:g,debug:m,config:c,editorContainer:f,...r}=d;f&&(this.editorContainer=typeof f=="string"?document.querySelector(f):f),this.opts=r,V.setOptions=r,ce.config=c,this.userFormData=n||e,this.Components=ce,this.dom=V,J.init({debug:m,...g}),$e.init({debug:m,sessionStorage:r.sessionStorage,...h}),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",this.loadResources.bind(this)):this.loadResources()}get formData(){return this.Components.formData}set formData(e={}){this.userFormData=Mt(e),this.load(this.userFormData,this.opts)}loadData(e={}){this.formData=e}get json(){return this.Components.json}clear(){this.userFormData=Tn(),this.Components.load(this.userFormData,this.opts),this.render()}async loadResources(){document.removeEventListener("DOMContentLoaded",this.loadResources);const e=[Fg(this.opts.svgSprite),Hg(this.opts.style),X.init({preloaded:{"en-US":pd},...this.opts.i18n,locale:globalThis.sessionStorage?.getItem(oc)})].filter(Boolean);await Promise.all(e),this.opts.allowEdit&&this.init()}init(){return Dt.init(this.opts.controls,this.opts.stickyControls).then(e=>{this.controls=e,this.load(this.userFormData,this.opts),this.formId=ce.get("id"),this.i18n={setLang:t=>{globalThis.sessionStorage?.setItem(oc,t),X.setCurrent(t).then(()=>{this.init()},console.error)}},this.opts.onLoad?.(this),this.tooltipInstance=new Bu})}load(e=this.userFormData,t=this.opts){this.Components.load(e,t),this.render()}render(){if(!this.controls)return globalThis.requestAnimationFrame(()=>this.render());if(this.stages=Object.values(ce.get("stages")),this.opts.controlOnLeft)for(const n of this.stages)n.dom.style.order=1;const e={attrs:{className:"formeo formeo-editor",id:this.formId},content:[this.stages.map(({dom:n})=>n)]};X.current.dir&&(e.attrs.dir=X.current.dir,V.dir=X.current.dir),this.editor=V.create(e),(this.controls.container||this.editor).appendChild(this.controls.dom),this.editorContainer&&(V.empty(this.editorContainer),this.editorContainer.appendChild(this.editor)),J.formeoLoaded=new globalThis.CustomEvent("formeoLoaded",{detail:{formeo:this}}),document.dispatchEvent(J.formeoLoaded)}};const mn="f-",vu=l=>typeof l=="string"?document.querySelector(l):l,Gm=({editorContainer:l,renderContainer:e,formData:t,...n})=>{const d={renderContainer:vu(e),editorContainer:vu(l),formData:Mt(t)};return{elements:{},...n,...d}},vn=l=>l.match(cp)?.[0]||l,yu=l=>{if(!l||l.hasAttribute("hidden")||l.parentElement.hasAttribute("hidden"))return!1;const e=window.getComputedStyle(l);return!(e.display==="none"||e.visibility==="hidden"||e.opacity==="0")},qm={isChecked:l=>l.checked,isNotChecked:l=>!l.checked,value:l=>l.value,isVisible:l=>yu(l),isNotVisible:l=>!yu(l)},Km=()=>V.btnTemplate({className:"remove-input-group",children:V.icon("remove"),action:{mouseover:({target:l})=>l.parentElement.classList.add("will-remove"),mouseleave:({target:l})=>l.parentElement.classList.remove("will-remove"),click:({target:l})=>l.parentElement.remove()}}),bu={equals:xs,notEquals:(l,e)=>!xs(l,e),contains:(l,e)=>l.includes(e),notContains:(l,e)=>!l.includes(e)},Ym=Object.entries(yh).reduce((l,[e,t])=>(l[t]=bu[e],l[e]=bu[e],l),{}),wu={equals:(l,{targetProperty:e,value:t})=>{l[`_${e}`]=l[e],l[e]=t}},Zm=Object.entries(bh).reduce((l,[e,t])=>(l[t]=wu[e],l[e]=wu[e],l),{}),Xm={isChecked:l=>{l.checked=!0},isNotChecked:l=>{l.checked=!1},value:(l,{assignment:e,...t})=>{const n=Zm[e]?.(l,t),d=new Event("input",{bubbles:!0});return l.dispatchEvent(d),n},isNotVisible:l=>{l?._required===void 0&&(l._required=l.required),l.parentElement.setAttribute("hidden",!0),l.required=!1},isVisible:l=>{l.parentElement.removeAttribute("hidden"),l.required=l._required}};let cd=class{constructor(e,t){const{renderContainer:n,elements:d,formData:h,config:g}=Gm(e);this.container=n,this.form=Mt(t||h),this.elements=d,this.config=g,this.components=Object.create(null),this.dom=V}get formData(){return this.form}set formData(e){this.form=Mt(e)}get userData(){const e=this.container.querySelector(".formeo-render")||this.renderedForm;if(!e)return{};const t=new FormData(e),n={};for(const[d,h]of t.entries())n[d]?Array.isArray(n[d])?n[d].push(h):n[d]=[n[d],h]:n[d]=h;return n}get userFormData(){const e=[];for(const[t,n]of Object.entries(this.userData)){const d={key:t,value:n,label:this.components[vn(t)]?.config?.label||""};e.push(d)}return e}set userData(e={}){const t=this.container.querySelector("form");for(const n of Object.keys(e)){const d=t.elements[n];if(d.length&&d[0].type==="checkbox"){const h=Array.isArray(e[n])?e[n]:[e[n]];for(const g of d)g.checked=h.includes(g.value)}else if(d.length&&d[0].type==="radio")for(const h of d)h.checked=h.value===e[n];else d.type&&(d.value=e[n])}}render(e=this.form){this.form=Mt(e);const t=this.getRenderedForm(e),n=this.container.querySelector(".formeo-render");n?n.replaceWith(t):this.container.appendChild(t)}getRenderedForm(e=this.form){this.form=Mt(e);const t=document.getElementsByClassName("formeo-render").length,n={...this.config,tag:"form",id:this.form.id,className:`formeo-render formeo formeo-rendered-${t}`,children:this.processedData};return this.renderedForm=V.render(n),this.applyConditions(),this.renderedForm}get html(){return(this.renderedForm||this.getRenderedForm()).outerHTML}orderChildren=(e,t)=>t.reduce((n,d)=>(n.push(this.form[e][d]),n),[]);prefixId=e=>mn+e;processColumn=({id:e,...t})=>({...t,id:this.prefixId(e),children:this.processFields(t.children),style:`width: ${t.config.width||"100%"}`});processRows=e=>this.orderChildren("rows",this.form.stages[e].children).reduce((t,n)=>(n&&t.push(this.processRow(n)),t),[]);cacheComponent=e=>(this.components[vn(e.id)]=e,e);processRow=(e,t="row")=>{const{config:n,id:d}=e,h=[`formeo-${t}-wrap`],g={...e,children:this.processColumns(e.id),id:this.prefixId(d)};this.cacheComponent(g);const c=[{condition:n.legend,result:()=>({tag:n.fieldset?"legend":"h3",children:n.legend})},{condition:!0,result:()=>g},{condition:n.inputGroup,result:()=>this.addButton(d)}].reduce((f,{condition:r,result:o})=>(r&&f.push(o()),f),[]);return n.inputGroup&&h.push(`${mn}input-group-wrap`),{tag:n.fieldset?"fieldset":"div",className:h,children:c}};cloneComponentData=e=>{const{children:t=[],id:n,attrs:d={},...h}=this.components[e],g={...d,"data-clone-of":n};return h.tag==="input"&&(g.name=qh(this.components[e])),{...h,id:mn+He(n),children:t?.length&&t.map(({id:m})=>this.cloneComponentData(vn(m))),attrs:g}};addButton=e=>({tag:"button",attrs:{className:"add-input-group btn pull-right",type:"button"},children:"Add +",action:{click:t=>{const n=t.target.parentElement,d=V.create(this.cloneComponentData(e));n.insertBefore(d,n.lastChild);const h=V.create(Km());d.appendChild(h)}}});processColumns=e=>this.orderChildren("columns",this.form.rows[e].children).map(t=>this.cacheComponent(this.processColumn(t)));processFields=e=>this.orderChildren("fields",e).map(({id:t,...n})=>{const d=n.config?.controlId||n.meta?.id,{action:h={},dependencies:g={}}=this.elements[d]||{};g&&Gh(g);const m=Ve({action:h},n);return this.cacheComponent({...m,id:this.prefixId(t)})});get processedData(){return Object.values(this.form.stages).map(e=>(e.children=this.processRows(e.id),e.className=Nt,this.components[vn(e.id)]=e,e))}handleComponentCondition=(e,t,n)=>{if(e.length){for(const g of e)this.handleComponentCondition(g,t,n);return}const d=Jm(e);d&&e.addEventListener(d,g=>{if(this.evaluateCondition(t,g))for(const m of n)this.execResult(m,g)},!1);const h={target:e};if(this.evaluateCondition(t,h))for(const g of n)this.execResult(g,h)};applyConditions=()=>{for(const{conditions:e}of Object.values(this.components))if(e)for(const t of e){const{if:n,then:d}=t;for(const h of n){const{source:g,target:m}=h;if(Pe(g)){const{component:c,options:f}=this.getComponent(g),r=f||c;this.handleComponentCondition(r,h,d)}if(Pe(m)){const{component:c,options:f}=this.getComponent(m),r=f||c;this.handleComponentCondition(r,h,d)}}}};evaluateCondition=({source:e,sourceProperty:t,targetProperty:n,comparison:d,target:h})=>{const g=this.getComponentProperty(e,t);if(typeof g=="boolean")return g;const m=String(Pe(h)?this.getComponentProperty(h,n):h);return Ym[d]?.(g,m)};execResult=({target:e,targetProperty:t,assignment:n,value:d})=>{if(Pe(e)){const{component:h,option:g}=this.getComponent(e),m=g||h;Xm[t]?.(m,{targetProperty:t,assignment:n,value:d})}};getComponentProperty=(e,t)=>{const{component:n,option:d}=this.getComponent(e),h=d||n;return qm[t]?.(h)||h[t]};getComponent=e=>{const t={component:null};if(!Pe(e))return null;const[,n,d,h]=yt(e),g=this.renderedForm.querySelector(`#${mn}${n}`);if(!g)return t;if(t.component=g,d){const m=g.querySelectorAll("input"),c=m[h];return t.options=m,t.option=c,t}return t};getComponents=e=>{const t=[],n=e.slice(e.indexOf(".")+1);return t.push(...this.renderedForm.querySelectorAll(`[name=f-${n}]`)),t}};const Qm=[["input",l=>["textarea","text"].includes(l.type)],["change",l=>["select"].includes(l.tagName.toLowerCase())||["checkbox","radio"].includes(l.type)]],Jm=l=>{const[e]=Qm.find(t=>t[1](l))||[!1];return e};window!==void 0&&(window.FormeoEditor=ld,window.FormeoRenderer=cd);const aa=ld,la=cd,ev={rows:{all:{events:{onAdd:l=>{if(console.log(`You just added a new row with the id "${l.target.id}"`,l.index),l.index===2){const e=l.target.dom.querySelector(".action-btn-wrap"),t=document.createElement("button");t.type="button",t.className="btn btn-sm btn-secondary",t.textContent="Add Column",t.style.border="1px solid #ccc",t.style.width="auto",t.addEventListener("click",()=>{l.target.addChild()}),e.appendChild(t)}}}}},fields:{all:{panels:{attrs:{}},events:{onRemove:l=>{console.log(`You just removed the field with the id "${l.target.id}"`,l)}}},"text-input":{attrs:{type:[{label:"text",value:"text"},{label:"phone",value:"phone"},{label:"email",value:"email"}]},config:{helpText:"This is a custom help text for text input fields.",hideLabel:!1}},checkbox:{actionButtons:{},panels:{attrs:{hideDisabled:!0}}}}},tv={sortable:!1,groupOrder:["common","html"],disable:{},elements:[{tag:"input",config:{label:"Email",disabledAttrs:["type"],lockedAttrs:["required","className"]},meta:{group:"common",id:"email",icon:"@"},attrs:{className:"custom-email",type:"email",required:!0}}],elementOrder:{common:["button","checkbox","date-input","hidden","upload","number","radio","select","text-input","textarea"]}},nv=".build-form",iv=".render-form",on={editorContainer:nv,actions:{},controls:tv,config:ev,events:{onSave:console.log,onChange:console.log},style:null,sessionStorage:!0,editPanelOrder:["attrs","options"],onLoad:()=>{console.log("demo loaded")}},ca={renderContainer:iv,elements:{tinymce:{action:{onRender:l=>{if(l.id){const e=`#${l.id}`;globalThis.tinymce.remove(e),globalThis.tinymce.init({selector:e})}}}}}};async function rv(l){l.innerHTML=`
  ...
  `;try{await ov(),await sv()&&console.log("Highlight.js loaded successfully"),l.innerHTML=`
      <div class="angular-demo">
        <h3>Angular Integration Demo</h3>
...
npm install formeo</code></pre>
          ...
          <div class="guide-section">
            ...
            <pre><code class="language-typescript">${Qo(cv)}</code></pre>
          </div>

          <div class="guide-section">
            <h4>3. Service for Formeo Management (Optional)</h4>
            <pre><code class="language-typescript">${Qo(uv)}</code></pre>
          </div>

          <div class="guide-section">
            <h4>4. Module Configuration</h4>
            <pre><code class="language-typescript">${Qo(hv)}</code></pre>
          </div>
        </div>
    ...
    `;const t=await lv();Cu();const n=l.querySelector("#toggle-instructions"),d=l.querySelector("#instructions-section"),h=n.querySelector(".toggle-text"),g=n.querySelector(".toggle-icon");return n&&d&&n.addEventListener("click",()=>{const m=d.style.display==="block";d.style.display=m?"none":"block",h.textContent=m?"Show Implementation Guide":"Hide Implementation Guide",g.textContent=m?"▼":"▲",m||setTimeout(()=>Cu(),50)}),{angularApp:t,cleanup:()=>{t?.destroy&&t.destroy();const m=document.getElementById("angular-app-root");m&&(m.innerHTML="")}}}catch(e){return console.error("Failed to load Angular demo:",e),l.innerHTML=`
      <div class="angular-demo">
        <h3>Angular Integration Demo</h3>
    ...
    `,{cleanup:()=>{}}}}async function ov(){await new Promise(l=>setTimeout(l,500)),console.log("Angular-style demo environment ready")}async function sv(){if(window.hljs)return window.hljs;try{const l=document.createElement("link");return l.rel="stylesheet",l.href="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/styles/github.min.css",document.head.appendChild(l),av(),await Xo("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/highlight.min.js"),await Xo("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/languages/typescript.min.js"),await Xo("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/languages/bash.min.js"),window.hljs}catch(l){return console.warn("Failed to load Highlight.js:",l),null}}function av(){const l=document.createElement("style");l.textContent=`
  ...
  `,document.head.appendChild(l)}function Xo(l){return new Promise((e,t)=>{const n=document.createElement("script");n.src=l,n.onload=e,n.onerror=t,document.head.appendChild(n)})}function Cu(){window.hljs?document.querySelectorAll("pre code").forEach(l=>{try{window.hljs.highlightElement(l)}catch(e){console.warn("Failed to highlight code block:",e)}}):document.querySelectorAll("pre code").forEach(l=>{l.style.fontFamily="'Monaco', 'Menlo', 'Ubuntu Mono', monospace",l.style.fontSize="14px",l.style.lineHeight="1.5"})}async function lv(){const l=document.getElementById("angular-app-root");if(!l)return null;l.innerHTML=`
  ...
  `;const e=l.querySelector(".angular-form-editor"),t=l.querySelector(".angular-form-renderer");if(e&&t){const n=document.createElement("form");n.className="build-form-angular-real";const d=document.createElement("div");d.className="render-form-angular-real",e.appendChild(n),t.appendChild(d);const h={...on,editorContainer:".build-form-angular-real",events:{...on.events,onSave:a=>{console.log("Angular Component - Form saved:",a)},onChange:a=>{console.log("Angular Component - Form changed:",a)}}},g={...ca,renderContainer:".render-form-angular-real"},m=new aa(h),c=new la(g),f=l.querySelector("#angular-save-btn"),r=l.querySelector("#angular-render-btn"),o=l.querySelector("#angular-clear-btn");return f&&f.addEventListener("click",()=>{const a=m.formData;console.log("Angular Component - Save clicked:",a),alert("Form saved! Check console for form data.")}),r&&r.addEventListener("click",()=>{const a=m.formData;a&&Object.keys(a).length>0?(d.style.display="block",c.render(a),console.log("Angular Component - Render clicked:",a)):alert("Please create a form first before rendering")}),o&&o.addEventListener("click",()=>{m&&m.clear(),c&&d&&(d.innerHTML="",d.style.display="none"),console.log("Angular Component - Clear clicked")}),{editor:m,renderer:c,destroy:()=>{m?.destroy&&m.destroy(),c?.destroy&&c.destroy()}}}return null}function Qo(l){const e=document.createElement("div");return e.textContent=l,e.innerHTML}const cv=`import { Component, OnInit, OnDestroy, ElementRef, ViewChild, inject } from '@angular/core';
...
}`,uv=`import { Injectable, signal } from '@angular/core';
import { FormeoEditor, FormeoRenderer } from 'formeo';
...
}`,hv=`// app.config.ts (for standalone applications)
...
bootstrapApplication(AppComponent, appConfig)
  .catch(err => console.error(err));`;async function dv(l){l.innerHTML=`
  ...
  `;try{await fv(),await pv()&&console.log("Highlight.js loaded successfully for React demo"),l.innerHTML=`
      <div class="react-demo">
        <h3>React Integration Demo</h3>
        <div class="demo-description">
...
npm install --save-dev @types/react @types/react-dom typescript</code></pre>
          ...
          <div class="guide-section">
            ...
            <pre><code class="language-typescript">${es(bv)}</code></pre>
          </div>
        </div>
    ...
    `;const t=await mv();Su();const n=l.querySelector("#toggle-instructions"),d=l.querySelector("#instructions-section"),h=n.querySelector(".toggle-text"),g=n.querySelector(".toggle-icon");return n&&d&&n.addEventListener("click",()=>{const m=d.style.display==="block";d.style.display=m?"none":"block",h.textContent=m?"Show Implementation Guide":"Hide Implementation Guide",g.textContent=m?"▼":"▲",m||setTimeout(()=>Su(),50)}),{reactApp:t,cleanup:()=>{t?.cleanup&&t.cleanup();const m=document.getElementById("react-app-root");m&&(m.innerHTML="")}}}catch(e){return console.error("Failed to load React demo:",e),l.innerHTML=`
      <div class="react-demo">
        <h3>React Integration Demo</h3>
        <div class="error-message">
    ...
    `,{cleanup:()=>{}}}}async function fv(){await new Promise(l=>setTimeout(l,500)),console.log("React-style demo environment ready")}async function pv(){if(window.hljs)return window.hljs;try{const l=document.createElement("link");return l.rel="stylesheet",l.href="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/styles/github.min.css",document.head.appendChild(l),gv(),await Jo("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/highlight.min.js"),await Jo("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/languages/typescript.min.js"),await Jo("https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.9.0/languages/bash.min.js"),window.hljs}catch(l){return console.warn("Failed to load Highlight.js:",l),null}}function gv(){const l=document.createElement("style");l.textContent=`
  ...
  `,document.head.appendChild(l)}function Jo(l){return new Promise((e,t)=>{const n=document.createElement("script");n.src=l,n.onload=e,n.onerror=t,document.head.appendChild(n)})}function Su(){window.hljs?document.querySelectorAll("pre code").forEach(l=>{try{window.hljs.highlightElement(l)}catch(e){console.warn("Failed to highlight code block:",e)}}):document.querySelectorAll("pre code").forEach(l=>{l.style.fontFamily="'Monaco', 'Menlo', 'Ubuntu Mono', monospace",l.style.fontSize="14px",l.style.lineHeight="1.5"})}async function mv(){const l=document.getElementById("react-app-root");if(!l)return null;l.innerHTML=`
...
}`,yv=`import React, { useState } from 'react';
...
}`,bv=`import React, { createContext, useContext, useReducer, useCallback } from 'react';
import { FormeoEditor, FormeoRenderer } from 'formeo';
...
`,"error_marker.css",!1)}),ace.define("ace/ace",["require","exports","module","ace/lib/dom","ace/range","ace/editor","ace/edit_session","ace/undomanager","ace/virtual_renderer","ace/worker/worker_client","ace/keyboard/hash_handler","ace/placeholder","ace/multi_select","ace/mode/folding/fold_mode","ace/theme/textmate","ace/ext/error_marker","ace/config","ace/loader_build"],function(t,n,d){t("./loader_build")(n);var h=t("./lib/dom"),g=t("./range").Range,m=t("./editor").Editor,c=t("./edit_session").EditSession,f=t("./undomanager").UndoManager,r=t("./virtual_renderer").VirtualRenderer;t("./worker/worker_client"),t("./keyboard/hash_handler"),t("./placeholder"),t("./multi_select"),t("./mode/folding/fold_mode"),t("./theme/textmate"),t("./ext/error_marker"),n.config=t("./config"),n.edit=function(a,s){if(typeof a=="string"){var i=a;if(a=document.getElementById(i),!a)throw new Error("ace.edit can't find div #"+i)}if(a&&a.env&&a.env.editor instanceof m)return a.env.editor;var u="";if(a&&/input|textarea/i.test(a.tagName)){var p=a;u=p.value,a=h.createElement("pre"),p.parentNode.replaceChild(a,p)}else a&&(u=a.textContent,a.innerHTML="");var y=n.createEditSession(u),b=new m(new r(a),y,s),M={document:y,editor:b,onResize:b.resize.bind(b,null)};return p&&(M.textarea=p),b.on("destroy",function(){M.editor.container.env=null}),b.container.env=b.env=M,b},n.createEditSession=function(a,s){var i=new c(a,s);return i.setUndoManager(new f),i},n.Range=g,n.Editor=m,n.EditSession=c,n.UndoManager=f,n.VirtualRenderer=r;var o=n.config.version;n.version=o}),(function(){ace.require(["ace/ace"],function(t){t&&(t.config.init(!0),t.define=ace.define);var n=(function(){return this})();!n&&typeof window<"u"&&(n=window),!n&&typeof self<"u"&&(n=self),n.ace||(n.ace=t);for(var d in t)t.hasOwnProperty(d)&&(n.ace[d]=t[d]);n.ace.default=n.ace,l&&(l.exports=n.ace)})})()})(ts)),ts.exports}var ua=wv();const Cv=Ot(ua),Sv="/formeo/assets/js/mode-json.min.js",Av="/formeo/assets/js/theme-github_light_default.min.js";var ns,$u;function $v(){if($u)return ns;$u=1;function l(e,t,n,d){var h=-1,g=e==null?0:e.length;for(d&&g&&(n=e[++h]);++h<g;)n=t(n,e[h],h,e);return n}return ns=l,ns}var is,xu;function xv(){if(xu)return is;xu=1;function l(e){return function(t){return e?.[t]}}return is=l,is}var rs,Mu;function Mv(){if(Mu)return rs;Mu=1;var l=xv(),e={À:"A",Á:"A",Â:"A",Ã:"A",Ä:"A",Å:"A",à:"a",á:"a",â:"a",ã:"a",ä:"a",å:"a",Ç:"C",ç:"c",Ð:"D",ð:"d",È:"E",É:"E",Ê:"E",Ë:"E",è:"e",é:"e",ê:"e",ë:"e",Ì:"I",Í:"I",Î:"I",Ï:"I",ì:"i",í:"i",î:"i",ï:"i",Ñ:"N",ñ:"n",Ò:"O",Ó:"O",Ô:"O",Õ:"O",Ö:"O",Ø:"O",ò:"o",ó:"o",ô:"o",õ:"o",ö:"o",ø:"o",Ù:"U",Ú:"U",Û:"U",Ü:"U",ù:"u",ú:"u",û:"u",ü:"u",Ý:"Y",ý:"y",ÿ:"y",Æ:"Ae",æ:"ae",Þ:"Th",þ:"th",ß:"ss",Ā:"A",Ă:"A",Ą:"A",ā:"a",ă:"a",ą:"a",Ć:"C",Ĉ:"C",Ċ:"C",Č:"C",ć:"c",ĉ:"c",ċ:"c",č:"c",Ď:"D",Đ:"D",ď:"d",đ:"d",Ē:"E",Ĕ:"E",Ė:"E",Ę:"E",Ě:"E",ē:"e",ĕ:"e",ė:"e",ę:"e",ě:"e",Ĝ:"G",Ğ:"G",Ġ:"G",Ģ:"G",ĝ:"g",ğ:"g",ġ:"g",ģ:"g",Ĥ:"H",Ħ:"H",ĥ:"h",ħ:"h",Ĩ:"I",Ī:"I",Ĭ:"I",Į:"I",İ:"I",ĩ:"i",ī:"i",ĭ:"i",į:"i",ı:"i",Ĵ:"J",ĵ:"j",Ķ:"K",ķ:"k",ĸ:"k",Ĺ:"L",Ļ:"L",Ľ:"L",Ŀ:"L",Ł:"L",ĺ:"l",ļ:"l",ľ:"l",ŀ:"l",ł:"l",Ń:"N",Ņ:"N",Ň:"N",Ŋ:"N",ń:"n",ņ:"n",ň:"n",ŋ:"n",Ō:"O",Ŏ:"O",Ő:"O",ō:"o",ŏ:"o",ő:"o",Ŕ:"R",Ŗ:"R",Ř:"R",ŕ:"r",ŗ:"r",ř:"r",Ś:"S",Ŝ:"S",Ş:"S",Š:"S",ś:"s",ŝ:"s",ş:"s",š:"s",Ţ:"T",Ť:"T",Ŧ:"T",ţ:"t",ť:"t",ŧ:"t",Ũ:"U",Ū:"U",Ŭ:"U",Ů:"U",Ű:"U",Ų:"U",ũ:"u",ū:"u",ŭ:"u",ů:"u",ű:"u",ų:"u",Ŵ:"W",ŵ:"w",Ŷ:"Y",ŷ:"y",Ÿ:"Y",Ź:"Z",Ż:"Z",Ž:"Z",ź:"z",ż:"z",ž:"z",Ĳ:"IJ",ĳ:"ij",Œ:"Oe",œ:"oe",ŉ:"'n",ſ:"s"},t=l(e);return rs=t,rs}var os,Eu;function Ev(){if(Eu)return os;Eu=1;var l=Mv(),e=Kn(),t=/[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g,n="\\u0300-\\u036f",d="\\ufe20-\\ufe2f",h="\\u20d0-\\u20ff",g=n+d+h,m="["+g+"]",c=RegExp(m,"g");function f(r){return r=e(r),r&&r.replace(t,l).replace(c,"")}return os=f,os}var ss,_u;function _v(){if(_u)return ss;_u=1;var l=/[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g;function e(t){return t.match(l)||[]}return ss=e,ss}var as,Tu;function Tv(){if(Tu)return as;Tu=1;var l=/[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/;function e(t){return l.test(t)}return as=e,as}var ls,Lu;function Lv(){if(Lu)return ls;Lu=1;var l="\\ud800-\\udfff",e="\\u0300-\\u036f",t="\\ufe20-\\ufe2f",n="\\u20d0-\\u20ff",d=e+t+n,h="\\u2700-\\u27bf",g="a-z\\xdf-\\xf6\\xf8-\\xff",m="\\xac\\xb1\\xd7\\xf7",c="\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf",f="\\u2000-\\u206f",r=" \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000",o="A-Z\\xc0-\\xd6\\xd8-\\xde",a="\\ufe0e\\ufe0f",s=m+c+f+r,i="['’]",u="["+s+"]",p="["+d+"]",y="\\d+",b="["+h+"]",M="["+g+"]",$="[^"+l+s+y+h+g+o+"]",A="\\ud83c[\\udffb-\\udfff]",S="(?:"+p+"|"+A+")",E="[^"+l+"]",R="(?:\\ud83c[\\udde6-\\uddff]){2}",L="[\\ud800-\\udbff][\\udc00-\\udfff]",_="["+o+"]",D="\\u200d",w="(?:"+M+"|"+$+")",v="(?:"+_+"|"+$+")",C="(?:"+i+"(?:d|ll|m|re|s|t|ve))?",x="(?:"+i+"(?:D|LL|M|RE|S|T|VE))?",T=S+"?",k="["+a+"]?",O="(?:"+D+"(?:"+[E,R,L].join("|")+")"+k+T+")*",I="\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])",N="\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])",P=k+T+O,B="(?:"+[b,R,L].join("|")+")"+P,F=RegExp([_+"?"+M+"+"+C+"(?="+[u,_,"$"].join("|")+")",v+"+"+x+"(?="+[u,_+w,"$"].join("|")+")",_+"?"+w+"+"+C,_+"+"+x,N,I,y,B].join("|"),"g");function H(z){return z.match(F)||[]}return ls=H,ls}var cs,Ru;function Rv(){if(Ru)return cs;Ru=1;var l=_v(),e=Tv(),t=Kn(),n=Lv();function d(h,g,m){return h=t(h),g=m?void 0:g,g===void 0?e(h)?n(h):l(h):h.match(g)||[]}return cs=d,cs}var us,ku;function kv(){if(ku)return us;ku=1;var l=$v(),e=Ev(),t=Rv(),n="['’]",d=RegExp(n,"g");function h(g){return function(m){return l(t(e(m).replace(d,"")),g,"")}}return us=h,us}var hs,Du;function Dv(){if(Du)return hs;Du=1;function l(e,t,n){var d=-1,h=e.length;t<0&&(t=-t>h?0:h+t),n=n>h?h:n,n<0&&(n+=h),h=t>n?0:n-t>>>0,t>>>=0;for(var g=Array(h);++d<h;)g[d]=e[d+t];return g}return hs=l,hs}var ds,Ou;function Ov(){if(Ou)return ds;Ou=1;var l=Dv();function e(t,n,d){var h=t.length;return d=d===void 0?h:d,!n&&d>=h?t:l(t,n,d)}return ds=e,ds}var fs,Iu;function ud(){if(Iu)return fs;Iu=1;var l="\\ud800-\\udfff",e="\\u0300-\\u036f",t="\\ufe20-\\ufe2f",n="\\u20d0-\\u20ff",d=e+t+n,h="\\ufe0e\\ufe0f",g="\\u200d",m=RegExp("["+g+l+d+h+"]");function c(f){return m.test(f)}return fs=c,fs}var ps,Nu;function Iv(){if(Nu)return ps;Nu=1;function l(e){return e.split("")}return ps=l,ps}var gs,Fu;function Nv(){if(Fu)return gs;Fu=1;var l="\\ud800-\\udfff",e="\\u0300-\\u036f",t="\\ufe20-\\ufe2f",n="\\u20d0-\\u20ff",d=e+t+n,h="\\ufe0e\\ufe0f",g="["+l+"]",m="["+d+"]",c="\\ud83c[\\udffb-\\udfff]",f="(?:"+m+"|"+c+")",r="[^"+l+"]",o="(?:\\ud83c[\\udde6-\\uddff]){2}",a="[\\ud800-\\udbff][\\udc00-\\udfff]",s="\\u200d",i=f+"?",u="["+h+"]?",p="(?:"+s+"(?:"+[r,o,a].join("|")+")"+u+i+")*",y=u+i+p,b="(?:"+[r+m+"?",m,o,a,g].join("|")+")",M=RegExp(c+"(?="+c+")|"+b+y,"g");function $(A){return A.match(M)||[]}return gs=$,gs}var ms,Pu;function Fv(){if(Pu)return ms;Pu=1;var l=Iv(),e=ud(),t=Nv();function n(d){return e(d)?t(d):l(d)}return ms=n,ms}var vs,Hu;function Pv(){if(Hu)return vs;Hu=1;var l=Ov(),e=ud(),t=Fv(),n=Kn();function d(h){return function(g){g=n(g);var m=e(g)?t(g):void 0,c=m?m[0]:g.charAt(0),f=m?l(m,1).join(""):g.slice(1);return c[h]()+f}}return vs=d,vs}var ys,Wu;function Hv(){if(Wu)return ys;Wu=1;var l=Pv(),e=l("toUpperCase");return ys=e,ys}var bs,zu;function Wv(){if(zu)return bs;zu=1;var l=kv(),e=Hv(),t=l(function(n,d,h){return n+(h?" ":"")+e(d)});return bs=t,bs}var zv=Wv();const Bv=Ot(zv);ua.config.setModuleUrl("ace/mode/json",Sv);ua.config.setModuleUrl("ace/theme/github_light_default",Av);const it=Cv.edit("formData-editor");it.session.setOption("useWorker",!1);it.setOptions({theme:"ace/theme/github_light_default",mode:"ace/mode/json"});const jv=document.getElementById("submit-formData"),Vv=document.getElementById("formData-popover"),Uv=document.getElementById("editor-action-buttons"),Gv=(l,e)=>({renderForm:()=>{const t=document.querySelector(".render-form");t.style.display="block",e.render(l.formData)},getHtml:()=>{e.formData=l.formData;const t=e.html,n=window.open("","_blank");n.document.body.innerHTML=t},getUserData:()=>{console.log(e.userData),console.log("User Form Data:",e.userFormData)},resetEditor:()=>{window.sessionStorage.removeItem("formeo-formData"),window.location.reload()},editData:()=>{it.setValue(JSON.stringify(l.formData,null,2),1)}}),qv={editData:{popovertarget:"formData-popover"}},Kv=l=>{const e=qv[l]||{};return{id:l,type:"button",...e}},Yv=(l,e)=>{jv.addEventListener("click",()=>{l.formData=it.session.getValue(),Vv.hidePopover()});const t=Gv(l,e);return Object.entries(t).map(([d,h])=>{const g=Kv(d),m=Object.assign(document.createElement("button"),g);for(const[f,r]of Object.entries(g))m.setAttribute(f,r);const c=document.createTextNode(Bv(d));return m.appendChild(c),m.addEventListener("click",h,!1),Uv.appendChild(m),m})};document.getElementById("format-json").addEventListener("click",Zv);document.getElementById("collapse-json").addEventListener("click",Xv);document.getElementById("copy-json").addEventListener("click",Qv);function Zv(){const l=it.session.getValue(),e=JSON.parse(l);it.setValue(JSON.stringify(e,null,2),1)}function Xv(){const l=it.session.getValue(),e=JSON.parse(l);it.setValue(JSON.stringify(e,null,0),1)}async function Qv({target:l}){const e=l.textContent;l.textContent="Copied!";const t=setTimeout(()=>{l.textContent=e,clearTimeout(t)},3e3);try{await navigator.clipboard.writeText(it.session.getValue()),console.log("Text copied to clipboard")}catch(n){console.error("Failed to copy: ",n)}}const Jv=l=>{const e=document.getElementById("control-filter"),t=document.getElementById("locale"),n=globalThis.sessionStorage.getItem("formeo-locale"),d=({target:{value:g}})=>l.controls.actions.filter(g),h=({target:{value:g}})=>{globalThis.sessionStorage.setItem("formeo-locale",g),l.i18n.setLang(g)};e.addEventListener("input",d),t.value=n||"en-US",t.addEventListener("change",h,!1)};async function ey(l){l.innerHTML=`
    <form class="build-form"></form>
    <div class="render-form"></div>
  `;const e=new aa(on),t=new la(ca);return Yv(e,t),Jv(e),{editor:e,renderer:t,cleanup:()=>{e?.destroy&&e.destroy(),t?.destroy&&t.destroy();const n=document.getElementById("editor-action-buttons");n&&(n.innerHTML="")}}}class ty{constructor(){if(this.currentFramework=null,this.frameworkContainer=document.getElementById("framework-container"),this.frameworkSelect=document.getElementById("framework-select"),this.currentDemo=null,this.isLoading=!1,this.validFrameworks=["vanilla","angular","react"],!this.frameworkContainer){console.error("Framework container not found");return}if(!this.frameworkSelect){console.error("Framework selector not found");return}this.init()}init(){this.frameworkSelect.addEventListener("change",t=>{this.switchFramework(t.target.value)}),window.addEventListener("popstate",()=>{const t=this.getFrameworkFromURL();this.switchFramework(t,{updateURL:!1})});const e=this.getFrameworkFromURL();this.switchFramework(e)}async switchFramework(e,t={}){const{updateURL:n=!0}=t;if(this.isLoading){console.warn("Framework switch already in progress");return}if(!(this.currentFramework===e&&this.currentDemo!==null)){this.isLoading=!0,this.showLoadingState();try{switch(await this.cleanupCurrentDemo(),this.frameworkContainer.innerHTML="",e){case"vanilla":this.currentDemo=await ey(this.frameworkContainer);break;case"angular":this.currentDemo=await rv(this.frameworkContainer);break;case"react":this.currentDemo=await dv(this.frameworkContainer);break;default:throw new Error(`Unknown framework: ${e}`)}this.currentFramework=e,this.syncFrameworkSelector(e),n&&this.updateURL(e),console.log(`Loaded ${e} demo successfully`)}catch(d){console.error(`Failed to load ${e} demo:`,d),this.showErrorState(e,d)}finally{this.isLoading=!1}}}async cleanupCurrentDemo(){if(this.currentDemo?.cleanup)try{await Promise.resolve(this.currentDemo.cleanup())}catch(e){console.warn("Error during demo cleanup:",e)}this.currentDemo=null}syncFrameworkSelector(e){this.frameworkSelect.value!==e&&(this.frameworkSelect.value=e)}getFrameworkFromURL(){const t=new URLSearchParams(window.location.search).get("framework");return t&&this.validFrameworks.includes(t)?t:"vanilla"}updateURL(e){const t=new URL(window.location);e==="vanilla"?t.searchParams.delete("framework"):t.searchParams.set("framework",e),window.history.pushState({framework:e},"",t.toString())}showLoadingState(){this.frameworkContainer.innerHTML=`
      <div class="loading-message">
    ...
    `}}document.addEventListener("DOMContentLoaded",()=>{window.frameworkLoader=new ty});export{km as C,Ve as a,X as m,Xe as t};
